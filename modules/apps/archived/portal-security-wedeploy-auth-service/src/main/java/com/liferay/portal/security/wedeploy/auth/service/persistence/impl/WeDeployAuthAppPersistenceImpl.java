...
public class WeDeployAuthAppPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByRU_CI", _finderPathFetchByRU_CI
			).put(
				"finderPathCountByRU_CI", _finderPathCountByRU_CI
			).put(
				"finderPathFetchByCI_CS", _finderPathFetchByCI_CS
			).put(
				"finderPathCountByCI_CS", _finderPathCountByCI_CS
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(WeDeployAuthApp.class);
	}
