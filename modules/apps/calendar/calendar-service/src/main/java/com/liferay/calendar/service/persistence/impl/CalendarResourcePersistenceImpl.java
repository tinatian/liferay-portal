...
public class CalendarResourcePersistenceImpl
	...
	public CalendarResource updateImpl(CalendarResource calendarResource) {
		...
		entityCache.putResult(
			entityCacheEnabled, CalendarResourceImpl.class,
			calendarResourceModelImpl, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByC_C_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_C_A", "findByC_C_A",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithPaginationCountByC_C_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_C_A", "countByC_C_A",
			new String[] {
				Long.class.getName(), String.class.getName(),
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = CalendarResourceImpl.class;
