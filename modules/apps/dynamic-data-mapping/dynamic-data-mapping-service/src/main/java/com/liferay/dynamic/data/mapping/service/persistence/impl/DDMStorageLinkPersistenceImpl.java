...
public class DDMStorageLinkPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByClassPK = _createFinderPath(
			...
			"fetchByClassPK", new String[] {"classPK"});
		...
		_finderPathWithPaginationFindByStructureId = _createFinderPath(
			DDMStorageLinkImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByStructureId", new String[] {"structureId"});
		...
		_finderPathCountByStructureId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByStructureId", new String[] {"structureId"});

		_finderPathWithPaginationFindByStructureVersionId = _createFinderPath(
			DDMStorageLinkImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByStructureVersionId", new String[] {"structureVersionId"});
		...
		_finderPathCountByStructureVersionId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByStructureVersionId", new String[] {"structureVersionId"});
	...
	private static class DDMStorageLinkModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					ddmStorageLinkModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					ddmStorageLinkModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = ddmStorageLinkModelImpl.getAttributeValue(
						attributeName);
				}
			}
