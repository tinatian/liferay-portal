...
public class AccountEntryUserRelPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByAccountUserId",
				_finderPathCountByAccountUserId
			).put(
				"finderPathFetchByAEI_AUI", _finderPathFetchByAEI_AUI
			).put(
				"finderPathCountByAEI_AUI", _finderPathCountByAEI_AUI
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(AccountEntryUserRel.class);
	}
