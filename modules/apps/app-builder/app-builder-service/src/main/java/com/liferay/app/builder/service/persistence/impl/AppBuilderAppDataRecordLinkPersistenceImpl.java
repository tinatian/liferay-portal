...
public class AppBuilderAppDataRecordLinkPersistenceImpl
	...
	public void cacheResult(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByDDLRecordId"),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByDDLRecordId"),
			args, appBuilderAppDataRecordLinkModelImpl, false);
	}
	...
	public AppBuilderAppDataRecordLink updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, AppBuilderAppDataRecordLinkImpl.class,
			appBuilderAppDataRecordLinkModelImpl.getPrimaryKey(),
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByDDLRecordId");
