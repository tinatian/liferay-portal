	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			MapUtil.singletonDictionary(
				"model.class.name", DLFileVersionPreview.class.getName()));
		...
		_finderPathFetchByF_F = _createFinderPath(
			...
			"fetchByF_F", new String[] {"fileEntryId", "fileVersionId"});
	...
	private static class DLFileVersionPreviewModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					dlFileVersionPreviewModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						dlFileVersionPreviewModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] =
						dlFileVersionPreviewModelImpl.getAttributeValue(
							attributeName);
				}
			}
