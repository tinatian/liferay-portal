...
public class MBStatsUserPersistenceImpl
	...
	public MBStatsUser updateImpl(MBStatsUser mbStatsUser) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBStatsUserImpl.class, mbStatsUserModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByG_NotU_NotM = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_NotU_NotM",
			"findByG_NotU_NotM",
			new String[] {
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = MBStatsUserImpl.class;
