...
public class KaleoTimerInstanceTokenPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByKITI_KTI = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class,
		...
		_finderPathCountByKITI_KTI = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByKITI_KTI",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathWithPaginationFindByKITI_C = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class,
			KaleoTimerInstanceTokenImpl.class,
		...
		_finderPathWithoutPaginationFindByKITI_C = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class,
			KaleoTimerInstanceTokenImpl.class,
		...
		_finderPathCountByKITI_C = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByKITI_C",
			new String[] {Long.class.getName(), Boolean.class.getName()});

		_finderPathWithPaginationFindByKITI_B_C = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class,
			KaleoTimerInstanceTokenImpl.class,
		...
		_finderPathWithoutPaginationFindByKITI_B_C = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class,
			KaleoTimerInstanceTokenImpl.class,
		...
		_finderPathCountByKITI_B_C = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTimerInstanceTokenImpl.class, Long.class,
