...
public class DLFileShortcutPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_F_A = _createFinderPath(
			DLFileShortcutImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_F_A", new String[] {"groupId", "folderId", "active"});
		...
		_finderPathCountByG_F_A = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_F_A", new String[] {"groupId", "folderId", "active"});

		_finderPathWithPaginationFindByG_F_A_S = _createFinderPath(
			DLFileShortcutImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_F_A_S",
			new String[] {"groupId", "folderId", "active", "status"});
	...
	private static class DLFileShortcutModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					dlFileShortcutModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					dlFileShortcutModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = dlFileShortcutModelImpl.getAttributeValue(
						attributeName);
				}
			}
