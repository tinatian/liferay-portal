...
public class LiferayObjectWrapperTest {
	...
	public void testWrap() throws Exception {
		...
		LiferayCollection liferayCollection = new LiferayCollection();
		...
		LiferayMap liferayMap = new LiferayMap();
		...
		LiferayObject liferayObject = new LiferayObject();
	...
	private class LiferayCollection extends ArrayList {
	}

	private class LiferayMap extends HashMap {
	}

	private class LiferayObject {
	}
