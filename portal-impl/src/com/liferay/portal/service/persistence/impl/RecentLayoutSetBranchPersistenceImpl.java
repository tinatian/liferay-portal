...
public class RecentLayoutSetBranchPersistenceImpl extends BasePersistenceImpl<RecentLayoutSetBranch>
	...
	protected void cacheUniqueFindersCache(
		...
		if (isNew) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_U_L, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_U_L, args,
	...
	public RecentLayoutSetBranch fetchByPrimaryKey(Serializable primaryKey) {
		RecentLayoutSetBranch recentLayoutSetBranch = (RecentLayoutSetBranch)EntityCacheUtil.getResult(RecentLayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
