...
public class AssetListEntrySegmentsEntryRelPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByA_S", _finderPathFetchByA_S
			).put(
				...
				"finderPathCountByA_S_C", _finderPathCountByA_S_C
			).put(
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(AssetListEntrySegmentsEntryRel.class);
	}
