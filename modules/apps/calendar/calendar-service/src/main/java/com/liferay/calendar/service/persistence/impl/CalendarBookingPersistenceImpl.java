...
public class CalendarBookingPersistenceImpl
	...
	public void clearCache(CalendarBooking calendarBooking) {
		...
		entityCache.removeResult(
			entityCacheEnabled, CalendarBookingImpl.class, calendarBooking,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, CalendarBookingImpl.class,
		...
		_finderPathWithoutPaginationFindByCalendarId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("CalendarId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("CalendarId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByCalendarId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByCalendarId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByCalendarResourceId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("CalendarResourceId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("CalendarResourceId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByCalendarResourceId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByParentCalendarBookingId =
			new FinderPath(
				...
				"findByParentCalendarBookingId",
				new String[] {Long.class.getName()},
				_ARGUMENTS_BIFUNCTION_MAP.get("ParentCalendarBookingId"),
		...
		_finderPathCountByParentCalendarBookingId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("ParentCalendarBookingId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ParentCalendarBookingId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByParentCalendarBookingId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByRecurringCalendarBookingId =
			new FinderPath(
				...
				"findByRecurringCalendarBookingId",
				new String[] {Long.class.getName()},
				_ARGUMENTS_BIFUNCTION_MAP.get("RecurringCalendarBookingId"),
				_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get(
					"RecurringCalendarBookingId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByRecurringCalendarBookingId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_finderPathFetchByC_V = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_V"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_V,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_V,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {calendarBookingModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((calendarBookingModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CalendarId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((calendarBookingModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CalendarResourceId")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((calendarBookingModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_V")) != 0)) {
