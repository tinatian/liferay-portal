...
public class WikiPagePersistenceImpl
	...
	public void clearCache(WikiPage wikiPage) {
		...
		entityCache.removeResult(
			entityCacheEnabled, WikiPageImpl.class, wikiPage,
	...
	public WikiPage updateImpl(WikiPage wikiPage) {
		...
		entityCache.putResult(
			entityCacheEnabled, WikiPageImpl.class, wikiPage, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, WikiPageImpl.class,
		...
		_finderPathWithoutPaginationFindByResourcePrimKey = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("ResourcePrimKey"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ResourcePrimKey"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByResourcePrimKey,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, WikiPageImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			new String[] {String.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("Uuid_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Uuid_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByUuid_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByUuid_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByNodeId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("NodeId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("NodeId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByNodeId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByNodeId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByFormat = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("Format"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Format"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByFormat,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByFormat,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByR_N = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("R_N"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("R_N"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByR_N,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByR_N,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByR_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("R_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("R_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByR_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByR_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_H = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_H"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_H"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_P = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("N_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_P"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_R = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("N_R"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_R"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_R,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_R,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_S = new FinderPath(
			...
			new String[] {Long.class.getName(), Integer.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("N_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByR_N_V = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("R_N_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("R_N_V"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByR_N_V,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByR_N_V,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByR_N_H = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("R_N_H"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("R_N_H"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByR_N_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByR_N_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByR_N_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("R_N_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("R_N_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByR_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByR_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_N_H = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_H"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_H"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_N_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByU_N_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("U_N_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("U_N_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByU_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByU_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByN_T_V = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_T_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_T_V"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByN_T_V,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_T_V,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_T_H = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_T_H"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_T_H"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_T_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_T_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_T_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_T_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_T_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_H_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_H_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_H_P"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_H_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_H_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_H_R = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_H_R"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_H_R"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_H_R,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_H_R,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_H_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_H_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_H_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_H_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_H_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_U_N_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_U_N_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_U_N_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_U_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_U_N_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_N_T_H = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_T_H"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_T_H"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N_T_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N_T_H,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_N_H_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_H_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_H_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N_H_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N_H_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_H_P_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_H_P_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_H_P_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_H_P_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_H_P_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByN_H_R_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("N_H_R_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_H_R_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_H_R_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByN_H_R_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_N_H_P_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_H_P_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_H_P_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N_H_P_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N_H_P_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("ResourcePrimKey")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("NodeId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Format")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("R_N")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("R_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_H")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_R")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("R_N_V")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("R_N_H")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("R_N_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N_H")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("U_N_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_T_V")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_T_H")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_T_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_H_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_H_R")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_H_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_U_N_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N_T_H")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N_H_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_H_P_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("N_H_R_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((wikiPageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N_H_P_S")) != 0)) {
