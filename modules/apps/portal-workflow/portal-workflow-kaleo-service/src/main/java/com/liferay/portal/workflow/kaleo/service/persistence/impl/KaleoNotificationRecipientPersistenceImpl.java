...
public class KaleoNotificationRecipientPersistenceImpl
	...
	public KaleoNotificationRecipient updateImpl(
		...
		KaleoNotificationRecipient originalKaleoNotificationRecipient =
			kaleoNotificationRecipient;
		...
		entityCache.putResult(
			KaleoNotificationRecipientImpl.class,
			originalKaleoNotificationRecipient, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByKaleoNotificationId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "KaleoNotificationId",
			"findByKaleoNotificationId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByKaleoNotificationId =
			_createFinderPath(
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"KaleoNotificationId", "findByKaleoNotificationId",
				new String[] {Long.class.getName()});

		_finderPathCountByKaleoNotificationId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "KaleoNotificationId",
