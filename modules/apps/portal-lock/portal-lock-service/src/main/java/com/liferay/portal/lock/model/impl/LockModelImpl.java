...
public class LockModelImpl extends BaseModelImpl<Lock> implements LockModel {
	...
	public void resetOriginalValues() {
		...
		_lockCacheModel = _toLockCacheModel();
	}

	@Override
	public CacheModel<Lock> toCacheModel() {
		LockCacheModel lockCacheModel = _toLockCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		LockCacheModel lockCacheModel = _lockCacheModel;

		if (lockCacheModel == null) {
			lockCacheModel = _dummyLockCacheModel;
		}

		return (T)function.apply(lockCacheModel);
	}

	private LockCacheModel _toLockCacheModel() {
	...
	private static final LockCacheModel _dummyLockCacheModel =
		new LockCacheModel();
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			lockCacheModel -> {
				Long createDate = lockCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"expirationDate",
			lockCacheModel -> {
				Long expirationDate = lockCacheModel.expirationDate;
