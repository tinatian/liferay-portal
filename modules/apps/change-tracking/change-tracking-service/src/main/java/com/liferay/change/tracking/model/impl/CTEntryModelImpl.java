...
public class CTEntryModelImpl
	...
	public void resetOriginalValues() {
		...
		_ctEntryCacheModel = _toCTEntryCacheModel();
	}

	@Override
	public CacheModel<CTEntry> toCacheModel() {
		CTEntryCacheModel ctEntryCacheModel = _toCTEntryCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		CTEntryCacheModel ctEntryCacheModel = _ctEntryCacheModel;

		if (ctEntryCacheModel == null) {
			ctEntryCacheModel = _dummyCTEntryCacheModel;
		}

		return (T)function.apply(ctEntryCacheModel);
	}

	private CTEntryCacheModel _toCTEntryCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			ctEntryCacheModel -> {
				Long createDate = ctEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			ctEntryCacheModel -> {
				Long modifiedDate = ctEntryCacheModel.modifiedDate;
