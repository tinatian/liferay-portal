...
public class DDMTemplatePersistenceImpl
	...
	public void clearCache(DDMTemplate ddmTemplate) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DDMTemplateImpl.class, ddmTemplate,
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, DDMTemplateImpl.class, primaryKey);
		}
	}
	...
	public DDMTemplate updateImpl(DDMTemplate ddmTemplate) {
		...
		entityCache.putResult(
			entityCacheEnabled, DDMTemplateImpl.class, ddmTemplate, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DDMTemplateImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, DDMTemplateImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
		...
		_finderPathWithoutPaginationFindByClassPK = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("ClassPK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ClassPK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByClassPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByClassPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByTemplateKey = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("TemplateKey"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("TemplateKey"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByTemplateKey,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByTemplateKey,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByLanguage = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("Language"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Language"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByLanguage,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByLanguage,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchBySmallImageId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_finderPathWithoutPaginationFindByG_CPK = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("G_CPK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_CPK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_CPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_CPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_C_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_finderPathWithoutPaginationFindByC_C_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_C_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_C_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_C_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_C_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_C_T_M = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_T_M"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_T_M"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C_T_M,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_C_T_M,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", DDMTemplateModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", DDMTemplateModelImpl.GROUPID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"ClassPK", DDMTemplateModelImpl.CLASSPK_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"TemplateKey", DDMTemplateModelImpl.TEMPLATEKEY_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"Type", DDMTemplateModelImpl.TYPE_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"Language", DDMTemplateModelImpl.LANGUAGE_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"SmallImageId", DDMTemplateModelImpl.SMALLIMAGEID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {ddmTemplateModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {ddmTemplateModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("ClassPK")) != 0)) {

					return new Object[] {ddmTemplateModelImpl.getClassPK()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("TemplateKey")) != 0)) {

					return new Object[] {ddmTemplateModelImpl.getTemplateKey()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {ddmTemplateModelImpl.getType()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Language")) != 0)) {

					return new Object[] {ddmTemplateModelImpl.getLanguage()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_CPK")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_C_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_C_T_M")) != 0)) {
