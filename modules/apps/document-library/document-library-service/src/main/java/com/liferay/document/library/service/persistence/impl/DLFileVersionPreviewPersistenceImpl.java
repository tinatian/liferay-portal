...
public class DLFileVersionPreviewPersistenceImpl
	...
	public void clearCache(DLFileVersionPreview dlFileVersionPreview) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DLFileVersionPreviewImpl.class,
			dlFileVersionPreview, _columnBitmaskEnabled);
	}
	...
	public DLFileVersionPreview updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, DLFileVersionPreviewImpl.class,
			dlFileVersionPreview, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DLFileVersionPreviewImpl.class,
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByF_F,
				MapUtil.singletonDictionary(
		...
		_finderPathFetchByF_F_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("F_F_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("F_F_P"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByF_F_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByF_F_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((dlFileVersionPreviewModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("F_F_P")) != 0)) {
