...
public class LayoutSEOSitePersistenceImpl
	...
	public LayoutSEOSite updateImpl(LayoutSEOSite layoutSEOSite) {
		...
		entityCache.putResult(
			entityCacheEnabled, LayoutSEOSiteImpl.class,
			layoutSEOSiteModelImpl.getPrimaryKey(), layoutSEOSiteModelImpl,
			false,
			new Object[] {
				_columnBitmaskEnabled, layoutSEOSiteModelImpl.getColumnBitmask()
			});
	...
	private FinderPath _populateFinderPath(
		...
		Class<?> returnClass = LayoutSEOSiteImpl.class;
