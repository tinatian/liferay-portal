...
public class UserModelImpl extends BaseModelImpl<User> implements UserModel {
	...
	public boolean getOriginalDefaultUser() {
		return GetterUtil.getBoolean(getOriginalAttributeValue("defaultUser"));
	}
	...
	public long getOriginalContactId() {
		return GetterUtil.getLong(getOriginalAttributeValue("contactId"));
	}
	...
	public long getOriginalFacebookId() {
		return GetterUtil.getLong(getOriginalAttributeValue("facebookId"));
	}
	...
	public long getOriginalPortraitId() {
		return GetterUtil.getLong(getOriginalAttributeValue("portraitId"));
	}
