...
public class SegmentsEntryPersistenceImpl
	...
	public SegmentsEntry updateImpl(SegmentsEntry segmentsEntry) {
		...
		entityCache.putResult(
			entityCacheEnabled, SegmentsEntryImpl.class,
			segmentsEntryModelImpl.getPrimaryKey(), segmentsEntryModelImpl,
			false,
			new Object[] {
				_columnBitmaskEnabled, segmentsEntryModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_S");
