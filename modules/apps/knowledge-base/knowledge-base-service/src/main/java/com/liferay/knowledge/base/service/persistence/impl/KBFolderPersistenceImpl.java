...
public class KBFolderPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((kbFolderModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				kbFolderModelImpl.getCacheModelAttribute("uuid"),
				kbFolderModelImpl.getCacheModelAttribute("groupId")
			};
		...
		if ((kbFolderModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				kbFolderModelImpl.getCacheModelAttribute("groupId"),
				kbFolderModelImpl.getCacheModelAttribute("parentKBFolderId"),
				kbFolderModelImpl.getCacheModelAttribute("name")
			};
		...
		if ((kbFolderModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				kbFolderModelImpl.getCacheModelAttribute("groupId"),
				kbFolderModelImpl.getCacheModelAttribute("parentKBFolderId"),
				kbFolderModelImpl.getCacheModelAttribute("urlTitle")
			};
	...
	public KBFolder updateImpl(KBFolder kbFolder) {
		...
		if (isNew) {
			...
			if ((kbFolderModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					kbFolderModelImpl.getCacheModelAttribute("uuid"),
					kbFolderModelImpl.getCacheModelAttribute("companyId")
				};
