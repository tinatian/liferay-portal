...
public class SocialActivitySettingPersistenceImpl
	...
	public SocialActivitySetting updateImpl(
		...
		try {
			...
			if (CTPersistenceHelperUtil.isInsert(socialActivitySetting)) {
				if (!isNew) {
					SocialActivitySetting oldSocialActivitySetting =
						(SocialActivitySetting)session.get(
							SocialActivitySettingImpl.class,
							socialActivitySetting.getPrimaryKeyObj());

					if (oldSocialActivitySetting != null) {
						session.evict(oldSocialActivitySetting);
					}
				}
		...
		EntityCacheUtil.putResult(
			SocialActivitySettingModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySettingImpl.class, socialActivitySetting, false,
			SocialActivitySettingModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByG_C_A = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_A"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_A"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_A,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_C_A,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByG_C_A_N = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_A_N"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_A_N"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByG_C_A_N,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_C_A_N,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", SocialActivitySettingModelImpl.GROUPID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((socialActivitySettingModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_A")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((socialActivitySettingModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_A_N")) != 0)) {
