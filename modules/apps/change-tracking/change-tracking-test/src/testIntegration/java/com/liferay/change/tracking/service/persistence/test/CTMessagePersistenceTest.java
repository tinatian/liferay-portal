...
public class CTMessagePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCTMessage.setUserId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingCTMessage.getUserId(), newCTMessage.getUserId());
		Assert.assertEquals(
	...
	protected OrderByComparator<CTMessage> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "userId", true, "ctCollectionId", true);
	}
	...
	protected CTMessage addCTMessage() throws Exception {
		...
		ctMessage.setUserId(RandomTestUtil.nextLong());
