...
public class CTSContentModelImpl
	...
	public void resetOriginalValues() {
		...
		_ctsContentCacheModel = _toCTSContentCacheModel();
	}

	@Override
	public CacheModel<CTSContent> toCacheModel() {
		CTSContentCacheModel ctsContentCacheModel = _toCTSContentCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		CTSContentCacheModel ctsContentCacheModel = _ctsContentCacheModel;

		if (ctsContentCacheModel == null) {
			ctsContentCacheModel = _dummyCTSContentCacheModel;
		}

		return (T)function.apply(ctsContentCacheModel);
	}

	private CTSContentCacheModel _toCTSContentCacheModel() {
