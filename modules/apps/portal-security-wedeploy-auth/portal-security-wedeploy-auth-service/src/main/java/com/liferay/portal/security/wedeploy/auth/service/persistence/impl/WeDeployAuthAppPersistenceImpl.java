...
public class WeDeployAuthAppPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByRU_CI = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, WeDeployAuthAppImpl.class,
		...
		_finderPathCountByRU_CI = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, Long.class,
		...
		_finderPathFetchByCI_CS = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, WeDeployAuthAppImpl.class,
		...
		_finderPathCountByCI_CS = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, Long.class,
