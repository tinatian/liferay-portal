...
public class ServletContextClassLoaderPool {
	...
	public static ClassLoader getClassLoader(String servletContextName) {
		...
		return _servletContextClassLoaders.get(servletContextName);
	}
	...
	public static void register(
		...
		if ((servletContextName == null) || (classLoader == null)) {
			return;
		}

		_servletContextClassLoaders.put(servletContextName, classLoader);
	...
	public static void unregister(String servletContextName) {
		...
		ClassLoader classLoader = _servletContextClassLoaders.remove(
			servletContextName);
	...
	private static final Map<String, ClassLoader> _servletContextClassLoaders =
