...
public class TrashEntryModelImpl
	...
	public void resetOriginalValues() {
		...
		_trashEntryCacheModel = _toTrashEntryCacheModel();
	}

	@Override
	public CacheModel<TrashEntry> toCacheModel() {
		TrashEntryCacheModel trashEntryCacheModel = _toTrashEntryCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		TrashEntryCacheModel trashEntryCacheModel = _trashEntryCacheModel;

		if (trashEntryCacheModel == null) {
			trashEntryCacheModel = _dummyTrashEntryCacheModel;
		}

		return (T)function.apply(trashEntryCacheModel);
	}

	private TrashEntryCacheModel _toTrashEntryCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			trashEntryCacheModel -> {
				Long createDate = trashEntryCacheModel.createDate;
