...
public class WorkflowDefinitionLinkPersistenceImpl
	...
	public WorkflowDefinitionLink updateImpl(
		...
		EntityCacheUtil.putResult(
			WorkflowDefinitionLinkModelImpl.ENTITY_CACHE_ENABLED,
			WorkflowDefinitionLinkImpl.class, workflowDefinitionLink, false,
			WorkflowDefinitionLinkModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByC_W_W = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_W_W"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_W_W"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_W_W,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_W_W,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByG_C_C_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_C"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_C_C_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByG_C_C_C_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_C_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_C_T"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByG_C_C_C_T,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_C_C_C_T,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((workflowDefinitionLinkModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_W_W")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((workflowDefinitionLinkModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_C_C")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((workflowDefinitionLinkModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_C_C_T")) != 0)) {
