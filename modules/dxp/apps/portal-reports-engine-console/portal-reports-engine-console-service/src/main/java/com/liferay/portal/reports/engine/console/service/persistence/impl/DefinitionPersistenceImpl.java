...
public class DefinitionPersistenceImpl
	...
	public void clearCache(Definition definition) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DefinitionImpl.class, definition,
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, DefinitionImpl.class, primaryKey);
		}
	}
	...
	public Definition updateImpl(Definition definition) {
		...
		entityCache.putResult(
			entityCacheEnabled, DefinitionImpl.class, definition, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		DefinitionModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		DefinitionModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DefinitionImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, DefinitionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((definitionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {definitionModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {definitionModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {definitionModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {definitionModelImpl.getCompanyId()};
				}
