...
public class PollsChoicePersistenceImpl
	...
	public void cacheResult(PollsChoice pollsChoice) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByQ_N"),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByQ_N"), args,
			pollsChoiceModelImpl, false);
	}
	...
	public PollsChoice updateImpl(PollsChoice pollsChoice) {
		...
		entityCache.putResult(
			entityCacheEnabled, PollsChoiceImpl.class,
			pollsChoiceModelImpl.getPrimaryKey(), pollsChoiceModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, pollsChoiceModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByQ_N");
