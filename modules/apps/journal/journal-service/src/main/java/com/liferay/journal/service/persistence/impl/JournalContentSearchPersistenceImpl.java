...
public class JournalContentSearchPersistenceImpl
	...
	public JournalContentSearch updateImpl(
		...
		JournalContentSearch originalJournalContentSearch =
			journalContentSearch;
		...
		entityCache.putResult(
			JournalContentSearchImpl.class, originalJournalContentSearch, false,
			true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByArticleId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "ArticleId",
			"findByArticleId",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByArticleId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "ArticleId",
		...
		_finderPathWithPaginationFindByG_P_L = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_P_L", "findByG_P_L",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_P_L = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_P_L", "findByG_P_L",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName()
			});
		...
		_finderPathWithPaginationFindByG_P_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_P_A", "findByG_P_A",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_P_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_P_A", "findByG_P_A",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPathCountByG_P_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_P_A", "countByG_P_A",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			});
		...
		_finderPathWithPaginationFindByG_P_L_P = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_P_L_P", "findByG_P_L_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), String.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_P_L_P = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_P_L_P",
			"findByG_P_L_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), String.class.getName()
		...
		_finderPathFetchByG_P_L_P_A = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_P_L_P_A", "fetchByG_P_L_P_A",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), String.class.getName(),
				String.class.getName()
		...
		_finderPathCountByG_P_L_P_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_P_L_P_A",
			"countByG_P_L_P_A",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), String.class.getName(),
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = JournalContentSearchImpl.class;
