...
public class KBTemplateModelImpl
	...
	public void resetOriginalValues() {
		...
		_kbTemplateCacheModel = _toKBTemplateCacheModel();
	}

	@Override
	public CacheModel<KBTemplate> toCacheModel() {
		KBTemplateCacheModel kbTemplateCacheModel = _toKBTemplateCacheModel();
	...
	private KBTemplateCacheModel _toKBTemplateCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			kbTemplateCacheModel -> {
				Long createDate = kbTemplateCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			kbTemplateCacheModel -> {
				Long modifiedDate = kbTemplateCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			kbTemplateCacheModel -> {
				Long lastPublishDate = kbTemplateCacheModel.lastPublishDate;
