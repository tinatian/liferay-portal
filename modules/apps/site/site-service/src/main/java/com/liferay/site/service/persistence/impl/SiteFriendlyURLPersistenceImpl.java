...
public class SiteFriendlyURLPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_G = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, SiteFriendlyURLImpl.class,
			SiteFriendlyURLImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_G",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_G = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, SiteFriendlyURLImpl.class,
			SiteFriendlyURLImpl.class,
		...
		_finderPathCountByC_G = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, SiteFriendlyURLImpl.class,
		...
		_finderPathFetchByC_G_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, SiteFriendlyURLImpl.class,
			SiteFriendlyURLImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByC_G_L",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByC_G_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, SiteFriendlyURLImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByC_G_L",
			new String[] {
		...
		_finderPathFetchByC_F_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, SiteFriendlyURLImpl.class,
			SiteFriendlyURLImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByC_F_L",
			new String[] {
		...
		_finderPathCountByC_F_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, SiteFriendlyURLImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByC_F_L",
			new String[] {
