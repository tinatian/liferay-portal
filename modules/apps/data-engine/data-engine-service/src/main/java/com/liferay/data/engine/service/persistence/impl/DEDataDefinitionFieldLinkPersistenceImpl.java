...
public class DEDataDefinitionFieldLinkPersistenceImpl
	...
	public DEDataDefinitionFieldLink updateImpl(
		...
		DEDataDefinitionFieldLink originalDEDataDefinitionFieldLink =
			deDataDefinitionFieldLink;
		...
		entityCache.putResult(
			DEDataDefinitionFieldLinkImpl.class,
			originalDEDataDefinitionFieldLink, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByC_DDMSI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_DDMSI", "findByC_DDMSI",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_DDMSI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_DDMSI",
			"findByC_DDMSI",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathCountByC_DDMSI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_DDMSI",
			"countByC_DDMSI",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathWithPaginationFindByDDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "DDMSI_F", "findByDDMSI_F",
			new String[] {
		...
		_finderPathWithoutPaginationFindByDDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "DDMSI_F",
			"findByDDMSI_F",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathCountByDDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "DDMSI_F",
			"countByDDMSI_F",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathWithPaginationCountByDDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "DDMSI_F", "countByDDMSI_F",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathWithPaginationFindByC_DDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_DDMSI_F",
			"findByC_DDMSI_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_DDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_DDMSI_F",
			"findByC_DDMSI_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByC_DDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_DDMSI_F",
			"countByC_DDMSI_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithPaginationCountByC_DDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_DDMSI_F",
			"countByC_DDMSI_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathFetchByC_C_DDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_C_DDMSI_F", "fetchByC_C_DDMSI_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), String.class.getName()
			});

		_finderPathCountByC_C_DDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_C_DDMSI_F",
			"countByC_C_DDMSI_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), String.class.getName()
		...
		_finderPathWithPaginationCountByC_C_DDMSI_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_C_DDMSI_F",
			"countByC_C_DDMSI_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), String.class.getName()
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = DEDataDefinitionFieldLinkImpl.class;
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", DEDataDefinitionFieldLinkModelImpl.UUID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((deDataDefinitionFieldLinkModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_DDMSI")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((deDataDefinitionFieldLinkModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("DDMSI_F")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((deDataDefinitionFieldLinkModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_DDMSI_F")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((deDataDefinitionFieldLinkModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_C_DDMSI_F")) != 0)) {
