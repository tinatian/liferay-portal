...
public class SubscriptionModelImpl
	...
	public static final long FREQUENCY_COLUMN_BITMASK = 2048L;
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		if ((_subscriptionCacheModel == null) ||
			(_subscriptionCacheModel == _dummySubscriptionCacheModel)) {
	...
	public void setMvccVersion(long mvccVersion) {
		...
		if (_subscriptionCacheModel == _dummySubscriptionCacheModel) {
