...
public class DDLRecordSetVersionPersistenceImpl
	...
	public void cacheResult(DDLRecordSetVersion ddlRecordSetVersion) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByRS_V"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByRS_V"), args,
	...
	public DDLRecordSetVersion updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, DDLRecordSetVersionImpl.class,
			ddlRecordSetVersionModelImpl.getPrimaryKey(),
			ddlRecordSetVersionModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByRS_V");
