...
public class OAuth2ScopeGrantModelImpl
	...
	public long getOriginalOAuth2ApplicationScopeAliasesId() {
		return getOriginalAttributeValue("oAuth2ApplicationScopeAliasesId");
	}
	...
	public String getOriginalApplicationName() {
		return getOriginalAttributeValue("applicationName");
	}
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (oAuth2ScopeGrantCacheModel == null) {
			oAuth2ScopeGrantCacheModel = _dummyOAuth2ScopeGrantCacheModel;
		}

		return (T)function.apply(oAuth2ScopeGrantCacheModel);
	}

	private OAuth2ScopeGrantCacheModel _toOAuth2ScopeGrantCacheModel() {
		OAuth2ScopeGrantCacheModel oAuth2ScopeGrantCacheModel =
	...
	private static final OAuth2ScopeGrantCacheModel
		_dummyOAuth2ScopeGrantCacheModel = new OAuth2ScopeGrantCacheModel();
	...
	static {
		...
		columnBitmasks.put("oAuth2ApplicationScopeAliasesId", 4L);
