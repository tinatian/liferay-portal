...
public class AssetListEntrySegmentsEntryRelPersistenceImpl
	...
	public AssetListEntrySegmentsEntryRel updateImpl(
		...
		AssetListEntrySegmentsEntryRel originalAssetListEntrySegmentsEntryRel =
			assetListEntrySegmentsEntryRel;
		...
		entityCache.putResult(
			AssetListEntrySegmentsEntryRelImpl.class,
			originalAssetListEntrySegmentsEntryRel, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByA_S = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "A_S", "fetchByA_S",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AssetListEntrySegmentsEntryRelImpl.class;
