...
public class SharingEntryPersistenceImpl
	...
	public void cacheResult(List<SharingEntry> sharingEntries) {
		for (SharingEntry sharingEntry : sharingEntries) {
			if (entityCache.getResult(
					entityCacheEnabled, SharingEntryImpl.class,
					sharingEntry.getPrimaryKey()) == null) {
	...
	public void clearCache(SharingEntry sharingEntry) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SharingEntryImpl.class, sharingEntry,
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, SharingEntryImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, sharingEntryModelImpl, false);
		...
		finderCache.putResult(
			_finderPathCountByTU_C_C, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByTU_C_C, args, sharingEntryModelImpl, false);
	}
	...
	public SharingEntry updateImpl(SharingEntry sharingEntry) {
		...
		entityCache.putResult(
			entityCacheEnabled, SharingEntryImpl.class, sharingEntry, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		SharingEntryModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		SharingEntryModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SharingEntryImpl.class,
		...
		_finderPathWithoutPaginationFindByToUserId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("ToUserId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ToUserId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByToUserId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByToUserId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByTU_C = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("TU_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("TU_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByTU_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByTU_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByTU_C_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("TU_C_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("TU_C_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByTU_C_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByTU_C_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", SharingEntryModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", SharingEntryModelImpl.GROUPID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"UserId", SharingEntryModelImpl.USERID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"ToUserId", SharingEntryModelImpl.TOUSERID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((sharingEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {sharingEntryModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {sharingEntryModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {sharingEntryModelImpl.getUserId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((sharingEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("ToUserId")) != 0)) {

					return new Object[] {sharingEntryModelImpl.getToUserId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						sharingEntryModelImpl.getUserId(),
						sharingEntryModelImpl.getClassNameId()
					};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((sharingEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("TU_C")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((sharingEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("TU_C_C")) != 0)) {
