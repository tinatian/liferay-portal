...
public class AppBuilderAppDeploymentPersistenceImpl
	...
	public void cacheResult(AppBuilderAppDeployment appBuilderAppDeployment) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_T"),
			new Object[] {
				appBuilderAppDeployment.getAppBuilderAppId(),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_T"), args,
			appBuilderAppDeploymentModelImpl, false);
	}
	...
	public AppBuilderAppDeployment updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, AppBuilderAppDeploymentImpl.class,
			appBuilderAppDeploymentModelImpl.getPrimaryKey(),
			appBuilderAppDeploymentModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_T");
