...
public class PluginSettingPersistenceImpl
	...
	public PluginSetting updateImpl(PluginSetting pluginSetting) {
		...
		EntityCacheUtil.putResult(
			PluginSettingModelImpl.ENTITY_CACHE_ENABLED,
			PluginSettingImpl.class, pluginSettingModelImpl, false,
			PluginSettingModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByC_I_T = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_I_T", "fetchByC_I_T",
			new String[] {
		...
		_finderPathCountByC_I_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_I_T", "countByC_I_T",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			});
	...
	private FinderPath _createFinderPath(
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				PluginSettingModelImpl.FINDER_CACHE_ENABLED, returnClass,
				cacheName, methodName, params);
		}

		FinderPath finderPath = new FinderPath(
			PluginSettingModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
