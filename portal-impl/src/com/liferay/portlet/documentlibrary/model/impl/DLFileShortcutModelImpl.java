...
public class DLFileShortcutModelImpl
	...
	private DLFileShortcutCacheModel _toDLFileShortcutCacheModel() {
		DLFileShortcutCacheModel dlFileShortcutCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			dlFileShortcutCacheModel -> {
				Long createDate = dlFileShortcutCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			dlFileShortcutCacheModel -> {
				Long modifiedDate = dlFileShortcutCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			dlFileShortcutCacheModel -> {
				Long lastPublishDate = dlFileShortcutCacheModel.lastPublishDate;
		...
		cacheModelGetterFunctions.put(
			"statusDate",
			dlFileShortcutCacheModel -> {
				Long statusDate = dlFileShortcutCacheModel.statusDate;
