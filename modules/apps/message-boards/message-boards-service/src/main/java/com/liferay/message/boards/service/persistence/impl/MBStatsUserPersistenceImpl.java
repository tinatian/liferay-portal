...
public class MBStatsUserPersistenceImpl
	...
	public void clearCache(MBStatsUser mbStatsUser) {
		...
		entityCache.removeResult(
			entityCacheEnabled, MBStatsUserImpl.class, mbStatsUser,
	...
	public MBStatsUser updateImpl(MBStatsUser mbStatsUser) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBStatsUserImpl.class, mbStatsUser, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, MBStatsUserImpl.class,
		...
		_finderPathFetchByG_U = new FinderPath(
			finderCacheEnabled, MBStatsUserImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByG_U",
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mbStatsUserModelImpl.getColumnBitmask() &
