...
public class JournalArticleResourcePersistenceImpl
	...
	public JournalArticleResource updateImpl(
		...
		JournalArticleResource originalJournalArticleResource =
			journalArticleResource;
		...
		entityCache.putResult(
			JournalArticleResourceImpl.class, originalJournalArticleResource,
			false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByG_A = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_A", "fetchByG_A",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = JournalArticleResourceImpl.class;
