...
/**
 * Provides the local service utility for LoadFinderCacheEntry. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.LoadFinderCacheEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class LoadFinderCacheEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.LoadFinderCacheEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static LoadFinderCacheEntry addLoadFinderCacheEntry(
		LoadFinderCacheEntry loadFinderCacheEntry) {

		return getService().addLoadFinderCacheEntry(loadFinderCacheEntry);
	}
	 ...
	 */
	public static LoadFinderCacheEntry createLoadFinderCacheEntry(
		long loadFinderCacheEntryId) {

		return getService().createLoadFinderCacheEntry(loadFinderCacheEntryId);
	}
	 ...
	 */
	public static LoadFinderCacheEntry deleteLoadFinderCacheEntry(
		LoadFinderCacheEntry loadFinderCacheEntry) {

		return getService().deleteLoadFinderCacheEntry(loadFinderCacheEntry);
	}
	...
	public static LoadFinderCacheEntry deleteLoadFinderCacheEntry(
		...
		return getService().deleteLoadFinderCacheEntry(loadFinderCacheEntryId);
	}
	...
	public static LoadFinderCacheEntry fetchLoadFinderCacheEntry(
		long loadFinderCacheEntryId) {

		return getService().fetchLoadFinderCacheEntry(loadFinderCacheEntryId);
	}
	 ...
	 */
	public static List<LoadFinderCacheEntry> getLoadFinderCacheEntries(
		int start, int end) {

		return getService().getLoadFinderCacheEntries(start, end);
	}
	 ...
	 */
	public static int getLoadFinderCacheEntriesCount() {
		return getService().getLoadFinderCacheEntriesCount();
	}
	 ...
	 * @throws PortalException if a load finder cache entry with the primary key could not be found
	 */
	public static LoadFinderCacheEntry getLoadFinderCacheEntry(
			long loadFinderCacheEntryId)
		throws PortalException {

		return getService().getLoadFinderCacheEntry(loadFinderCacheEntryId);
	}
	 ...
	 */
	public static LoadFinderCacheEntry updateLoadFinderCacheEntry(
		LoadFinderCacheEntry loadFinderCacheEntry) {

		return getService().updateLoadFinderCacheEntry(loadFinderCacheEntry);
	}

	public static LoadFinderCacheEntryLocalService getService() {
		return _service;
	}

	private static volatile LoadFinderCacheEntryLocalService _service;
