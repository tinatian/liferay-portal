...
public class ClusterClassLoaderTracker implements BundleActivator {
		...
		_bundleTracker = new BundleTracker<ClassLoader>(
			...
			public ClassLoader addingBundle(
				...
				ClusterClassLoaderPool.register(
					_parseBundleInfo(bundle), classLoader);
	...
	private String[] _parseBundleInfo(Bundle bundle) {
		String[] symbolicNameWithVersion = new String[2];

		symbolicNameWithVersion[0] = bundle.getSymbolicName();
		symbolicNameWithVersion[1] = String.valueOf(bundle.getVersion());

		return symbolicNameWithVersion;
	}
