...
public class KaleoTimerPersistenceImpl
	...
	public void clearCache(KaleoTimer kaleoTimer) {
		...
		entityCache.removeResult(
			entityCacheEnabled, KaleoTimerImpl.class, kaleoTimer,
	...
	public KaleoTimer updateImpl(KaleoTimer kaleoTimer) {
		...
		entityCache.putResult(
			entityCacheEnabled, KaleoTimerImpl.class, kaleoTimer, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, KaleoTimerImpl.class,
		...
		_finderPathWithoutPaginationFindByKCN_KCPK_Blocking = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("KCN_KCPK_Blocking"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("KCN_KCPK_Blocking"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByKCN_KCPK_Blocking,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoTimerModelImpl.getColumnBitmask() &
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoTimerModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("KCN_KCPK_Blocking")) !=
						  0)) {
