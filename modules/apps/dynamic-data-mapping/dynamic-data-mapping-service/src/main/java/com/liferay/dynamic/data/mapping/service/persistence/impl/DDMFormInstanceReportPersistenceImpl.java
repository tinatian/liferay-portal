...
public class DDMFormInstanceReportPersistenceImpl
	...
	public DDMFormInstanceReport updateImpl(
		...
		DDMFormInstanceReport originalDDMFormInstanceReport =
			ddmFormInstanceReport;
		...
		entityCache.putResult(
			DDMFormInstanceReportImpl.class, originalDDMFormInstanceReport,
			false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByFormInstanceId = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "FormInstanceId", "fetchByFormInstanceId",
