...
public class MBBanPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByBanUserId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MBBanImpl.class,
			MBBanImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByBanUserId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByBanUserId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MBBanImpl.class,
			MBBanImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByBanUserId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MBBanImpl.class, Long.class,
		...
		_finderPathFetchByG_B = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MBBanImpl.class,
		...
		_finderPathCountByG_B = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MBBanImpl.class, Long.class,
