...
public class MBDiscussionPersistenceImpl
	...
	public void clearCache(MBDiscussion mbDiscussion) {
		...
		entityCache.removeResult(
			entityCacheEnabled, MBDiscussionImpl.class, mbDiscussion,
	...
	public MBDiscussion updateImpl(MBDiscussion mbDiscussion) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBDiscussionImpl.class, mbDiscussion, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, MBDiscussionImpl.class,
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByThreadId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", MBDiscussionModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"ClassNameId", MBDiscussionModelImpl.CLASSNAMEID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"ThreadId", MBDiscussionModelImpl.THREADID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mbDiscussionModelImpl.getColumnBitmask() &
