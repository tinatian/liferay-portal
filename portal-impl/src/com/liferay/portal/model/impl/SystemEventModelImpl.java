...
public class SystemEventModelImpl
	...
	private SystemEventCacheModel _toSystemEventCacheModel() {
		SystemEventCacheModel systemEventCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			systemEventCacheModel -> {
				Long createDate = systemEventCacheModel.createDate;
