...
public class CTProcessModelImpl
	...
	public void resetOriginalValues() {
		...
		_ctProcessCacheModel = _toCTProcessCacheModel();
	}

	@Override
	public CacheModel<CTProcess> toCacheModel() {
		CTProcessCacheModel ctProcessCacheModel = _toCTProcessCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		CTProcessCacheModel ctProcessCacheModel = _ctProcessCacheModel;

		if (ctProcessCacheModel == null) {
			ctProcessCacheModel = _dummyCTProcessCacheModel;
		}

		return (T)function.apply(ctProcessCacheModel);
	}

	private CTProcessCacheModel _toCTProcessCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			ctProcessCacheModel -> {
				Long createDate = ctProcessCacheModel.createDate;
