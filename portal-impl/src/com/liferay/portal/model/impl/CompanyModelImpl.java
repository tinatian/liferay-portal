...
public class CompanyModelImpl
	...
	public void setMvccVersion(long mvccVersion) {
		...
		if (!isNew() && (_companyCacheModel == null)) {
	...
	public String getOriginalWebId() {
		return getCacheModelAttribute("webId");
	}
	...
	public String getOriginalMx() {
		return getCacheModelAttribute("mx");
	}
	...
	public boolean getOriginalSystem() {
		return getCacheModelAttribute("system");
	}
