...
public class DDMStructureLinkPersistenceImpl
	...
	public void clearCache(DDMStructureLink ddmStructureLink) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DDMStructureLinkImpl.class, ddmStructureLink,
	...
	public void clearCache(List<DDMStructureLink> ddmStructureLinks) {
		...
		for (DDMStructureLink ddmStructureLink : ddmStructureLinks) {
			entityCache.removeResult(
				entityCacheEnabled, DDMStructureLinkImpl.class,
				ddmStructureLink, _columnBitmaskEnabled);
		}
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DDMStructureLinkImpl.class,
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_C_S,
				MapUtil.singletonDictionary(
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmStructureLinkModelImpl.getColumnBitmask() &
