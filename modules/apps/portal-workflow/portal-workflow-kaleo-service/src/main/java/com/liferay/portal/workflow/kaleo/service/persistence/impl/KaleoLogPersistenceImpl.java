...
public class KaleoLogPersistenceImpl extends BasePersistenceImpl<KaleoLog>
	...
	public List<KaleoLog> findByKITI_T(long kaleoInstanceTokenId, String type,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_KITI_T_KALEOINSTANCETOKENID_2_SQL);
	...
	public List<KaleoLog> findByKCN_KCPK_KITI_T(String kaleoClassName,
		...
		if (list == null) {
			...
			if (kaleoClassName.isEmpty()) {
				query.append(_FINDER_COLUMN_KCN_KCPK_KITI_T_KALEOCLASSNAME_3_SQL);
			}
			else {
				bindKaleoClassName = true;

				query.append(_FINDER_COLUMN_KCN_KCPK_KITI_T_KALEOCLASSNAME_2_SQL);
			}

			query.append(_FINDER_COLUMN_KCN_KCPK_KITI_T_KALEOCLASSPK_2_SQL);

			query.append(_FINDER_COLUMN_KCN_KCPK_KITI_T_KALEOINSTANCETOKENID_2_SQL);
