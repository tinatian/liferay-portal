...
public class CTCollectionPersistenceImpl
	...
	public void clearCache(CTCollection ctCollection) {
		...
		entityCache.removeResult(
			entityCacheEnabled, CTCollectionImpl.class, ctCollection,
	...
	public CTCollection updateImpl(CTCollection ctCollection) {
		...
		entityCache.putResult(
			entityCacheEnabled, CTCollectionImpl.class, ctCollection, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, CTCollectionImpl.class,
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ctCollectionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CompanyId")) != 0)) {

					return new Object[] {ctCollectionModelImpl.getCompanyId()};
				}
