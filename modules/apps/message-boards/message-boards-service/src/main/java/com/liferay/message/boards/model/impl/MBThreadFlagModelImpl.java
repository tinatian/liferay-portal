...
public class MBThreadFlagModelImpl
	...
	private MBThreadFlagCacheModel _toMBThreadFlagCacheModel() {
		MBThreadFlagCacheModel mbThreadFlagCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			mbThreadFlagCacheModel -> {
				Long createDate = mbThreadFlagCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			mbThreadFlagCacheModel -> {
				Long modifiedDate = mbThreadFlagCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			mbThreadFlagCacheModel -> {
				Long lastPublishDate = mbThreadFlagCacheModel.lastPublishDate;
