...
public class RepositoryEntryPersistenceImpl
	...
	public RepositoryEntry updateImpl(RepositoryEntry repositoryEntry) {
		...
		RepositoryEntry originalRepositoryEntry = repositoryEntry;
		...
		EntityCacheUtil.putResult(
			RepositoryEntryImpl.class, originalRepositoryEntry, false, true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = RepositoryEntryImpl.class;
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", RepositoryEntryModelImpl.UUID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((repositoryEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {repositoryEntryModelImpl.getUuid()};
				}
