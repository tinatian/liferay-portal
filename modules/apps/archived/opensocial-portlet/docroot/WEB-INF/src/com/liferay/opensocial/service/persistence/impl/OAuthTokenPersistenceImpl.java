...
public class OAuthTokenPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByU_G_S_M_T = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "U_G_S_M_T", "fetchByU_G_S_M_T",
			new String[] {
		...
		_finderPathCountByU_G_S_M_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "U_G_S_M_T",
			"countByU_G_S_M_T",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName(), Long.class.getName(),
	...
	private FinderPath _createFinderPath(
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				OAuthTokenModelImpl.FINDER_CACHE_ENABLED, returnClass,
				cacheName, methodName, params);
		}

		FinderPath finderPath = new FinderPath(
			OAuthTokenModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
