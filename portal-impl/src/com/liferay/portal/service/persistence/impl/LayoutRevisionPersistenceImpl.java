...
public class LayoutRevisionPersistenceImpl
	...
	public LayoutRevision updateImpl(LayoutRevision layoutRevision) {
		...
		EntityCacheUtil.putResult(
			LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionImpl.class, layoutRevision, false,
			LayoutRevisionModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByLayoutSetBranchId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("LayoutSetBranchId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("LayoutSetBranchId"));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByLayoutSetBranchId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByPlid,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByStatus = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Status"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Status"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByStatus,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByStatus,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_H = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_H"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_H"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_H,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_H,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_S"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByH_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("H_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("H_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByH_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByH_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_L_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_L_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_L_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_L_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_L_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_P_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_P_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_P_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_P_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_P_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByL_H_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_H_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_H_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByL_H_P,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_H_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_H_P_Collection = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_H_P_Collection"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_H_P_Collection"));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_H_P_Collection,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_H_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_H_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_H_S"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_H_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_H_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_P_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_P_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_P_S"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_P_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_P_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByL_L_H_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_L_H_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_L_H_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByL_L_H_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_L_H_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
	...
	static {
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("LayoutSetBranchId")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_H")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("H_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_L_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_P_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_H_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_H_P_Collection")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_H_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_P_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutRevisionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("L_L_H_P")) != 0)) {
