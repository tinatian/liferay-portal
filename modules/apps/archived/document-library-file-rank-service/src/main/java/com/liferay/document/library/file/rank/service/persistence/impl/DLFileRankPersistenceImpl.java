...
public class DLFileRankPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByG_U_A", _finderPathCountByG_U_A
			).put(
				"finderPathFetchByC_U_F", _finderPathFetchByC_U_F
			).put(
				"finderPathCountByC_U_F", _finderPathCountByC_U_F
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(DLFileRank.class);
	}
