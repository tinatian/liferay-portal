...
public class KaleoTaskAssignmentInstancePersistenceImpl
	...
	public List<KaleoTaskAssignmentInstance> findByassigneeClassName(
		...
		if (list == null) {
			...
			if (assigneeClassName.isEmpty()) {
				query.append(_FINDER_COLUMN_ASSIGNEECLASSNAME_ASSIGNEECLASSNAME_3_SQL);
			}
			else {
				bindAssigneeClassName = true;

				query.append(_FINDER_COLUMN_ASSIGNEECLASSNAME_ASSIGNEECLASSNAME_2_SQL);
			}
	...
	public List<KaleoTaskAssignmentInstance> findByG_ACPK(long groupId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_ACPK_GROUPID_2_SQL);

			query.append(_FINDER_COLUMN_G_ACPK_ASSIGNEECLASSPK_2_SQL);
	...
	public List<KaleoTaskAssignmentInstance> findByACN_ACPK(
		...
		if (list == null) {
			...
			if (assigneeClassName.isEmpty()) {
				query.append(_FINDER_COLUMN_ACN_ACPK_ASSIGNEECLASSNAME_3_SQL);
			}
			else {
				bindAssigneeClassName = true;

				query.append(_FINDER_COLUMN_ACN_ACPK_ASSIGNEECLASSNAME_2_SQL);
			}

			query.append(_FINDER_COLUMN_ACN_ACPK_ASSIGNEECLASSPK_2_SQL);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByKaleoDefinitionVersionId = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
				KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
				KaleoTaskAssignmentInstanceImpl.class,
		...
		_finderPathWithoutPaginationFindByKaleoDefinitionVersionId = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
				KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
				KaleoTaskAssignmentInstanceImpl.class,
		...
		_finderPathCountByKaleoDefinitionVersionId = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
				KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
				Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
