...
public class JournalFeedPersistenceImpl
	...
	public void cacheResult(JournalFeed journalFeed) {
		entityCache.putResult(
			...
			new Object[] {
				...
				((JournalFeedModelImpl)journalFeed).getColumnBitmask()
			});
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F"),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F"), args,
			journalFeedModelImpl, false);
	}
	...
	public JournalFeed updateImpl(JournalFeed journalFeed) {
		...
		entityCache.putResult(
			entityCacheEnabled, JournalFeedImpl.class,
			journalFeedModelImpl.getPrimaryKey(), journalFeedModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, journalFeedModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F");
	...
	private FinderPath _populateFinderPath(
		...
		Class<?> returnClass = JournalFeedImpl.class;
