...
public class LayoutPageTemplateCollectionPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, LayoutPageTemplateCollectionImpl.class,
		...
		_finderPathFetchByG_LPTCK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_LPTCK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_LPTCK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_LPTCK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_LPTCK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateCollectionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_LPTCK")) != 0)) {
