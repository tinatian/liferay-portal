...
public class DDMStructureVersionPersistenceImpl
	...
	public void clearCache(DDMStructureVersion ddmStructureVersion) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DDMStructureVersionImpl.class,
			ddmStructureVersion, _columnBitmaskEnabled);
	}
	...
	public DDMStructureVersion updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, DDMStructureVersionImpl.class,
			ddmStructureVersion, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DDMStructureVersionImpl.class,
		...
		_finderPathFetchByS_V = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("S_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("S_V"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByS_V,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByS_V,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByS_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("S_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("S_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByS_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByS_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmStructureVersionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("S_V")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmStructureVersionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("S_S")) != 0)) {
