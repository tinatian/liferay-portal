...
public class ImagePersistenceImpl
	...
	public void clearCache(Image image) {
		...
		EntityCacheUtil.removeResult(
			ImageModelImpl.ENTITY_CACHE_ENABLED, ImageImpl.class, image,
	...
	public Image updateImpl(Image image) {
		...
		EntityCacheUtil.putResult(
			ImageModelImpl.ENTITY_CACHE_ENABLED, ImageImpl.class, image, false,
			ImageModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByLtSize = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "LtSize", "findByLtSize",
			new String[] {
		...
		_finderPathWithPaginationCountByLtSize = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "LtSize", "countByLtSize",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = ImageImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				ImageModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
				methodName, params);
		}
