...
public class AppBuilderAppDeploymentPersistenceImpl
	...
	public AppBuilderAppDeployment updateImpl(
		...
		AppBuilderAppDeployment originalAppBuilderAppDeployment =
			appBuilderAppDeployment;
		...
		entityCache.putResult(
			AppBuilderAppDeploymentImpl.class, originalAppBuilderAppDeployment,
			false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByA_T = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "A_T", "fetchByA_T",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AppBuilderAppDeploymentImpl.class;
