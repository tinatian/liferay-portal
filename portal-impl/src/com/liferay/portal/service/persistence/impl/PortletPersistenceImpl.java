...
public class PortletPersistenceImpl
	...
	public Portlet updateImpl(Portlet portlet) {
		...
		EntityCacheUtil.putResult(
			PortletModelImpl.ENTITY_CACHE_ENABLED, PortletImpl.class,
			portletModelImpl, false, PortletModelImpl.COLUMN_BITMASK_ENABLED);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = PortletImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				PortletModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
				methodName, params);
		}
