...
public class SiteFriendlyURLPersistenceImpl
	...
	public void cacheResult(SiteFriendlyURL siteFriendlyURL) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_G_L"),
			new Object[] {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_F_L"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_G_L"), args,
			siteFriendlyURLModelImpl, false);
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_F_L"), args,
			siteFriendlyURLModelImpl, false);
	}
	...
	public SiteFriendlyURL updateImpl(SiteFriendlyURL siteFriendlyURL) {
		...
		entityCache.putResult(
			entityCacheEnabled, SiteFriendlyURLImpl.class,
			siteFriendlyURLModelImpl.getPrimaryKey(), siteFriendlyURLModelImpl,
			false,
			new Object[] {
				_columnBitmaskEnabled,
