...
public class AccountRolePersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByAccountEntryId = _createFinderPath(
			AccountRoleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByAccountEntryId", new String[] {"accountEntryId"});
		...
		_finderPathCountByAccountEntryId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByAccountEntryId", new String[] {"accountEntryId"});
		...
		_finderPathCountByRoleId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByRoleId", new String[] {"roleId"});
	}
	...
	private static class AccountRoleModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					accountRoleModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					accountRoleModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			AccountRoleModelImpl accountRoleModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = accountRoleModelImpl.getAttributeValue(
						attributeName);
				}
			}
