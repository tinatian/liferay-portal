...
public class SegmentsExperimentPersistenceImpl
	...
	public void clearCache(SegmentsExperiment segmentsExperiment) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SegmentsExperimentImpl.class,
			segmentsExperiment, _columnBitmaskEnabled);
	}
	...
	public SegmentsExperiment updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, SegmentsExperimentImpl.class,
			segmentsExperiment, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SegmentsExperimentImpl.class,
		...
		_finderPathWithoutPaginationFindBySegmentsExperimentKey =
			new FinderPath(
				...
				"findBySegmentsExperimentKey",
				new String[] {String.class.getName()},
				_ARGUMENTS_BIFUNCTION_MAP.get("SegmentsExperimentKey"),
		...
		_finderPathCountBySegmentsExperimentKey = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("SegmentsExperimentKey"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("SegmentsExperimentKey"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountBySegmentsExperimentKey,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByS_C_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("S_C_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("S_C_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByS_C_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByS_C_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByS_C_C_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("S_C_C_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("S_C_C_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByS_C_C_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByS_C_C_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {segmentsExperimentModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsExperimentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("SegmentsExperimentKey")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsExperimentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("S_C_C")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsExperimentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("S_C_C_S")) != 0)) {
