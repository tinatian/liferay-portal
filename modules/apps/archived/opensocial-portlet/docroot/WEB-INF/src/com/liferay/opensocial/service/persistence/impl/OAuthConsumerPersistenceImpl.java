...
public class OAuthConsumerPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByGadgetKey = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("GadgetKey"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("GadgetKey"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByGadgetKey,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByGadgetKey,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
