	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			MapUtil.singletonDictionary(
				"model.class.name", App.class.getName()));
		...
		_finderPathCountByCategory = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByCategory", new String[] {"category"});
	}
	...
	private static class AppModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(appModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			AppModelImpl appModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = appModelImpl.getOriginalAttributeValue(
						attributeName);
				}
				else {
					arguments[i] = appModelImpl.getAttributeValue(
						attributeName);
				}
			}
