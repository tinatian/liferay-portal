...
>
	...
	<@insertDDMStorageLink
		_ddmStorageLinkModel = dDLDDMDataFactory.newDDMStorageLinkModel(_ddmStorageLinkId, ddmContentModel, _ddmStructureId)
	/>
</#macro>
...
<#macro insertDDMStructureLink
	_entry
>
	<#local ddmStructureLinkModel = dDLDDMDataFactory.newDDMStructureLinkModel(_entry)>
