 ...
 * @see com.liferay.portal.tools.service.builder.test.service.persistence.impl.LVEntryLocalizationVersionPersistenceImpl
 * @see LVEntryLocalizationVersionUtil
 * @generated
 */
@ProviderType
public interface LVEntryLocalizationVersionPersistence extends BasePersistence<LVEntryLocalizationVersion> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<LVEntryLocalizationVersion> findByLvEntryLocalizationId(
	...
	*/
	public java.util.List<LVEntryLocalizationVersion> findByLvEntryLocalizationId(
		long lvEntryLocalizationId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LVEntryLocalizationVersion> orderByComparator);
	...
	* @return the matching lv entry localization versions
	*/
	public java.util.List<LVEntryLocalizationVersion> findByLvEntryId_LanguageId(
	...
	*/
	public java.util.List<LVEntryLocalizationVersion> findAll(int start, int end);
	...
	*/
	public java.util.List<LVEntryLocalizationVersion> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<LVEntryLocalizationVersion> orderByComparator);
