...
public class KBTemplatePersistenceImpl
	...
	public void clearCache(KBTemplate kbTemplate) {
		...
		entityCache.removeResult(
			entityCacheEnabled, KBTemplateImpl.class, kbTemplate,
	...
	public KBTemplate updateImpl(KBTemplate kbTemplate) {
		...
		entityCache.putResult(
			entityCacheEnabled, KBTemplateImpl.class, kbTemplate, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, KBTemplateImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, KBTemplateImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kbTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {kbTemplateModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {kbTemplateModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {kbTemplateModelImpl.getGroupId()};
				}
