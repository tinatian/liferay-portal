...
public class SyncDevicePersistenceImpl
	...
	public void clearCache(SyncDevice syncDevice) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SyncDeviceImpl.class, syncDevice,
	...
	public SyncDevice updateImpl(SyncDevice syncDevice) {
		...
		entityCache.putResult(
			entityCacheEnabled, SyncDeviceImpl.class, syncDevice, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SyncDeviceImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", SyncDeviceModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"UserId", SyncDeviceModelImpl.USERID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((syncDeviceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {syncDeviceModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {syncDeviceModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {syncDeviceModelImpl.getUserId()};
				}
