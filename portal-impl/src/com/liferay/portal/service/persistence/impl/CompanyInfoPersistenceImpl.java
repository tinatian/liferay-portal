...
public class CompanyInfoPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByCompanyId = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "CompanyId", "fetchByCompanyId",
	...
	private FinderPath _createFinderPath(
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				CompanyInfoModelImpl.FINDER_CACHE_ENABLED, returnClass,
				cacheName, methodName, params);
		}

		FinderPath finderPath = new FinderPath(
			CompanyInfoModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
