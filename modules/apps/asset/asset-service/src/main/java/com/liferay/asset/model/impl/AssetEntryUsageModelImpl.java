...
public class AssetEntryUsageModelImpl
	...
	private AssetEntryUsageCacheModel _toAssetEntryUsageCacheModel() {
		AssetEntryUsageCacheModel assetEntryUsageCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			assetEntryUsageCacheModel -> {
				Long createDate = assetEntryUsageCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			assetEntryUsageCacheModel -> {
				Long modifiedDate = assetEntryUsageCacheModel.modifiedDate;
