...
public class CTCollectionModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		CTCollectionCacheModel ctCollectionCacheModel = _ctCollectionCacheModel;

		if (ctCollectionCacheModel == null) {
			ctCollectionCacheModel = _dummyCTCollectionCacheModel;
		}

		return (T)function.apply(ctCollectionCacheModel);
	}

	private CTCollectionCacheModel _toCTCollectionCacheModel() {
		CTCollectionCacheModel ctCollectionCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			ctCollectionCacheModel -> {
				Long createDate = ctCollectionCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			ctCollectionCacheModel -> {
				Long modifiedDate = ctCollectionCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"statusDate",
			ctCollectionCacheModel -> {
				Long statusDate = ctCollectionCacheModel.statusDate;
