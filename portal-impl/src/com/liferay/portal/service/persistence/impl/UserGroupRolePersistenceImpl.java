...
public class UserGroupRolePersistenceImpl
	...
	public UserGroupRole updateImpl(UserGroupRole userGroupRole) {
		...
		EntityCacheUtil.putResult(
			UserGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupRoleImpl.class, userGroupRoleModelImpl, false,
			UserGroupRoleModelImpl.COLUMN_BITMASK_ENABLED);
	...
	private FinderPath _createFinderPath(
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				UserGroupRoleModelImpl.FINDER_CACHE_ENABLED, returnClass,
				cacheName, methodName, params);
		}

		FinderPath finderPath = new FinderPath(
			UserGroupRoleModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
