...
create unique index IX_523E5C67 on OAuth2Application (companyId, clientId[$COLUMN_LENGTH:75$]);
...
create unique index IX_8E6F6B4B on OAuth2ScopeGrant (oA2AScopeAliasesId, companyId, applicationName[$COLUMN_LENGTH:255$], bundleSymbolicName[$COLUMN_LENGTH:255$], scope[$COLUMN_LENGTH:240$]);