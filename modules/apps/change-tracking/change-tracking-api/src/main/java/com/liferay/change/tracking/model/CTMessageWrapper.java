...
public class CTMessageWrapper
	...
	/**
	 * Returns the user ID of this ct message.
	 *
	 * @return the user ID of this ct message
	 */
	@Override
	...
	/**
	 * Returns the user uuid of this ct message.
	 *
	 * @return the user uuid of this ct message
	 */
	@Override
	...
	/**
	 * Sets the user ID of this ct message.
	 *
	 * @param userId the user ID of this ct message
	 */
	@Override
	...
	/**
	 * Sets the user uuid of this ct message.
	 *
	 * @param userUuid the user uuid of this ct message
	 */
	@Override
