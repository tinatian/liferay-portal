...
public class EntryPersistenceImpl
	...
	public void clearCache(Entry entry) {
		...
		entityCache.removeResult(
			entityCacheEnabled, EntryImpl.class, entry, _columnBitmaskEnabled);
	}
	...
	public void clearCache(List<Entry> entries) {
		...
		for (Entry entry : entries) {
			entityCache.removeResult(
				entityCacheEnabled, EntryImpl.class, entry,
	...
	public Entry updateImpl(Entry entry) {
		...
		entityCache.putResult(
			entityCacheEnabled, EntryImpl.class, entry, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, EntryImpl.class,
		...
		_finderPathWithoutPaginationFindByCreateDate = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("CreateDate"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("CreateDate"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByCreateDate,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByCreateDate,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByFromUserId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("FromUserId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("FromUserId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByFromUserId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByFromUserId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_F,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByF_T = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("F_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("F_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByF_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByF_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByC_F_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_F_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_F_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_F_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_F_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByF_T_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("F_T_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("F_T_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByF_T_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByF_T_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CreateDate", EntryModelImpl.CREATEDATE_COLUMN_BITMASK);
	...
	static {
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((entryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CreateDate")) != 0)) {

					return new Object[] {entryModelImpl.getCreateDate()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((entryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("FromUserId")) != 0)) {

					return new Object[] {entryModelImpl.getFromUserId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {entryModelImpl.getToUserId()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {entryModelImpl.getOriginalToUserId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((entryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("F_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((entryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_F_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((entryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("F_T_C")) != 0)) {
