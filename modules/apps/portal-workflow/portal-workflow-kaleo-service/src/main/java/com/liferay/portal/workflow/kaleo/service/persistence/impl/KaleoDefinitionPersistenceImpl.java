...
public class KaleoDefinitionPersistenceImpl extends BasePersistenceImpl<KaleoDefinition>
	...
	public KaleoDefinition fetchByC_N_V(long companyId, String name,
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(_finderPathFetchByC_N_V, finderArgs,
						list);
				}
				else {
					if (list.size() > 1) {
	...
	public KaleoDefinition fetchByC_N_A(long companyId, String name,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_N_A_COMPANYID_2_SQL);

			boolean bindName = false;

			if (name.isEmpty()) {
				query.append(_FINDER_COLUMN_C_N_A_NAME_3_SQL);
			}
			else {
				bindName = true;

				query.append(_FINDER_COLUMN_C_N_A_NAME_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(_finderPathFetchByC_N_A, finderArgs,
						list);
				}
				else {
					if (list.size() > 1) {
				...
				finderCache.removeResult(_finderPathFetchByC_N_A, finderArgs);
	...
	public void cacheResult(KaleoDefinition kaleoDefinition) {
		...
		finderCache.putResult(_finderPathFetchByC_N_V,
			new Object[] {
				kaleoDefinition.getCompanyId(), kaleoDefinition.getName(),
				kaleoDefinition.getVersion()
			}, kaleoDefinition);

		finderCache.putResult(_finderPathFetchByC_N_A,
			new Object[] {
				kaleoDefinition.getCompanyId(), kaleoDefinition.getName(),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(_finderPathCountByC_N_V, args, Long.valueOf(1),
			false);
		finderCache.putResult(_finderPathFetchByC_N_V, args,
			kaleoDefinitionModelImpl, false);
		...
		finderCache.putResult(_finderPathCountByC_N_A, args, Long.valueOf(1),
			false);
		finderCache.putResult(_finderPathFetchByC_N_A, args,
			kaleoDefinitionModelImpl, false);
	}
	...
	public KaleoDefinition updateImpl(KaleoDefinition kaleoDefinition) {
		...
		if (!KaleoDefinitionModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
			Object[] args = new Object[] { kaleoDefinitionModelImpl.getCompanyId() };
			...
			finderCache.removeResult(_finderPathWithoutPaginationFindByC_A, args);
			...
			if ((kaleoDefinitionModelImpl.getColumnBitmask() &
				...
				finderCache.removeResult(_finderPathCountByC_A, args);
				finderCache.removeResult(_finderPathWithoutPaginationFindByC_A,
					args);
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class,
				FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll",
				new String[0]);

		_finderPathCountAll = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
				new String[0]);

		_finderPathWithPaginationFindByCompanyId = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class,
		...
		_finderPathWithoutPaginationFindByCompanyId = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class,
		...
		_finderPathCountByCompanyId = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompanyId",
				new String[] { Long.class.getName() });

		_finderPathFetchByC_N = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
		...
		_finderPathCountByC_N = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_N",
				new String[] { Long.class.getName(), String.class.getName() });

		_finderPathWithPaginationFindByC_A = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class,
		...
		_finderPathWithoutPaginationFindByC_A = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class,
		...
		_finderPathCountByC_A = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_A",
				new String[] { Long.class.getName(), Boolean.class.getName() });

		_finderPathFetchByC_N_V = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class, FINDER_CLASS_NAME_ENTITY,
				"fetchByC_N_V",
				new String[] {
		...
		_finderPathCountByC_N_V = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathFetchByC_N_A = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
				KaleoDefinitionImpl.class, FINDER_CLASS_NAME_ENTITY,
				"fetchByC_N_A",
				new String[] {
		...
		_finderPathCountByC_N_A = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
				KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED, Long.class,
