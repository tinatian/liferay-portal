...
public class SegmentsEntryPersistenceImpl
	...
	public void clearCache(SegmentsEntry segmentsEntry) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SegmentsEntryImpl.class, segmentsEntry,
	...
	public SegmentsEntry updateImpl(SegmentsEntry segmentsEntry) {
		...
		entityCache.putResult(
			entityCacheEnabled, SegmentsEntryImpl.class, segmentsEntryModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindBySource = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "Source", "findBySource",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			});

		_finderPathWithoutPaginationFindBySource = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "Source", "findBySource",
			new String[] {String.class.getName()});

		_finderPathCountBySource = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "Source",
		...
		_finderPathFetchByG_S = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_S", "fetchByG_S",
		...
		_finderPathWithPaginationCountByG_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_A", "countByG_A",
			new String[] {Long.class.getName(), Boolean.class.getName()});

		_finderPathWithPaginationFindByA_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "A_T", "findByA_T",
			new String[] {
		...
		_finderPathWithoutPaginationFindByA_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "A_T", "findByA_T",
			new String[] {Boolean.class.getName(), String.class.getName()});

		_finderPathCountByA_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "A_T", "countByA_T",
			new String[] {Boolean.class.getName(), String.class.getName()});

		_finderPathWithPaginationFindByG_A_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_A_T", "findByG_A_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_A_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_A_T", "findByG_A_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			});

		_finderPathCountByG_A_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_A_T", "countByG_A_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			});

		_finderPathWithPaginationCountByG_A_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_A_T", "countByG_A_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			});

		_finderPathWithPaginationFindByG_A_S_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_A_S_T", "findByG_A_S_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_A_S_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_A_S_T",
			"findByG_A_S_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), String.class.getName()
		...
		_finderPathCountByG_A_S_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_A_S_T",
			"countByG_A_S_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
		...
		_finderPathWithPaginationCountByG_A_S_T = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_A_S_T", "countByG_A_S_T",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), String.class.getName()
			});
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SegmentsEntryImpl.class;
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {segmentsEntryModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {segmentsEntryModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Source")) != 0)) {

					return new Object[] {segmentsEntryModelImpl.getSource()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {segmentsEntryModelImpl.getType()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("A_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_A_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_A_S_T")) != 0)) {
