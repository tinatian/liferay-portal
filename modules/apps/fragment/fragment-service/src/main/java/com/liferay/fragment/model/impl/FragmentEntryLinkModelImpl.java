...
public class FragmentEntryLinkModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (fragmentEntryLinkCacheModel == null) {
			fragmentEntryLinkCacheModel = _dummyFragmentEntryLinkCacheModel;
		}

		return (T)function.apply(fragmentEntryLinkCacheModel);
	}

	private FragmentEntryLinkCacheModel _toFragmentEntryLinkCacheModel() {
		FragmentEntryLinkCacheModel fragmentEntryLinkCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			fragmentEntryLinkCacheModel -> {
				Long createDate = fragmentEntryLinkCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			fragmentEntryLinkCacheModel -> {
				Long modifiedDate = fragmentEntryLinkCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			...
			fragmentEntryLinkCacheModel -> {
				...
				return new Date(lastPropagationDate);
			});
