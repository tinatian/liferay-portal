	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByCompanyId = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {messageModelImpl.getOriginalCompanyId()};
			});
		...
		_finderPathWithPaginationFindByFolderId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MessageImpl.class,
		...
		_finderPathWithoutPaginationFindByFolderId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MessageImpl.class,
			...
			baseModel -> {
				...
				return new Object[] {messageModelImpl.getOriginalFolderId()};
			});

		_finderPathCountByFolderId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, Long.class,
		...
		_finderPathFetchByF_R = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, MessageImpl.class,
		...
		_finderPathCountByF_R = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, Long.class,
