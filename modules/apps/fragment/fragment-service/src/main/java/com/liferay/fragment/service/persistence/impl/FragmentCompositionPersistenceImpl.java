...
public class FragmentCompositionPersistenceImpl
	...
	public void clearCache(FragmentComposition fragmentComposition) {
		...
		entityCache.removeResult(
			entityCacheEnabled, FragmentCompositionImpl.class,
			fragmentComposition, _columnBitmaskEnabled);
	}
	...
	public FragmentComposition updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, FragmentCompositionImpl.class,
			fragmentComposition, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, FragmentCompositionImpl.class,
		...
		_finderPathFetchByG_FCK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_FCK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((fragmentCompositionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_FCK")) != 0)) {
