...
public class TranslationEntryModelImpl
	...
	private TranslationEntryCacheModel _toTranslationEntryCacheModel() {
		TranslationEntryCacheModel translationEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			translationEntryCacheModel -> {
				Long createDate = translationEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			translationEntryCacheModel -> {
				Long modifiedDate = translationEntryCacheModel.modifiedDate;
