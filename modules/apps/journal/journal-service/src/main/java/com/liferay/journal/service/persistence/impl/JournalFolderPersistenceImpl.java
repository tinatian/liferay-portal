...
public class JournalFolderPersistenceImpl
	...
	public void cacheResult(JournalFolder journalFolder) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_N"),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_N"), args,
			journalFolderModelImpl, false);
	...
	public JournalFolder updateImpl(JournalFolder journalFolder) {
		...
		entityCache.putResult(
			entityCacheEnabled, JournalFolderImpl.class,
			journalFolderModelImpl.getPrimaryKey(), journalFolderModelImpl,
			false,
			new Object[] {
				_columnBitmaskEnabled, journalFolderModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_N");
