...
public class ReadingTimeEntryModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (readingTimeEntryCacheModel == null) {
			readingTimeEntryCacheModel = _dummyReadingTimeEntryCacheModel;
		}

		return (T)function.apply(readingTimeEntryCacheModel);
	}

	private ReadingTimeEntryCacheModel _toReadingTimeEntryCacheModel() {
		ReadingTimeEntryCacheModel readingTimeEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			readingTimeEntryCacheModel -> {
				Long createDate = readingTimeEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			readingTimeEntryCacheModel -> {
				Long modifiedDate = readingTimeEntryCacheModel.modifiedDate;
