...
public class LayoutClassedModelUsagePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByCK_CT_P = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutClassedModelUsageImpl.class,
			LayoutClassedModelUsageImpl.class,
		...
		_finderPathWithoutPaginationFindByCK_CT_P = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutClassedModelUsageImpl.class,
			LayoutClassedModelUsageImpl.class,
		...
		_finderPathCountByCK_CT_P = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutClassedModelUsageImpl.class, Long.class,
		...
		_finderPathFetchByC_C_CK_CT_P = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutClassedModelUsageImpl.class,
			LayoutClassedModelUsageImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_C_CK_CT_P",
		...
		_finderPathCountByC_C_CK_CT_P = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutClassedModelUsageImpl.class, Long.class,
