...
public class FragmentEntryVersionPersistenceImpl
	...
	public int countByG_FEK_Version(
		...
		Object[] finderArgs = new Object[] {groupId, fragmentEntryKey, version};
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, FragmentEntryVersionImpl.class, primaryKey);
		}
	}
	...
	public FragmentEntryVersion updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, FragmentEntryVersionImpl.class,
			fragmentEntryVersion, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, FragmentEntryVersionImpl.class,
		...
		_finderPathWithoutPaginationFindByFragmentEntryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("FragmentEntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("FragmentEntryId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByFragmentEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByFragmentEntryId_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("FragmentEntryId_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("FragmentEntryId_Version"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByFragmentEntryId_Version,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByFragmentEntryId_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByUuid_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Uuid_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Uuid_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByUuid_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByUUID_G,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByUUID_G_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("UUID_G_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("UUID_G_Version"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByUUID_G_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByUUID_G_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByUuid_C_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Uuid_C_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Uuid_C_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByUuid_C_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByGroupId_Version = new FinderPath(
			...
			new String[] {Long.class.getName(), Integer.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("GroupId_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("GroupId_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByGroupId_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByFragmentCollectionId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("FragmentCollectionId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("FragmentCollectionId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByFragmentCollectionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByFragmentCollectionId_Version =
			new FinderPath(
				...
				"findByFragmentCollectionId_Version",
				new String[] {Long.class.getName(), Integer.class.getName()},
				_ARGUMENTS_BIFUNCTION_MAP.get("FragmentCollectionId_Version"),
				_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get(
		...
		_finderPathWithoutPaginationFindByG_FCI = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_FCI,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FEK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FEK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FEK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_FEK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FEK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByG_FEK_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FEK_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FEK_Version"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_FEK_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FEK_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_LikeN = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_FCI_LikeN,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_LikeN,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_LikeN_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_LikeN_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_FCI_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_T_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_T_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_FCI_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_S_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_S_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_S_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_S_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_LikeN_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN_S"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_LikeN_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_LikeN_S_Version =
			new FinderPath(
				...
				_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN_S_Version"),
				_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get(
		...
		_finderPathCountByG_FCI_LikeN_S_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN_S_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_LikeN_S_Version"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_LikeN_S_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_T_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_FCI_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_FCI_T_S_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T_S_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_FCI_T_S_Version"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_FCI_T_S_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.fragment.model.FragmentEntryVersion"),
			true);
	}
