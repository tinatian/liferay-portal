...
public class FragmentCompositionPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			FragmentCompositionImpl.class, FragmentCompositionImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			FragmentCompositionImpl.class, Long.class,
		...
		_finderPathFetchByG_FCK = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			FragmentCompositionImpl.class, FragmentCompositionImpl.class,
		...
		_finderPathCountByG_FCK = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			FragmentCompositionImpl.class, Long.class,
