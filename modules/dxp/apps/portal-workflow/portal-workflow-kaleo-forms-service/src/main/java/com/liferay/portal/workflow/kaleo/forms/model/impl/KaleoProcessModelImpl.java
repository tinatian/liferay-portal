...
public class KaleoProcessModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		KaleoProcessCacheModel kaleoProcessCacheModel = _kaleoProcessCacheModel;

		if (kaleoProcessCacheModel == null) {
			kaleoProcessCacheModel = _dummyKaleoProcessCacheModel;
		}

		return (T)function.apply(kaleoProcessCacheModel);
	}

	private KaleoProcessCacheModel _toKaleoProcessCacheModel() {
		KaleoProcessCacheModel kaleoProcessCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			kaleoProcessCacheModel -> {
				Long createDate = kaleoProcessCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			kaleoProcessCacheModel -> {
				Long modifiedDate = kaleoProcessCacheModel.modifiedDate;
