...
public class TranslationEntryPersistenceImpl
	...
	public void clearCache(TranslationEntry translationEntry) {
		...
		clearUniqueFindersCache(
			(TranslationEntryModelImpl)translationEntry, true);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, translationEntryModelImpl, false);
	...
	protected void clearUniqueFindersCache(
		...
		if ((translationEntryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				translationEntryModelImpl.getCacheModelAttribute("uuid"),
				translationEntryModelImpl.getCacheModelAttribute("groupId")
			};
		...
		if ((translationEntryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				translationEntryModelImpl.getCacheModelAttribute("classNameId"),
				translationEntryModelImpl.getCacheModelAttribute("classPK"),
				translationEntryModelImpl.getCacheModelAttribute("languageId")
			};
	...
	public TranslationEntry updateImpl(TranslationEntry translationEntry) {
		...
		if (isNew) {
			Object[] args = new Object[] {translationEntryModelImpl.getUuid()};
			...
			args = new Object[] {
				translationEntryModelImpl.getUuid(),
				translationEntryModelImpl.getCompanyId()
			};
			...
			if ((translationEntryModelImpl.getColumnBitmask() &
				...
				args = new Object[] {translationEntryModelImpl.getUuid()};
			...
			if ((translationEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					translationEntryModelImpl.getCacheModelAttribute("uuid"),
					translationEntryModelImpl.getCacheModelAttribute(
						"companyId")
				};
		...
		entityCache.putResult(
			TranslationEntryImpl.class, translationEntry.getPrimaryKey(),
			translationEntry, false);

		clearUniqueFindersCache(translationEntryModelImpl, false);
	...
	public void activate() {
		_finderPathWithPaginationFindAll = new FinderPath(
			TranslationEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	...
	static {
		try {
			Class.forName(TranslationPersistenceConstants.class.getName());
		}
