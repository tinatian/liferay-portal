...
public class MDRRulePersistenceImpl
	...
	public void clearCache(MDRRule mdrRule) {
		...
		entityCache.removeResult(
			entityCacheEnabled, MDRRuleImpl.class, mdrRule,
	...
	public MDRRule updateImpl(MDRRule mdrRule) {
		...
		entityCache.putResult(
			entityCacheEnabled, MDRRuleImpl.class, mdrRule, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, MDRRuleImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, MDRRuleImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mdrRuleModelImpl.getColumnBitmask() &
