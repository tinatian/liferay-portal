...
public class OAuthApplicationModelImpl
	...
	private OAuthApplicationCacheModel _toOAuthApplicationCacheModel() {
		OAuthApplicationCacheModel oAuthApplicationCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			oAuthApplicationCacheModel -> {
				Long createDate = oAuthApplicationCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			oAuthApplicationCacheModel -> {
				Long modifiedDate = oAuthApplicationCacheModel.modifiedDate;
