...
public class DDLRecordSetVersionPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByRS_V", _finderPathFetchByRS_V
			).put(
				"finderPathCountByRS_V", _finderPathCountByRS_V
			).put(
				...
				"finderPathCountByRS_S", _finderPathCountByRS_S
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(DDLRecordSetVersion.class);
	}
