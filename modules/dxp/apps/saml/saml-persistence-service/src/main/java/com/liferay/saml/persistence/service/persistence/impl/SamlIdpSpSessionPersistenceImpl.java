...
public class SamlIdpSpSessionPersistenceImpl
	...
	public void clearCache(SamlIdpSpSession samlIdpSpSession) {
		entityCache.removeResult(
			entityCacheEnabled, SamlIdpSpSessionImpl.class,
			samlIdpSpSession.getPrimaryKey());
	}
	...
	public SamlIdpSpSession updateImpl(SamlIdpSpSession samlIdpSpSession) {
		...
		entityCache.putResult(
			entityCacheEnabled, SamlIdpSpSessionImpl.class,
			samlIdpSpSession.getPrimaryKey(), samlIdpSpSession, false);
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, SamlIdpSpSessionImpl.class,
		...
		_finderPathWithPaginationCountByCreateDate = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, SamlIdpSpSessionImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByCreateDate", new String[] {Date.class.getName()});

		_finderPathWithPaginationFindBySamlIdpSsoSessionId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, SamlIdpSpSessionImpl.class,
			SamlIdpSpSessionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findBySamlIdpSsoSessionId",
			new String[] {
		...
		_finderPathWithoutPaginationFindBySamlIdpSsoSessionId =
			FinderPath.create(
				...
				SamlIdpSpSessionImpl.class, SamlIdpSpSessionImpl.class,
		...
		_finderPathCountBySamlIdpSsoSessionId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, SamlIdpSpSessionImpl.class,
		...
		_finderPathFetchBySISSI_SSEI = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, SamlIdpSpSessionImpl.class,
		...
		_finderPathCountBySISSI_SSEI = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, SamlIdpSpSessionImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countBySISSI_SSEI",
			new String[] {Long.class.getName(), String.class.getName()},
