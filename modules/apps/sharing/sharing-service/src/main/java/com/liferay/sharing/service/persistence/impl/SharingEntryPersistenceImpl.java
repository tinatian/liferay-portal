...
public class SharingEntryPersistenceImpl
	...
	public SharingEntry updateImpl(SharingEntry sharingEntry) {
		...
		entityCache.putResult(
			entityCacheEnabled, SharingEntryImpl.class, sharingEntryModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByToUserId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "ToUserId",
			"findByToUserId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByToUserId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "ToUserId",
		...
		_finderPathWithPaginationFindByTU_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "TU_C", "findByTU_C",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByTU_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "TU_C", "findByTU_C",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathCountByTU_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "TU_C", "countByTU_C",
			new String[] {Long.class.getName(), Long.class.getName()});
		...
		_finderPathFetchByTU_C_C = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "TU_C_C", "fetchByTU_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});

		_finderPathCountByTU_C_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "TU_C_C",
			"countByTU_C_C",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SharingEntryImpl.class;
