...
public class AnalyticsMessageModelImpl
	...
	private AnalyticsMessageCacheModel _toAnalyticsMessageCacheModel() {
		AnalyticsMessageCacheModel analyticsMessageCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			analyticsMessageCacheModel -> {
				Long createDate = analyticsMessageCacheModel.createDate;
