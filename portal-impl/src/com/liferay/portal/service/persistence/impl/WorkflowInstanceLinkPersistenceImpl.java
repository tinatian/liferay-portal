...
public class WorkflowInstanceLinkPersistenceImpl
	...
	public WorkflowInstanceLink updateImpl(
		...
		EntityCacheUtil.putResult(
			...
			false, WorkflowInstanceLinkModelImpl.COLUMN_BITMASK_ENABLED);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = WorkflowInstanceLinkImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				WorkflowInstanceLinkModelImpl.FINDER_CACHE_ENABLED, returnClass,
