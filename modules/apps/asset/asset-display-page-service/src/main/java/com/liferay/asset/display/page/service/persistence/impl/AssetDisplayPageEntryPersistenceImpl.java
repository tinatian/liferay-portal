	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			MapUtil.singletonDictionary(
				"model.class.name", AssetDisplayPageEntry.class.getName()));
		...
		_finderPathWithPaginationFindByLayoutPageTemplateEntryId =
			_createFinderPath(
				...
				"findByLayoutPageTemplateEntryId",
				new String[] {"layoutPageTemplateEntryId"});
	...
	private static class AssetDisplayPageEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					assetDisplayPageEntryModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						assetDisplayPageEntryModelImpl.getAttributeValue(
							attributeName);
				}
			}
