...
public class StatusPersistenceImpl
	...
	public void activate() {
		...
		_finderPathFetchByUserId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
		...
		_finderPathWithPaginationFindByModifiedDate = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
		...
		_finderPathWithoutPaginationFindByModifiedDate = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
			StatusImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByModifiedDate", new String[] {Long.class.getName()},
			StatusModelImpl.MODIFIEDDATE_COLUMN_BITMASK);

		_finderPathCountByModifiedDate = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByModifiedDate", new String[] {Long.class.getName()});

		_finderPathWithPaginationFindByOnline = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
			StatusImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByOnline",
			new String[] {
		...
		_finderPathWithoutPaginationFindByOnline = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
			StatusImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByOnline", new String[] {Boolean.class.getName()},
			StatusModelImpl.ONLINE_COLUMN_BITMASK);

		_finderPathCountByOnline = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByOnline", new String[] {Boolean.class.getName()});

		_finderPathWithPaginationFindByM_O = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
			StatusImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByM_O",
			new String[] {
		...
		_finderPathWithoutPaginationFindByM_O = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
			StatusImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByM_O",
		...
		_finderPathCountByM_O = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, StatusImpl.class,
