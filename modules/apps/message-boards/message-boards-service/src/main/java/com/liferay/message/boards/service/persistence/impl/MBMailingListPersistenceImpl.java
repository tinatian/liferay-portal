...
public class MBMailingListPersistenceImpl
	...
	public MBMailingList updateImpl(MBMailingList mbMailingList) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBMailingListImpl.class, mbMailingListModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByG_C = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_C", "fetchByG_C",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = MBMailingListImpl.class;
