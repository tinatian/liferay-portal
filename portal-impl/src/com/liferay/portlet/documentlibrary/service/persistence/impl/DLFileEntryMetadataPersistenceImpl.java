	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = registry.registerService(
			...
			HashMapBuilder.<String, Object>put(
				"model.class.name", DLFileEntryMetadata.class.getName()
			).build());
		...
		_finderPathFetchByD_F = _createFinderPath(
			...
			"fetchByD_F", new String[] {"DDMStructureId", "fileVersionId"});
	...
	private static class DLFileEntryMetadataModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					dlFileEntryMetadataModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						dlFileEntryMetadataModelImpl.getAttributeValue(
							attributeName);
				}
			}
