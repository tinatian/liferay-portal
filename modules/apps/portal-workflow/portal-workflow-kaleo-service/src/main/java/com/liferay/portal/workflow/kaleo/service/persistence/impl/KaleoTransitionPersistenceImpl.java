...
public class KaleoTransitionPersistenceImpl extends BasePersistenceImpl<KaleoTransition>
	...
	public KaleoTransition fetchByKNI_N(long kaleoNodeId, String name,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_KNI_N_KALEONODEID_2_SQL);

			boolean bindName = false;

			if (name.isEmpty()) {
				query.append(_FINDER_COLUMN_KNI_N_NAME_3_SQL);
			}
			else {
				bindName = true;

				query.append(_FINDER_COLUMN_KNI_N_NAME_2_SQL);
			}
	...
	public KaleoTransition fetchByKNI_DT(long kaleoNodeId,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_KNI_DT_KALEONODEID_2_SQL);

			query.append(_FINDER_COLUMN_KNI_DT_DEFAULTTRANSITION_2_SQL);
