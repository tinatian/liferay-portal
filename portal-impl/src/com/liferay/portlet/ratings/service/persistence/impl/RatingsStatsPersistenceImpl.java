...
public class RatingsStatsPersistenceImpl
	...
	public void clearCache(RatingsStats ratingsStats) {
		...
		EntityCacheUtil.removeResult(
			RatingsStatsModelImpl.ENTITY_CACHE_ENABLED, RatingsStatsImpl.class,
			ratingsStats, RatingsStatsModelImpl.COLUMN_BITMASK_ENABLED);
	}
	...
	public void clearCache(List<RatingsStats> ratingsStatses) {
		...
		for (RatingsStats ratingsStats : ratingsStatses) {
			EntityCacheUtil.removeResult(
				RatingsStatsModelImpl.ENTITY_CACHE_ENABLED,
				RatingsStatsImpl.class, ratingsStats,
	...
	public RatingsStats updateImpl(RatingsStats ratingsStats) {
		...
		EntityCacheUtil.putResult(
			RatingsStatsModelImpl.ENTITY_CACHE_ENABLED, RatingsStatsImpl.class,
			ratingsStats, false, RatingsStatsModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationCountByC_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_C", "countByC_C",
			new String[] {Long.class.getName(), Long.class.getName()});
	}
	...
	private FinderPath _createFinderPath(
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				RatingsStatsModelImpl.FINDER_CACHE_ENABLED, returnClass,
				cacheName, methodName, params);
		}

		FinderPath finderPath = new FinderPath(
			RatingsStatsModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
