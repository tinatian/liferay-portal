...
/**
 * The persistence utility for the ct collection service. This utility wraps {@link com.liferay.change.tracking.service.persistence.impl.CTCollectionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.liferay.change.tracking.service.persistence.impl.CTCollectionPersistenceImpl
 * @generated
 */
@ProviderType
public class CTCollectionUtil {
	...
	*/
	public static List<CTCollection> findByCompanyId(long companyId, int start,
		int end) {
	...
	*/
	public static CTCollection findByCompanyId_First(long companyId,
		OrderByComparator<CTCollection> orderByComparator)
	...
	*/
	public static CTCollection fetchByCompanyId_First(long companyId,
		OrderByComparator<CTCollection> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchCollectionException if a matching ct collection could not be found
	*/
	public static CTCollection findByCompanyId_Last(long companyId,
		OrderByComparator<CTCollection> orderByComparator)
		throws com.liferay.change.tracking.exception.NoSuchCollectionException {
		return getPersistence()
	...
	*/
	public static CTCollection fetchByCompanyId_Last(long companyId,
		OrderByComparator<CTCollection> orderByComparator) {
		return getPersistence()
	...
	*/
	public static CTCollection[] findByCompanyId_PrevAndNext(
		...
		throws com.liferay.change.tracking.exception.NoSuchCollectionException {
		return getPersistence()
				   .findByCompanyId_PrevAndNext(ctCollectionId, companyId,
			orderByComparator);
	}
	...
	*/
	...
	private static ServiceTracker<CTCollectionPersistence, CTCollectionPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CTCollectionPersistence.class);

		ServiceTracker<CTCollectionPersistence, CTCollectionPersistence> serviceTracker =
			new ServiceTracker<CTCollectionPersistence, CTCollectionPersistence>(bundle.getBundleContext(),
