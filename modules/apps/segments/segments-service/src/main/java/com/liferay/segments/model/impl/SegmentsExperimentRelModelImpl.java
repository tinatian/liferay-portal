...
public class SegmentsExperimentRelModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (segmentsExperimentRelCacheModel == null) {
			segmentsExperimentRelCacheModel =
				_dummySegmentsExperimentRelCacheModel;
		}

		return (T)function.apply(segmentsExperimentRelCacheModel);
	}

	private SegmentsExperimentRelCacheModel
		_toSegmentsExperimentRelCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			segmentsExperimentRelCacheModel -> {
				Long createDate = segmentsExperimentRelCacheModel.createDate;
