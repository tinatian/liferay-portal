...
public class LayoutSetBranchPersistenceImpl extends BasePersistenceImpl<LayoutSetBranch>
	...
	public LayoutSetBranch fetchByG_P_N(long groupId, boolean privateLayout,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_P_N_PRIVATELAYOUT_2_SQL);
	...
	public List<LayoutSetBranch> findByG_P_M(long groupId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_P_M_GROUPID_2_SQL);

			query.append(_FINDER_COLUMN_G_P_M_PRIVATELAYOUT_2_SQL);

			query.append(_FINDER_COLUMN_G_P_M_MASTER_2_SQL);
