...
public class OrgGroupRolePersistenceImpl
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = OrgGroupRoleImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				OrgGroupRoleModelImpl.FINDER_CACHE_ENABLED, returnClass,
				cacheName, methodName, params);
		}

		FinderPath finderPath = new FinderPath(
			OrgGroupRoleModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
