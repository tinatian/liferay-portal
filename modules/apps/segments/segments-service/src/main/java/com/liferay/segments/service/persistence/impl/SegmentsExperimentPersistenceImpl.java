...
public class SegmentsExperimentPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByS_C_C", _finderPathCountByS_C_C
			).put(
				...
				"finderPathCountByS_C_C_S", _finderPathCountByS_C_C_S
			).put(
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(SegmentsExperiment.class);
	}
