...
public class AnalyticsMessagePersistenceImpl
	...
	public void clearCache(AnalyticsMessage analyticsMessage) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AnalyticsMessageImpl.class, analyticsMessage,
	...
	public void clearCache(List<AnalyticsMessage> analyticsMessages) {
		...
		for (AnalyticsMessage analyticsMessage : analyticsMessages) {
			entityCache.removeResult(
				entityCacheEnabled, AnalyticsMessageImpl.class,
				analyticsMessage, _columnBitmaskEnabled);
		}
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AnalyticsMessageImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", AnalyticsMessageModelImpl.COMPANYID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((analyticsMessageModelImpl.getColumnBitmask() &
