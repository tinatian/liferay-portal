...
public class KaleoLogPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByKITI_T = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, KaleoLogImpl.class,
			KaleoLogImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByKITI_T",
			new String[] {
		...
		_finderPathWithoutPaginationFindByKITI_T = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, KaleoLogImpl.class,
			KaleoLogImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByKITI_T",
		...
		_finderPathCountByKITI_T = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, KaleoLogImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByKITI_T",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathWithPaginationFindByKCN_KCPK_KITI_T = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, KaleoLogImpl.class,
			KaleoLogImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByKCN_KCPK_KITI_T",
			new String[] {
		...
		_finderPathCountByKCN_KCPK_KITI_T = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, KaleoLogImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
