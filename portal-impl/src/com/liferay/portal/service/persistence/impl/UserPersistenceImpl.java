...
public class UserPersistenceImpl extends BasePersistenceImpl<User>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2_SQL = "user.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_SQL = "(user.uuid_ IS NULL OR user.uuid_ = '')";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_SQL = "user.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_SQL = "(user.uuid_ IS NULL OR user.uuid_ = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2_SQL = "user.companyId = ?";
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2_SQL = "user.companyId = ? AND user.defaultUser = [$FALSE$]";
	...
	public User fetchByContactId(long contactId, boolean retrieveFromCache) {
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByContactId,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_CONTACTID_CONTACTID_2_SQL);
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByContactId,
						finderArgs, list);
				}
				else {
				...
				FinderCacheUtil.removeResult(_finderPathFetchByContactId,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_CONTACTID_CONTACTID_2_SQL = "user.contactId = ?";
	...
	public List<User> findByEmailAddress(String emailAddress, int start,
		...
		if (list == null) {
			...
			if (emailAddress.isEmpty()) {
				query.append(_FINDER_COLUMN_EMAILADDRESS_EMAILADDRESS_3_SQL);
			}
			else {
				bindEmailAddress = true;

				query.append(_FINDER_COLUMN_EMAILADDRESS_EMAILADDRESS_2_SQL);
			}
	...
	private static final String _FINDER_COLUMN_EMAILADDRESS_EMAILADDRESS_2_SQL = "user.emailAddress = ?";
	private static final String _FINDER_COLUMN_EMAILADDRESS_EMAILADDRESS_3_SQL = "(user.emailAddress IS NULL OR user.emailAddress = '')";
	...
	public User fetchByPortraitId(long portraitId, boolean retrieveFromCache) {
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByPortraitId,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_PORTRAITID_PORTRAITID_2_SQL);
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByPortraitId,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
				...
				FinderCacheUtil.removeResult(_finderPathFetchByPortraitId,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_PORTRAITID_PORTRAITID_2_SQL = "user.portraitId = ?";
	...
	public List<User> findByU_C(long userId, long companyId, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_U_C_COMPANYID_2_SQL);
	...
	private static final String _FINDER_COLUMN_U_C_USERID_2_SQL = "user.userId > ? AND ";
	private static final String _FINDER_COLUMN_U_C_COMPANYID_2_SQL = "user.companyId = ? AND user.defaultUser = [$FALSE$]";
	...
	public User fetchByC_U(long companyId, long userId,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_U_USERID_2_SQL);
	...
	private static final String _FINDER_COLUMN_C_U_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_U_USERID_2_SQL = "user.userId = ?";
	...
	public List<User> findByC_CD(long companyId, Date createDate, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_CD_COMPANYID_2_SQL);

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_C_CD_CREATEDATE_1_SQL);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_C_CD_CREATEDATE_2_SQL);
			}
	...
	private static final String _FINDER_COLUMN_C_CD_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_CD_CREATEDATE_1_SQL = "user.createDate IS NULL AND user.defaultUser = [$FALSE$]";
	private static final String _FINDER_COLUMN_C_CD_CREATEDATE_2_SQL = "user.createDate = ? AND user.defaultUser = [$FALSE$]";
	...
	public List<User> findByC_MD(long companyId, Date modifiedDate, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_MD_COMPANYID_2_SQL);

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_C_MD_MODIFIEDDATE_1_SQL);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_C_MD_MODIFIEDDATE_2_SQL);
			}
	...
	private static final String _FINDER_COLUMN_C_MD_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_MD_MODIFIEDDATE_1_SQL = "user.modifiedDate IS NULL AND user.defaultUser = [$FALSE$]";
	private static final String _FINDER_COLUMN_C_MD_MODIFIEDDATE_2_SQL = "user.modifiedDate = ? AND user.defaultUser = [$FALSE$]";
	...
	public User fetchByC_DU(long companyId, boolean defaultUser,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByC_DU,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_DU_COMPANYID_2_SQL);

			query.append(_FINDER_COLUMN_C_DU_DEFAULTUSER_2_SQL);
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByC_DU,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
				...
				FinderCacheUtil.removeResult(_finderPathFetchByC_DU, finderArgs);
	...
	private static final String _FINDER_COLUMN_C_DU_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_DU_DEFAULTUSER_2_SQL = "user.defaultUser = ?";
	...
	public User fetchByC_SN(long companyId, String screenName,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByC_SN,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_SN_COMPANYID_2_SQL);

			boolean bindScreenName = false;

			if (screenName.isEmpty()) {
				query.append(_FINDER_COLUMN_C_SN_SCREENNAME_3_SQL);
			}
			else {
				bindScreenName = true;

				query.append(_FINDER_COLUMN_C_SN_SCREENNAME_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByC_SN,
						finderArgs, list);
				}
				else {
					User user = list.get(0);
				...
				FinderCacheUtil.removeResult(_finderPathFetchByC_SN, finderArgs);
	...
	private static final String _FINDER_COLUMN_C_SN_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_SN_SCREENNAME_2_SQL = "user.screenName = ?";
	private static final String _FINDER_COLUMN_C_SN_SCREENNAME_3_SQL = "(user.screenName IS NULL OR user.screenName = '')";
	...
	public User fetchByC_EA(long companyId, String emailAddress,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByC_EA,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_EA_COMPANYID_2_SQL);

			boolean bindEmailAddress = false;

			if (emailAddress.isEmpty()) {
				query.append(_FINDER_COLUMN_C_EA_EMAILADDRESS_3_SQL);
			}
			else {
				bindEmailAddress = true;

				query.append(_FINDER_COLUMN_C_EA_EMAILADDRESS_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByC_EA,
						finderArgs, list);
				}
				else {
					User user = list.get(0);
				...
				FinderCacheUtil.removeResult(_finderPathFetchByC_EA, finderArgs);
	...
	private static final String _FINDER_COLUMN_C_EA_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_EA_EMAILADDRESS_2_SQL = "user.emailAddress = ?";
	private static final String _FINDER_COLUMN_C_EA_EMAILADDRESS_3_SQL = "(user.emailAddress IS NULL OR user.emailAddress = '')";
	...
	public User fetchByC_FID(long companyId, long facebookId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByC_FID,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_FID_COMPANYID_2_SQL);

			query.append(_FINDER_COLUMN_C_FID_FACEBOOKID_2_SQL);
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByC_FID,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
				...
				FinderCacheUtil.removeResult(_finderPathFetchByC_FID, finderArgs);
	...
	private static final String _FINDER_COLUMN_C_FID_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_FID_FACEBOOKID_2_SQL = "user.facebookId = ?";
	...
	public User fetchByC_GUID(long companyId, String googleUserId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByC_GUID,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_GUID_COMPANYID_2_SQL);

			boolean bindGoogleUserId = false;

			if (googleUserId.isEmpty()) {
				query.append(_FINDER_COLUMN_C_GUID_GOOGLEUSERID_3_SQL);
			}
			else {
				bindGoogleUserId = true;

				query.append(_FINDER_COLUMN_C_GUID_GOOGLEUSERID_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByC_GUID,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
				...
				FinderCacheUtil.removeResult(_finderPathFetchByC_GUID,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_C_GUID_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_GUID_GOOGLEUSERID_2_SQL = "user.googleUserId = ?";
	private static final String _FINDER_COLUMN_C_GUID_GOOGLEUSERID_3_SQL = "(user.googleUserId IS NULL OR user.googleUserId = '')";
	...
	public User fetchByC_O(long companyId, String openId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByC_O,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_O_COMPANYID_2_SQL);

			boolean bindOpenId = false;

			if (openId.isEmpty()) {
				query.append(_FINDER_COLUMN_C_O_OPENID_3_SQL);
			}
			else {
				bindOpenId = true;

				query.append(_FINDER_COLUMN_C_O_OPENID_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByC_O,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
	...
	private static final String _FINDER_COLUMN_C_O_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_O_OPENID_2_SQL = "user.openId = ?";
	private static final String _FINDER_COLUMN_C_O_OPENID_3_SQL = "(user.openId IS NULL OR user.openId = '')";
	...
	private static final String _FINDER_COLUMN_C_S_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_S_STATUS_2_SQL = "user.status = ? AND user.defaultUser = [$FALSE$]";
	...
	public List<User> findByC_CD_MD(long companyId, Date createDate,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_CD_MD_COMPANYID_2_SQL);

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_C_CD_MD_CREATEDATE_1_SQL);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_C_CD_MD_CREATEDATE_2_SQL);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_C_CD_MD_MODIFIEDDATE_1_SQL);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_C_CD_MD_MODIFIEDDATE_2_SQL);
			}
	...
	private static final String _FINDER_COLUMN_C_CD_MD_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_CD_MD_CREATEDATE_1_SQL = "user.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_C_CD_MD_CREATEDATE_2_SQL = "user.createDate = ? AND ";
	private static final String _FINDER_COLUMN_C_CD_MD_MODIFIEDDATE_1_SQL = "user.modifiedDate IS NULL AND user.defaultUser = [$FALSE$]";
	private static final String _FINDER_COLUMN_C_CD_MD_MODIFIEDDATE_2_SQL = "user.modifiedDate = ? AND user.defaultUser = [$FALSE$]";
	...
	public List<User> findByC_DU_S(long companyId, boolean defaultUser,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_DU_S_COMPANYID_2_SQL);

			query.append(_FINDER_COLUMN_C_DU_S_DEFAULTUSER_2_SQL);

			query.append(_FINDER_COLUMN_C_DU_S_STATUS_2_SQL);
	...
	private static final String _FINDER_COLUMN_C_DU_S_COMPANYID_2_SQL = "user.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_DU_S_DEFAULTUSER_2_SQL = "user.defaultUser = ? AND ";
	private static final String _FINDER_COLUMN_C_DU_S_STATUS_2_SQL = "user.status = ?";
	...
	public User fetchByC_ERC(long companyId, String externalReferenceCode,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_ERC_COMPANYID_2_SQL);

			boolean bindExternalReferenceCode = false;

			if (externalReferenceCode.isEmpty()) {
				query.append(_FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_3_SQL);
			}
			else {
				bindExternalReferenceCode = true;

				query.append(_FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_2_SQL);
			}
	...
	private static final String _FINDER_COLUMN_C_ERC_COMPANYID_2_SQL = "user.companyId = ? AND ";
	...
	protected void cacheUniqueFindersCache(UserModelImpl userModelImpl) {
		...
		FinderCacheUtil.putResult(_finderPathCountByContactId, args,
			Long.valueOf(1), false);
		FinderCacheUtil.putResult(_finderPathFetchByContactId, args,
			userModelImpl, false);

		args = new Object[] { userModelImpl.getPortraitId() };

		FinderCacheUtil.putResult(_finderPathCountByPortraitId, args,
			Long.valueOf(1), false);
		FinderCacheUtil.putResult(_finderPathFetchByPortraitId, args,
			userModelImpl, false);
		...
		FinderCacheUtil.putResult(_finderPathCountByC_DU, args,
			Long.valueOf(1), false);
		...
		FinderCacheUtil.putResult(_finderPathCountByC_SN, args,
			Long.valueOf(1), false);
		...
		FinderCacheUtil.putResult(_finderPathCountByC_EA, args,
			Long.valueOf(1), false);
		...
		FinderCacheUtil.putResult(_finderPathCountByC_FID, args,
			Long.valueOf(1), false);
		...
		FinderCacheUtil.putResult(_finderPathCountByC_GUID, args,
			Long.valueOf(1), false);
		FinderCacheUtil.putResult(_finderPathFetchByC_GUID, args,
			userModelImpl, false);
	...
	public User updateImpl(User user) {
		...
		if (!UserModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByEmailAddress,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByC_CD,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByC_MD,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByC_CD_MD,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByC_DU_S,
				args);
			...
			if ((userModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByEmailAddress.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						userModelImpl.getOriginalEmailAddress()
					};

				FinderCacheUtil.removeResult(_finderPathCountByEmailAddress,
					args);
				FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByEmailAddress,
					args);
			...
			if ((userModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByC_CD.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						userModelImpl.getOriginalCompanyId(),
			...
			if ((userModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByC_MD.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						userModelImpl.getOriginalCompanyId(),
			...
			if ((userModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByC_CD_MD.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						userModelImpl.getOriginalCompanyId(),
						userModelImpl.getOriginalCreateDate(),
						userModelImpl.getOriginalModifiedDate()
			...
			if ((userModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByC_DU_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						userModelImpl.getOriginalCompanyId(),
						userModelImpl.getOriginalDefaultUser(),
						userModelImpl.getOriginalStatus()
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
				FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll",
				new String[0]);

		_finderPathCountAll = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
				new String[0]);

		_finderPathWithPaginationFindByUuid = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
				new String[] { String.class.getName() },
				UserModelImpl.UUID_COLUMN_BITMASK);

		_finderPathCountByUuid = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
				new String[] { String.class.getName() });

		_finderPathWithPaginationFindByUuid_C = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByUuid_C = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
				new String[] { String.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByCompanyId = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByCompanyId = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCompanyId",
				new String[] { Long.class.getName() },
				UserModelImpl.COMPANYID_COLUMN_BITMASK);

		_finderPathCountByCompanyId = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompanyId",
				new String[] { Long.class.getName() });

		_finderPathFetchByContactId = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
				FINDER_CLASS_NAME_ENTITY, "fetchByContactId",
				new String[] { Long.class.getName() },
				UserModelImpl.CONTACTID_COLUMN_BITMASK);

		_finderPathCountByContactId = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByContactId",
				new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByEmailAddress = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByEmailAddress = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"findByEmailAddress", new String[] { String.class.getName() },
				UserModelImpl.EMAILADDRESS_COLUMN_BITMASK);

		_finderPathCountByEmailAddress = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"countByEmailAddress", new String[] { String.class.getName() });

		_finderPathFetchByPortraitId = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
				FINDER_CLASS_NAME_ENTITY, "fetchByPortraitId",
				new String[] { Long.class.getName() },
				UserModelImpl.PORTRAITID_COLUMN_BITMASK);

		_finderPathCountByPortraitId = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByPortraitId",
				new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByU_C = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithPaginationCountByU_C = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByU_C",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathFetchByC_U = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_U = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_U",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByC_CD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByC_CD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_CD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_CD",
				new String[] { Long.class.getName(), Date.class.getName() });

		_finderPathWithPaginationFindByC_MD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByC_MD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_MD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_MD",
				new String[] { Long.class.getName(), Date.class.getName() });

		_finderPathFetchByC_DU = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_DU = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_DU",
				new String[] { Long.class.getName(), Boolean.class.getName() });

		_finderPathFetchByC_SN = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_SN = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_SN",
				new String[] { Long.class.getName(), String.class.getName() });

		_finderPathFetchByC_EA = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_EA = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_EA",
				new String[] { Long.class.getName(), String.class.getName() });

		_finderPathFetchByC_FID = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_FID = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_FID",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathFetchByC_GUID = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_GUID = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_GUID",
				new String[] { Long.class.getName(), String.class.getName() });

		_finderPathFetchByC_O = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_O = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_O",
				new String[] { Long.class.getName(), String.class.getName() });

		_finderPathWithPaginationFindByC_S = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByC_S = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_S = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_S",
				new String[] { Long.class.getName(), Integer.class.getName() });

		_finderPathWithPaginationFindByC_CD_MD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByC_CD_MD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_CD_MD = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationFindByC_DU_S = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathWithoutPaginationFindByC_DU_S = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_DU_S = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathFetchByC_ERC = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, UserImpl.class,
		...
		_finderPathCountByC_ERC = new FinderPath(UserModelImpl.ENTITY_CACHE_ENABLED,
				UserModelImpl.FINDER_CACHE_ENABLED, Long.class,
