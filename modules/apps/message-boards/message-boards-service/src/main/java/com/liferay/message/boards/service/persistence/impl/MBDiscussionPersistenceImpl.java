...
public class MBDiscussionPersistenceImpl
	...
	public MBDiscussion updateImpl(MBDiscussion mbDiscussion) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBDiscussionImpl.class, mbDiscussionModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByThreadId = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "ThreadId", "fetchByThreadId",
