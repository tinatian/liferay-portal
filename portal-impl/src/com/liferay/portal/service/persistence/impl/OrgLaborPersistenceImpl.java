...
public class OrgLaborPersistenceImpl
	...
	public OrgLabor updateImpl(OrgLabor orgLabor) {
		...
		EntityCacheUtil.putResult(
			OrgLaborModelImpl.ENTITY_CACHE_ENABLED, OrgLaborImpl.class,
			orgLaborModelImpl.getPrimaryKey(), orgLaborModelImpl, false,
			new Object[] {
				OrgLaborModelImpl.COLUMN_BITMASK_ENABLED,
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!OrgLaborModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				OrgLaborModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
