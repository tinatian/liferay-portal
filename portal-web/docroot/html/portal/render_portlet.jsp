...
PortletURLImpl urlEdit = new PortletURLImpl(request, portletDisplay.getId(), layout, PortletRequest.RENDER_PHASE);
...
PortletURLImpl urlEditDefaults = new PortletURLImpl(request, portletDisplay.getId(), layout, PortletRequest.RENDER_PHASE);
...
PortletURLImpl urlEditGuest = new PortletURLImpl(request, portletDisplay.getId(), layout, PortletRequest.RENDER_PHASE);
...
PortletURLImpl urlExportImport = new PortletURLImpl(request, PortletKeys.EXPORT_IMPORT, layout, PortletRequest.RENDER_PHASE);
...
PortletURLImpl urlHelp = new PortletURLImpl(request, portletDisplay.getId(), layout, PortletRequest.RENDER_PHASE);
...
PortletURLImpl urlMax = new PortletURLImpl(request, portletDisplay.getId(), layout, lifecycle);
...
PortletURLImpl urlPrint = new PortletURLImpl(request, portletDisplay.getId(), layout, PortletRequest.RENDER_PHASE);
...
PortletURLImpl urlStaging = new PortletURLImpl(request, PortletKeys.EXPORT_IMPORT, layout, PortletRequest.RENDER_PHASE);
