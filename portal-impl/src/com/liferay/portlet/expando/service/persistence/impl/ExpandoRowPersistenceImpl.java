	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByTableId = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {expandoRowModelImpl.getOriginalTableId()};
			});
		...
		_finderPathWithoutPaginationFindByClassPK = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {expandoRowModelImpl.getOriginalClassPK()};
			});
		...
		_finderPathFetchByT_C = FinderPath.create(
			ExpandoRowModelImpl.ENTITY_CACHE_ENABLED,
			ExpandoRowModelImpl.FINDER_CACHE_ENABLED, ExpandoRowImpl.class,
