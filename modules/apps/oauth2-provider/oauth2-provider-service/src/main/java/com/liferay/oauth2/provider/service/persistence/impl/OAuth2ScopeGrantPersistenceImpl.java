...
public class OAuth2ScopeGrantPersistenceImpl
	...
	public void cacheResult(OAuth2ScopeGrant oAuth2ScopeGrant) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_O_A_B_S"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_O_A_B_S"), args,
	...
	public OAuth2ScopeGrant updateImpl(OAuth2ScopeGrant oAuth2ScopeGrant) {
		...
		entityCache.putResult(
			entityCacheEnabled, OAuth2ScopeGrantImpl.class,
			oAuth2ScopeGrantModelImpl.getPrimaryKey(),
			oAuth2ScopeGrantModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_O_A_B_S");
