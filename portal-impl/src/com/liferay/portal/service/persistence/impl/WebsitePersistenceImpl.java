		...
		if (isNew) {
			...
			if ((websiteModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					websiteModelImpl.getCacheModelAttribute("uuid")
				};
			...
			if ((websiteModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					websiteModelImpl.getCacheModelAttribute("uuid"),
					websiteModelImpl.getCacheModelAttribute("companyId")
				};
			...
			if ((websiteModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					websiteModelImpl.getCacheModelAttribute("userId")
				};
			...
			if ((websiteModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					websiteModelImpl.getCacheModelAttribute("companyId"),
					websiteModelImpl.getCacheModelAttribute("classNameId")
				};
			...
			if ((websiteModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					websiteModelImpl.getCacheModelAttribute("companyId"),
					websiteModelImpl.getCacheModelAttribute("classNameId"),
					websiteModelImpl.getCacheModelAttribute("classPK")
				};
			...
			if ((websiteModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					...
					websiteModelImpl.getCacheModelAttribute("classNameId"),
					websiteModelImpl.getCacheModelAttribute("classPK"),
					websiteModelImpl.getCacheModelAttribute("primary")
				};
