	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByCompanyId = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {kaleoTransitionModelImpl.getCompanyId()};
			},
			baseModel -> {
				KaleoTransitionModelImpl kaleoTransitionModelImpl =
					(KaleoTransitionModelImpl)baseModel;
		...
		_finderPathWithoutPaginationFindByKaleoNodeId = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {kaleoTransitionModelImpl.getKaleoNodeId()};
			},
			baseModel -> {
				KaleoTransitionModelImpl kaleoTransitionModelImpl =
					(KaleoTransitionModelImpl)baseModel;
		...
		_finderPathFetchByKNI_N = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, KaleoTransitionImpl.class,
		...
		_finderPathCountByKNI_N = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, Long.class,
		...
		_finderPathFetchByKNI_DT = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, KaleoTransitionImpl.class,
		...
		_finderPathCountByKNI_DT = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, Long.class,
