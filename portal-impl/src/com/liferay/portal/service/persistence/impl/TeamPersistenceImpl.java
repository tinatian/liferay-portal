...
public class TeamPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((teamModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				teamModelImpl.getColumnOriginalValue("uuid_"),
				teamModelImpl.getColumnOriginalValue("groupId")
			};
		...
		if ((teamModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				teamModelImpl.getColumnOriginalValue("groupId"),
				teamModelImpl.getColumnOriginalValue("name")
			};
	...
	public Team updateImpl(Team team) {
		...
		if (isNew) {
			...
			if ((teamModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					teamModelImpl.getColumnOriginalValue("uuid_"),
					teamModelImpl.getColumnOriginalValue("companyId")
				};
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			TeamModelImpl.getColumnBitmask("uuid_") |
