...
public class SocialActivitySetPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByG_U_T", _finderPathCountByG_U_T
			).put(
				...
				"finderPathCountByG_U_C_T", _finderPathCountByG_U_C_T
			).put(
				...
				"finderPathCountByU_C_C_T", _finderPathCountByU_C_C_T
			).build());
	...
	public void destroy() {
		...
		FinderPath.unregisterFinderPaths(SocialActivitySet.class);
	}
