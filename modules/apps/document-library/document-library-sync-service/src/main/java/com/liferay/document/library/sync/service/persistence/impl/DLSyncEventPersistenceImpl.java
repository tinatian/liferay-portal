...
public class DLSyncEventPersistenceImpl
	...
	public void cacheResult(DLSyncEvent dlSyncEvent) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByTypePK"),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByTypePK"), args,
	...
	public DLSyncEvent updateImpl(DLSyncEvent dlSyncEvent) {
		...
		entityCache.putResult(
			entityCacheEnabled, DLSyncEventImpl.class,
			dlSyncEventModelImpl.getPrimaryKey(), dlSyncEventModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, dlSyncEventModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByTypePK");
