...
public class RatingsEntryPersistenceImpl extends BasePersistenceImpl<RatingsEntry>
	...
	public List<RatingsEntry> findByUuid(String uuid, int start, int end,
		...
		if (retrieveFromCache) {
			list = (List<RatingsEntry>)FinderCacheUtil.getResult(finderPath,
					finderArgs, this);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2_SQL = "ratingsEntry.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_SQL = "(ratingsEntry.uuid_ IS NULL OR ratingsEntry.uuid_ = '')";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_SQL = "ratingsEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_SQL = "(ratingsEntry.uuid_ IS NULL OR ratingsEntry.uuid_ = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2_SQL = "ratingsEntry.companyId = ?";
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2_SQL = "ratingsEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2_SQL = "ratingsEntry.classPK = ?";
	 ...
	 */
	@Override
	public List<RatingsEntry> findByU_C_C(long userId, long classNameId,
		long[] classPKs) {
		return findByU_C_C(userId, classNameId, classPKs, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<RatingsEntry> findByU_C_C(long userId, long classNameId,
		long[] classPKs, int start, int end,
		OrderByComparator<RatingsEntry> orderByComparator) {
		return findByU_C_C(userId, classNameId, classPKs, start, end,
			orderByComparator, true);
	}
	...
	public List<RatingsEntry> findByU_C_C(long userId, long classNameId,
		...
		if (classPKs.length == 1) {
			RatingsEntry ratingsEntry = fetchByU_C_C(userId, classNameId,
					classPKs[0]);
		...
		if (retrieveFromCache) {
			list = (List<RatingsEntry>)FinderCacheUtil.getResult(_finderPathWithPaginationFindByU_C_C,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationFindByU_C_C,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationFindByU_C_C,
					finderArgs);
	...
	public RatingsEntry fetchByU_C_C(long userId, long classNameId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByU_C_C,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByU_C_C,
						finderArgs, list);
				}
				else {
				...
				FinderCacheUtil.removeResult(_finderPathFetchByU_C_C, finderArgs);
	...
	public int countByU_C_C(long userId, long classNameId, long[] classPKs) {
		...
		Long count = (Long)FinderCacheUtil.getResult(_finderPathWithPaginationCountByU_C_C,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationCountByU_C_C,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationCountByU_C_C,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_U_C_C_USERID_2_SQL = "ratingsEntry.userId = ? AND ";
	private static final String _FINDER_COLUMN_U_C_C_CLASSNAMEID_2_SQL = "ratingsEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_U_C_C_CLASSPK_2_SQL = "ratingsEntry.classPK = ?";
	private static final String _FINDER_COLUMN_U_C_C_CLASSPK_7_SQL = "ratingsEntry.classPK IN (";
	...
	private static final String _FINDER_COLUMN_C_C_S_CLASSNAMEID_2_SQL = "ratingsEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_S_CLASSPK_2_SQL = "ratingsEntry.classPK = ? AND ";
	private static final String _FINDER_COLUMN_C_C_S_SCORE_2_SQL = "ratingsEntry.score = ?";
	...
	protected void cacheUniqueFindersCache(
		...
		FinderCacheUtil.putResult(_finderPathCountByU_C_C, args,
			Long.valueOf(1), false);
		FinderCacheUtil.putResult(_finderPathFetchByU_C_C, args,
	...
	public RatingsEntry updateImpl(RatingsEntry ratingsEntry) {
		...
		if (!RatingsEntryModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			FinderCacheUtil.removeResult(_finderPathCountByU_C_C, args);
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByU_C_C,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByC_C_S,
				args);
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll",
				new String[0]);

		_finderPathCountAll = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
				new String[0]);

		_finderPathWithPaginationFindByUuid = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByUuid",
				new String[] {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class,
		...
		_finderPathCountByUuid = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
				new String[] { String.class.getName() });

		_finderPathWithPaginationFindByUuid_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByUuid_C",
				new String[] {
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class,
		...
		_finderPathCountByUuid_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
				new String[] { String.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByC_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByC_C",
				new String[] {
		...
		_finderPathWithoutPaginationFindByC_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class,
		...
		_finderPathCountByC_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_C",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByU_C_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByU_C_C",
				new String[] {
		...
		_finderPathWithoutPaginationFindByU_C_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class,
		...
		_finderPathFetchByU_C_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
				"fetchByU_C_C",
				new String[] {
					Long.class.getName(), Long.class.getName(),
					Long.class.getName()
		...
		_finderPathCountByU_C_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationCountByU_C_C = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationFindByC_C_S = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByC_C_S",
				new String[] {
		...
		_finderPathWithoutPaginationFindByC_C_S = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED,
				RatingsEntryImpl.class,
		...
		_finderPathCountByC_C_S = new FinderPath(RatingsEntryModelImpl.ENTITY_CACHE_ENABLED,
				RatingsEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
