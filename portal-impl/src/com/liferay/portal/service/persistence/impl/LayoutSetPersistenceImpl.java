	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = registry.registerService(
			...
			HashMapBuilder.<String, Object>put(
				"model.class.name", LayoutSet.class.getName()
			).build());
		...
		_finderPathWithPaginationFindByLayoutSetPrototypeUuid =
			_createFinderPath(
				LayoutSetImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByLayoutSetPrototypeUuid",
				new String[] {"layoutSetPrototypeUuid"});
		...
		_finderPathWithPaginationFindByC_L = _createFinderPath(
			LayoutSetImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_L", new String[] {"companyId", "layoutSetPrototypeUuid"});
	...
	private static class LayoutSetModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(layoutSetModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			LayoutSetModelImpl layoutSetModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = layoutSetModelImpl.getOriginalAttributeValue(
						attributeName);
				}
				else {
					arguments[i] = layoutSetModelImpl.getAttributeValue(
						attributeName);
				}
			}
