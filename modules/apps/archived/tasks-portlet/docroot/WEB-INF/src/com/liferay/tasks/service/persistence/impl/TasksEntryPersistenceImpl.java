	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = registry.registerService(
			...
			HashMapBuilder.<String, Object>put(
				"model.class.name", TasksEntry.class.getName()
			).build());
		...
		_finderPathWithPaginationFindByAssigneeUserId = _createFinderPath(
			TasksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByAssigneeUserId", new String[] {"assigneeUserId"});
		...
		_finderPathCountByAssigneeUserId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByAssigneeUserId", new String[] {"assigneeUserId"});

		_finderPathWithPaginationFindByResolverUserId = _createFinderPath(
			TasksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByResolverUserId", new String[] {"resolverUserId"});
		...
		_finderPathCountByResolverUserId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByResolverUserId", new String[] {"resolverUserId"});
		...
		_finderPathWithPaginationFindByG_A = _createFinderPath(
			TasksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_A", new String[] {"groupId", "assigneeUserId"});
		...
		_finderPathCountByG_A = _createFinderPath(
			...
			new String[] {"groupId", "assigneeUserId"});

		_finderPathWithPaginationFindByG_R = _createFinderPath(
			TasksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_R", new String[] {"groupId", "resolverUserId"});
		...
		_finderPathCountByG_R = _createFinderPath(
			...
			new String[] {"groupId", "resolverUserId"});

		_finderPathWithPaginationFindByU_S = _createFinderPath(
			TasksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByU_S", new String[] {"userId", "status"});
		...
		_finderPathWithPaginationFindByA_S = _createFinderPath(
			TasksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByA_S", new String[] {"assigneeUserId", "status"});
		...
		_finderPathCountByA_S = _createFinderPath(
			...
			new String[] {"assigneeUserId", "status"});
		...
		_finderPathWithPaginationCountByG_U_S = _createFinderPath(
			...
			new String[] {"groupId", "userId", "status"});

		_finderPathWithPaginationFindByG_A_S = _createFinderPath(
			TasksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_A_S",
			new String[] {"groupId", "assigneeUserId", "status"});
	...
	private static class TasksEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(tasksEntryModelImpl, attributeNames, original);
			}

			long finderPathColumnBitmask = 0;

			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |= tasksEntryModelImpl.getColumnBitmask(
					attributeName);
			}
		...
		private Object[] _getValue(
			TasksEntryModelImpl tasksEntryModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = tasksEntryModelImpl.getAttributeValue(
						attributeName);
				}
			}
