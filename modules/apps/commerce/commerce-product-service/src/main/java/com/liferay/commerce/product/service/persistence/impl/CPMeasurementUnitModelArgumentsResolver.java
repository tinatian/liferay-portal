...
/**
 * The arguments resolver class for retrieving value from CPMeasurementUnit.
 *
 * @author Marco Leo
 * @generated
 */
@Component(
	immediate = true,
	service = {
		CPMeasurementUnitModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class CPMeasurementUnitModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(cpMeasurementUnitModelImpl, columnNames, original);
		}
		...
		if (finderPathColumnBitmask == null) {
			...
			if (finderPath.isBaseModelResult() &&
				(CPMeasurementUnitPersistenceImpl.
	...
	static {
		...
		orderByColumnsBitmask |= CPMeasurementUnitModelImpl.getColumnBitmask(
			"priority");
