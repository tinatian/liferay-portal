...
public class AnnouncementsFlagPersistenceImpl
	...
	public AnnouncementsFlag updateImpl(AnnouncementsFlag announcementsFlag) {
		...
		AnnouncementsFlag originalAnnouncementsFlag = announcementsFlag;
		...
		EntityCacheUtil.putResult(
			AnnouncementsFlagImpl.class, originalAnnouncementsFlag, false,
			true);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByU_E_V = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "U_E_V", "fetchByU_E_V",
			new String[] {
		...
		_finderPathCountByU_E_V = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "U_E_V", "countByU_E_V",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			});
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AnnouncementsFlagImpl.class;
