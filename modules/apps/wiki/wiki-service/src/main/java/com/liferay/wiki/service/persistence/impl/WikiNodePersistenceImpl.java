...
public class WikiNodePersistenceImpl
	...
	public void clearCache(WikiNode wikiNode) {
		...
		entityCache.removeResult(
			entityCacheEnabled, WikiNodeImpl.class, wikiNode,
	...
	public WikiNode updateImpl(WikiNode wikiNode) {
		...
		entityCache.putResult(
			entityCacheEnabled, WikiNodeImpl.class, wikiNode, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, WikiNodeImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, WikiNodeImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				WikiNodeModelImpl wikiNodeModelImpl =
					(WikiNodeModelImpl)baseModel;

				if (!checkColumns ||
					((wikiNodeModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {wikiNodeModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {wikiNodeModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {wikiNodeModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {wikiNodeModelImpl.getCompanyId()};
				}
