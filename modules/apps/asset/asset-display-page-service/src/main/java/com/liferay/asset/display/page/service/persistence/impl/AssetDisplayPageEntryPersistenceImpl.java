...
public class AssetDisplayPageEntryPersistenceImpl
	...
	public AssetDisplayPageEntry updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, AssetDisplayPageEntryImpl.class,
			assetDisplayPageEntryModelImpl, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByLayoutPageTemplateEntryId =
			_createFinderPath(
				...
				"LayoutPageTemplateEntryId", "findByLayoutPageTemplateEntryId",
				new String[] {
					Long.class.getName(), Integer.class.getName(),
					Integer.class.getName(), OrderByComparator.class.getName()
				});
		...
		_finderPathCountByLayoutPageTemplateEntryId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"LayoutPageTemplateEntryId", "countByLayoutPageTemplateEntryId",
			new String[] {Long.class.getName()});

		_finderPathFetchByG_C_C = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_C_C", "fetchByG_C_C",
			new String[] {
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AssetDisplayPageEntryImpl.class;
