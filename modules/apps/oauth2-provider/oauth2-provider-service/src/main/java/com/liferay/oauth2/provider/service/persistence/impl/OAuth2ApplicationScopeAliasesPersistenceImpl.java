...
public class OAuth2ApplicationScopeAliasesPersistenceImpl
	...
	public OAuth2ApplicationScopeAliases updateImpl(
		...
		OAuth2ApplicationScopeAliases originalOAuth2ApplicationScopeAliases =
			oAuth2ApplicationScopeAliases;
		...
		entityCache.putResult(
			OAuth2ApplicationScopeAliasesImpl.class,
			originalOAuth2ApplicationScopeAliases, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByC = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C", "findByC",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C", "findByC",
			new String[] {Long.class.getName()});

		_finderPathCountByC = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C", "countByC",
			new String[] {Long.class.getName()});
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = OAuth2ApplicationScopeAliasesImpl.class;
