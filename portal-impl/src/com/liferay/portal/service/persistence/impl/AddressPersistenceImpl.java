...
public class AddressPersistenceImpl
	...
	protected void cacheUniqueFindersCache(AddressModelImpl addressModelImpl) {
		...
		FinderCacheUtil.putResult(
			_finderPathFetchByC_ERC, args, addressModelImpl, false);
	}
	...
	private static class AddressModelArgumentsResolver
		...
		private final String _className = AddressImpl.class.getName();
		private final String _tableName = AddressTable.INSTANCE.getTableName();
