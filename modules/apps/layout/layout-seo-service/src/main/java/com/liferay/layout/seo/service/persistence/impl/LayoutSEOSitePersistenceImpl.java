...
public class LayoutSEOSitePersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((layoutSEOSiteModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				layoutSEOSiteModelImpl.getOriginalAttributeValue("uuid"),
				layoutSEOSiteModelImpl.getOriginalAttributeValue("groupId")
			};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			LayoutSEOSiteModelImpl.getColumnBitmask("uuid"));
