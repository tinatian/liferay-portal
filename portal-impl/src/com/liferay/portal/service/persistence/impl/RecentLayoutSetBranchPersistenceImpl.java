	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = registry.registerService(
			...
			HashMapBuilder.<String, Object>put(
				"model.class.name", RecentLayoutSetBranch.class.getName()
			).build());
		...
		_finderPathFetchByU_L = _createFinderPath(
			...
			"fetchByU_L", new String[] {"userId", "layoutSetId"});
	...
	private static class RecentLayoutSetBranchModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					recentLayoutSetBranchModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						recentLayoutSetBranchModelImpl.getAttributeValue(
							attributeName);
				}
			}
