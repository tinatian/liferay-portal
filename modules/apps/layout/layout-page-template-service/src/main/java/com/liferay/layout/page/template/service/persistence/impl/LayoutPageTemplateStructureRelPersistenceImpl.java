...
public class LayoutPageTemplateStructureRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathCountByLayoutPageTemplateStructureId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutPageTemplateStructureRelImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathWithPaginationFindBySegmentsExperienceId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutPageTemplateStructureRelImpl.class,
			LayoutPageTemplateStructureRelImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathCountBySegmentsExperienceId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutPageTemplateStructureRelImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathFetchByL_S = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			LayoutPageTemplateStructureRelImpl.class,
			LayoutPageTemplateStructureRelImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByL_S",
