...
public class OAuthUserPersistenceImpl
	...
	public void cacheResult(OAuthUser oAuthUser) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByAccessToken"),
			new Object[] {oAuthUser.getAccessToken()}, oAuthUser);

		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU_OAI"),
			new Object[] {
	...
	public void clearCache(List<OAuthUser> oAuthUsers) {
		for (OAuthUser oAuthUser : oAuthUsers) {
			entityCache.removeResult(
				entityCacheEnabled, OAuthUserImpl.class,
				oAuthUser.getPrimaryKey(), oAuthUser,
				new Object[] {
					_columnBitmaskEnabled,
					((OAuthUserModelImpl)oAuthUser).getColumnBitmask()
				});
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU_OAI"), args,
	...
	public OAuthUser updateImpl(OAuthUser oAuthUser) {
		...
		entityCache.putResult(
			entityCacheEnabled, OAuthUserImpl.class,
			oAuthUserModelImpl.getPrimaryKey(), oAuthUserModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, oAuthUserModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		Bundle bundle = FrameworkUtil.getBundle(OAuthUserPersistenceImpl.class);
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByAccessToken");

		_populateFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByAccessToken");

		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU_OAI");
