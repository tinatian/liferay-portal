...
public class DLFileEntryPersistenceImpl
	...
	public void cacheResult(DLFileEntry dlFileEntry) {
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_N"),
			new Object[] {
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_FN"),
			new Object[] {
				dlFileEntry.getGroupId(), dlFileEntry.getFolderId(),
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_T"),
			new Object[] {
				dlFileEntry.getGroupId(), dlFileEntry.getFolderId(),
	...
	protected void cacheUniqueFindersCache(
		...
		FinderCacheUtil.putResult(
			...
			args, Long.valueOf(1), false);
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_N"), args,
			dlFileEntryModelImpl, false);
		...
		FinderCacheUtil.putResult(
			...
			args, Long.valueOf(1), false);
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_FN"), args,
			dlFileEntryModelImpl, false);
		...
		FinderCacheUtil.putResult(
			...
			args, Long.valueOf(1), false);
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_T"), args,
			dlFileEntryModelImpl, false);
	}
	...
	public DLFileEntry updateImpl(DLFileEntry dlFileEntry) {
		...
		EntityCacheUtil.putResult(
			DLFileEntryModelImpl.ENTITY_CACHE_ENABLED, DLFileEntryImpl.class,
			dlFileEntryModelImpl.getPrimaryKey(), dlFileEntryModelImpl, false,
			new Object[] {
				DLFileEntryModelImpl.COLUMN_BITMASK_ENABLED,
	...
	public void afterPropertiesSet() {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_N");

		_populateFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_F_N");

		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_FN");

		_populateFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_F_FN");

		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_F_T");
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!DLFileEntryModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				DLFileEntryModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
