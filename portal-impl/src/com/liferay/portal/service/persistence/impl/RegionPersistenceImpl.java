...
public class RegionPersistenceImpl
	...
	public Region updateImpl(Region region) {
		...
		EntityCacheUtil.putResult(
			RegionModelImpl.ENTITY_CACHE_ENABLED, RegionImpl.class,
			regionModelImpl.getPrimaryKey(), regionModelImpl, false,
			new Object[] {
				RegionModelImpl.COLUMN_BITMASK_ENABLED,
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!RegionModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				RegionModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
		...
		_COLUMN_BITMASK_ARRAY_MAP.put(
			...
			new Object[] {
				...
				(Function<BaseModel<?>, Object[]>)baseModel -> {
					RegionModelImpl regionModelImpl =
						(RegionModelImpl)baseModel;
