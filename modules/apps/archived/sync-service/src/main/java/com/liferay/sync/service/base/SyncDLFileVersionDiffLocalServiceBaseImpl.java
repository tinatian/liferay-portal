...
public abstract class SyncDLFileVersionDiffLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SyncDLFileVersionDiffLocalServiceImpl#deleteSyncDLFileVersionDiff(SyncDLFileVersionDiff) to avoid orphaned data");
		}
	...
	public void loadFinderCache(FinderPath[] finderPaths) {
		syncDLFileVersionDiffPersistence.loadFinderCache(finderPaths);
	}
