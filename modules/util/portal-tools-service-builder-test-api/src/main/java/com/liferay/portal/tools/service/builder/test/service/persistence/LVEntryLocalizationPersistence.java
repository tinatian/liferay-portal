 ...
 */
@ProviderType
public interface LVEntryLocalizationPersistence extends BasePersistence<LVEntryLocalization> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<LVEntryLocalization> findByLvEntryId(long lvEntryId,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LVEntryLocalization> orderByComparator);
