...
public class BookmarksFolderPersistenceImpl
	...
	public void clearCache(BookmarksFolder bookmarksFolder) {
		...
		entityCache.removeResult(
			entityCacheEnabled, BookmarksFolderImpl.class, bookmarksFolder,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, BookmarksFolderImpl.class,
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((bookmarksFolderModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {bookmarksFolderModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {bookmarksFolderModelImpl.getGroupId()};
				}
