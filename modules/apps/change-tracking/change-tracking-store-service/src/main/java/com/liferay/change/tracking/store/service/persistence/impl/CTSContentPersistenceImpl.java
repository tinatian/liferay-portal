...
public class CTSContentPersistenceImpl
	...
	public void clearCache(CTSContent ctsContent) {
		...
		entityCache.removeResult(
			entityCacheEnabled, CTSContentImpl.class, ctsContent,
	...
	public CTSContent updateImpl(CTSContent ctsContent) {
		...
		entityCache.putResult(
			entityCacheEnabled, CTSContentImpl.class, ctsContentModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByC_R_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_R_S", "findByC_R_S",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_R_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_R_S", "findByC_R_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});

		_finderPathCountByC_R_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_R_S", "countByC_R_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});

		_finderPathWithPaginationFindByC_R_P_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_R_P_S", "findByC_R_P_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_R_P_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_R_P_S",
			"findByC_R_P_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName()
		...
		_finderPathCountByC_R_P_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_R_P_S",
			"countByC_R_P_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithPaginationFindByC_R_LikeP_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_R_LikeP_S",
			"findByC_R_LikeP_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName(),
		...
		_finderPathWithPaginationCountByC_R_LikeP_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_R_LikeP_S",
			"countByC_R_LikeP_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathFetchByC_R_P_V_S = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_R_P_V_S", "fetchByC_R_P_V_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName(),
				String.class.getName()
		...
		_finderPathCountByC_R_P_V_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_R_P_V_S",
			"countByC_R_P_V_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName(),
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.change.tracking.store.model.CTSContent"),
			true);
	}
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ctsContentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_R_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ctsContentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_R_P_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ctsContentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_R_P_V_S")) != 0)) {
