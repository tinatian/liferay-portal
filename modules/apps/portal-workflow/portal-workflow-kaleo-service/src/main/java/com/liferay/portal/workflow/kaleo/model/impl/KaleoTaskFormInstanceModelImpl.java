...
public class KaleoTaskFormInstanceModelImpl
	...
	private KaleoTaskFormInstanceCacheModel
		_toKaleoTaskFormInstanceCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			kaleoTaskFormInstanceCacheModel -> {
				Long createDate = kaleoTaskFormInstanceCacheModel.createDate;
