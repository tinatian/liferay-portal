...
public class UserIdMapperPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((userIdMapperModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				userIdMapperModelImpl.getOriginalAttributeValue("userId"),
				userIdMapperModelImpl.getOriginalAttributeValue("type")
			};
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByUserId = new FinderPath(
			...
			UserIdMapperModelImpl.getColumnBitmask("userId"));
		...
		_finderPathFetchByU_T = new FinderPath(
			...
			UserIdMapperModelImpl.getColumnBitmask("userId") |
			UserIdMapperModelImpl.getColumnBitmask("type"));
		...
		_finderPathFetchByT_E = new FinderPath(
			...
			UserIdMapperModelImpl.getColumnBitmask("type") |
			UserIdMapperModelImpl.getColumnBitmask("externalUserId"));
