...
public class FolderModelImpl
	...
	public void resetOriginalValues() {
		...
		_folderCacheModel = _toFolderCacheModel();
	}

	@Override
	public CacheModel<Folder> toCacheModel() {
		FolderCacheModel folderCacheModel = _toFolderCacheModel();
	...
	private FolderCacheModel _toFolderCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			folderCacheModel -> {
				Long createDate = folderCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			folderCacheModel -> {
				Long modifiedDate = folderCacheModel.modifiedDate;
