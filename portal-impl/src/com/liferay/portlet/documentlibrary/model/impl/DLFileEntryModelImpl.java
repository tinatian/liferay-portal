...
public class DLFileEntryModelImpl
	...
	public static final int CLASSNAMEID_COLUMN_INDEX = 10;

	public static final int CLASSPK_COLUMN_INDEX = 11;

	public static final int REPOSITORYID_COLUMN_INDEX = 12;

	public static final int FOLDERID_COLUMN_INDEX = 13;

	public static final int TREEPATH_COLUMN_INDEX = 14;

	public static final int NAME_COLUMN_INDEX = 15;

	public static final int FILENAME_COLUMN_INDEX = 16;

	public static final int EXTENSION_COLUMN_INDEX = 17;

	public static final int MIMETYPE_COLUMN_INDEX = 18;

	public static final int TITLE_COLUMN_INDEX = 19;

	public static final int DESCRIPTION_COLUMN_INDEX = 20;

	public static final int EXTRASETTINGS_COLUMN_INDEX = 21;

	public static final int FILEENTRYTYPEID_COLUMN_INDEX = 22;

	public static final int VERSION_COLUMN_INDEX = 23;

	public static final int SIZE_COLUMN_INDEX = 24;

	public static final int SMALLIMAGEID_COLUMN_INDEX = 25;

	public static final int LARGEIMAGEID_COLUMN_INDEX = 26;

	public static final int CUSTOM1IMAGEID_COLUMN_INDEX = 27;

	public static final int CUSTOM2IMAGEID_COLUMN_INDEX = 28;

	public static final int MANUALCHECKINREQUIRED_COLUMN_INDEX = 29;
	...
	public void setFileName(String fileName) {
		if (_originalValues[FILENAME_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[FILENAME_COLUMN_INDEX] = fileName;
		}
	...
	public String getOriginalFileName() {
		Object originalValue = _originalValues[FILENAME_COLUMN_INDEX];
	...
	public void setMimeType(String mimeType) {
		if (_originalValues[MIMETYPE_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[MIMETYPE_COLUMN_INDEX] = mimeType;
		}
	...
	public String getOriginalMimeType() {
		Object originalValue = _originalValues[MIMETYPE_COLUMN_INDEX];
	...
	public void setTitle(String title) {
		if (_originalValues[TITLE_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[TITLE_COLUMN_INDEX] = title;
		}
	...
	public String getOriginalTitle() {
		Object originalValue = _originalValues[TITLE_COLUMN_INDEX];
	...
	public void setFileEntryTypeId(long fileEntryTypeId) {
		if (_originalValues[FILEENTRYTYPEID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[FILEENTRYTYPEID_COLUMN_INDEX] = fileEntryTypeId;
		}
	...
	public long getOriginalFileEntryTypeId() {
		Object originalValue = _originalValues[FILEENTRYTYPEID_COLUMN_INDEX];
	...
	public void setSmallImageId(long smallImageId) {
		if (_originalValues[SMALLIMAGEID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[SMALLIMAGEID_COLUMN_INDEX] = smallImageId;
		}
	...
	public void setLargeImageId(long largeImageId) {
		if (_originalValues[LARGEIMAGEID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[LARGEIMAGEID_COLUMN_INDEX] = largeImageId;
		}
	...
	public long getOriginalLargeImageId() {
		Object originalValue = _originalValues[LARGEIMAGEID_COLUMN_INDEX];
	...
	public void setCustom1ImageId(long custom1ImageId) {
		if (_originalValues[CUSTOM1IMAGEID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[CUSTOM1IMAGEID_COLUMN_INDEX] = custom1ImageId;
		}
	...
	public long getOriginalCustom1ImageId() {
		Object originalValue = _originalValues[CUSTOM1IMAGEID_COLUMN_INDEX];
	...
	public void setCustom2ImageId(long custom2ImageId) {
		if (_originalValues[CUSTOM2IMAGEID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[CUSTOM2IMAGEID_COLUMN_INDEX] = custom2ImageId;
		}
	...
	public long getOriginalCustom2ImageId() {
		Object originalValue = _originalValues[CUSTOM2IMAGEID_COLUMN_INDEX];
	...
	public void resetOriginalValues() {
		...
		dlFileEntryModelImpl._columnBitmask = null;
	}
	...
	private Object[] _originalValues = new Object[32];
