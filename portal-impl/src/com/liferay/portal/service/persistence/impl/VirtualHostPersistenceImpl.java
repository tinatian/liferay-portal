...
public class VirtualHostPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByHostname = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Hostname"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Hostname"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByHostname,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByHostname,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_L_D = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_L_D"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_L_D"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_L_D,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_L_D,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
