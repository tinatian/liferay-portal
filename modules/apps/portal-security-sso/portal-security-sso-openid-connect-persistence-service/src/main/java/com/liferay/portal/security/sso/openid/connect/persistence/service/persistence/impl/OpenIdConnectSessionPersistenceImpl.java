...
public class OpenIdConnectSessionPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByC_A_C", _finderPathCountByC_A_C
			).put(
				"finderPathFetchByU_A_C", _finderPathFetchByU_A_C
			).put(
				"finderPathCountByU_A_C", _finderPathCountByU_A_C
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(OpenIdConnectSession.class);
	}
