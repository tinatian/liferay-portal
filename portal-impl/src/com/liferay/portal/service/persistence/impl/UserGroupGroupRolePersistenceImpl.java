...
public class UserGroupGroupRolePersistenceImpl
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			UserGroupGroupRoleImpl.class, UserGroupGroupRoleImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
			new String[0]);

		_finderPathWithPaginationFindByUserGroupId = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, UserGroupGroupRoleImpl.class,
		...
		_finderPathWithoutPaginationFindByUserGroupId = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, UserGroupGroupRoleImpl.class,
		...
		_finderPathCountByUserGroupId = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, Long.class,
		...
		_finderPathWithPaginationFindByU_G = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, UserGroupGroupRoleImpl.class,
		...
		_finderPathWithoutPaginationFindByU_G = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, UserGroupGroupRoleImpl.class,
		...
		_finderPathCountByU_G = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, Long.class,
		...
		_finderPathFetchByU_G_R = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, UserGroupGroupRoleImpl.class,
		...
		_finderPathCountByU_G_R = FinderPathUtil.create(
			UserGroupGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupGroupRoleModelImpl.FINDER_CACHE_ENABLED,
			UserGroupGroupRoleImpl.class, Long.class,
