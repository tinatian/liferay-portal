...
public class CTMessagePersistenceImpl
	...
	public void clearCache(CTMessage ctMessage) {
		...
		entityCache.removeResult(
			entityCacheEnabled, CTMessageImpl.class, ctMessage,
	...
	public CTMessage updateImpl(CTMessage ctMessage) {
		...
		entityCache.putResult(
			entityCacheEnabled, CTMessageImpl.class, ctMessage, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, CTMessageImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CTCollectionId", CTMessageModelImpl.CTCOLLECTIONID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ctMessageModelImpl.getColumnBitmask() &
