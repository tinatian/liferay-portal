...
public class DynamicQueryEntryWrapper
	...
	/**
	 * Returns the company ID of this dynamic query entry.
	 *
	 * @return the company ID of this dynamic query entry
	 */
	@Override
	...
	/**
	 * Returns the user ID of this dynamic query entry.
	 *
	 * @return the user ID of this dynamic query entry
	 */
	@Override
	...
	/**
	 * Returns the user uuid of this dynamic query entry.
	 *
	 * @return the user uuid of this dynamic query entry
	 */
	@Override
	...
	/**
	 * Sets the company ID of this dynamic query entry.
	 *
	 * @param companyId the company ID of this dynamic query entry
	 */
	@Override
	...
	/**
	 * Sets the user ID of this dynamic query entry.
	 *
	 * @param userId the user ID of this dynamic query entry
	 */
	@Override
	...
	/**
	 * Sets the user uuid of this dynamic query entry.
	 *
	 * @param userUuid the user uuid of this dynamic query entry
	 */
	@Override
...
// LIFERAY-SERVICE-BUILDER-HASH:1214316133