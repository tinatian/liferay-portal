...
public class DynamicQueryEntryModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(dynamicQueryEntryModelImpl, columnNames, original);
		}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				arguments[i] =
					dynamicQueryEntryModelImpl.getColumnOriginalValue(
						columnName);
			}
			else {
				arguments[i] = dynamicQueryEntryModelImpl.getColumnValue(
					columnName);
			}
		}
...
// LIFERAY-SERVICE-BUILDER-HASH:1882818178