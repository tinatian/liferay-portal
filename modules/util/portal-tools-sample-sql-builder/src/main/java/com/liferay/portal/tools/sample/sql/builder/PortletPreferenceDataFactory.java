...
public class PortletPreferenceDataFactory extends BaseDataFactory {
	...
	public PortletPreferencesModel newPortletPreferencesModel(
		...
		Map<Long, SimpleCounter> assetPublisherQueryCounter =
			_assetDataFactory.getAssetPublisherQueryCounter();
		...
		if (initContext.getAssetPublisherQueryName().equals(
				"assetCategories")) {

			List<AssetCategoryModel> assetCategoryModels =
				_assetDataFactory.getAssetCategoryModelsArray()[size];
			...
			List<AssetTagModel> assetTagModels =
				_assetDataFactory.getAssetTagModelsArray()[size];
		...
		jxPortletPreferences.setValue(
			"queryName0", initContext.getAssetPublisherQueryName());
		...
		jxPortletPreferences.setValue(
			"queryName1", initContext.getAssetPublisherQueryName());
		jxPortletPreferences.setValue(
