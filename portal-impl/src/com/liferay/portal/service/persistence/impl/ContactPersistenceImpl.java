	...
	private static class ContactModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(contactModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			ContactModelImpl contactModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = contactModelImpl.getOriginalAttributeValue(
						attributeName);
				}
				else {
					arguments[i] = contactModelImpl.getAttributeValue(
						attributeName);
				}
			}
