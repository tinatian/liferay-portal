...
public class LayoutSEOEntryPersistenceImpl
	...
	public void clearCache(LayoutSEOEntry layoutSEOEntry) {
		...
		entityCache.removeResult(
			entityCacheEnabled, LayoutSEOEntryImpl.class, layoutSEOEntry,
	...
	public LayoutSEOEntry updateImpl(LayoutSEOEntry layoutSEOEntry) {
		...
		entityCache.putResult(
			entityCacheEnabled, LayoutSEOEntryImpl.class, layoutSEOEntry, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, LayoutSEOEntryImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", LayoutSEOEntryModelImpl.UUID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutSEOEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {layoutSEOEntryModelImpl.getUuid()};
				}
