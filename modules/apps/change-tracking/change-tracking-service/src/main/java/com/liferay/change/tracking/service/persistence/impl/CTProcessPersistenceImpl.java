...
public class CTProcessPersistenceImpl
	...
	public void clearCache(CTProcess ctProcess) {
		...
		entityCache.removeResult(
			entityCacheEnabled, CTProcessImpl.class, ctProcess,
	...
	public CTProcess updateImpl(CTProcess ctProcess) {
		...
		entityCache.putResult(
			entityCacheEnabled, CTProcessImpl.class, ctProcess, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, CTProcessImpl.class,
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ctProcessModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CompanyId")) != 0)) {

					return new Object[] {ctProcessModelImpl.getCompanyId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						ctProcessModelImpl.getCtCollectionId()
					};
				}
