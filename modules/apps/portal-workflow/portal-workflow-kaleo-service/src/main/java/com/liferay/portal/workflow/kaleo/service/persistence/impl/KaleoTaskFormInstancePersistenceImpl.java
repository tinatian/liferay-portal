...
public class KaleoTaskFormInstancePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			KaleoTaskFormInstanceImpl.class, KaleoTaskFormInstanceImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, Long.class,
		...
		_finderPathWithPaginationFindByKaleoTaskId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, KaleoTaskFormInstanceImpl.class,
		...
		_finderPathWithoutPaginationFindByKaleoTaskId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, KaleoTaskFormInstanceImpl.class,
		...
		_finderPathCountByKaleoTaskId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, Long.class,
		...
		_finderPathFetchByKaleoTaskFormId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, KaleoTaskFormInstanceImpl.class,
		...
		_finderPathCountByKaleoTaskFormId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, Long.class,
