...
public class DLFileEntryTypePersistenceImpl
	...
	public DLFileEntryType updateImpl(DLFileEntryType dlFileEntryType) {
		...
		DLFileEntryType originalDLFileEntryType = dlFileEntryType;
		...
		EntityCacheUtil.putResult(
			DLFileEntryTypeImpl.class, originalDLFileEntryType, false, true);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByG_F = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_F", "fetchByG_F",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = DLFileEntryTypeImpl.class;
