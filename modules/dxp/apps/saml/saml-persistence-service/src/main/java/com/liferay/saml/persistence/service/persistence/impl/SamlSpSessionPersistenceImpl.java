...
public class SamlSpSessionPersistenceImpl
	...
	public void clearCache(SamlSpSession samlSpSession) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SamlSpSessionImpl.class, samlSpSession,
	...
	public SamlSpSession updateImpl(SamlSpSession samlSpSession) {
		...
		entityCache.putResult(
			entityCacheEnabled, SamlSpSessionImpl.class, samlSpSession, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SamlSpSessionImpl.class,
		...
		_finderPathFetchBySamlSpSessionKey = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("SamlSpSessionKey"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("SamlSpSessionKey"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchBySamlSpSessionKey,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountBySamlSpSessionKey,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByJSessionId = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("JSessionId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("JSessionId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByJSessionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByJSessionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByNameIdValue = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("NameIdValue"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("NameIdValue"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByNameIdValue,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByNameIdValue,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchBySessionIndex = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("SessionIndex"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("SessionIndex"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchBySessionIndex,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountBySessionIndex,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"JSessionId", SamlSpSessionModelImpl.JSESSIONID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"NameIdValue", SamlSpSessionModelImpl.NAMEIDVALUE_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"SessionIndex", SamlSpSessionModelImpl.SESSIONINDEX_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((samlSpSessionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("SamlSpSessionKey")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((samlSpSessionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("JSessionId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((samlSpSessionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("NameIdValue")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((samlSpSessionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("SessionIndex")) != 0)) {
