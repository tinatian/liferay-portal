...
public class PortalPreferencesPersistenceImpl
	...
	public PortalPreferences updateImpl(PortalPreferences portalPreferences) {
		...
		PortalPreferences originalPortalPreferences = portalPreferences;
		...
		EntityCacheUtil.putResult(
			PortalPreferencesImpl.class, originalPortalPreferences, false,
			true);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByO_O = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "O_O", "fetchByO_O",
			new String[] {Long.class.getName(), Integer.class.getName()});

		_finderPathCountByO_O = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "O_O", "countByO_O",
			new String[] {Long.class.getName(), Integer.class.getName()});
	}
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portalPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("O_O")) != 0)) {
