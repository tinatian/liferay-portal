...
public class SocialRelationPersistenceImpl
	...
	public void cacheResult(SocialRelation socialRelation) {
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU1_U2_T"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU1_U2_T"), args,
	...
	public SocialRelation updateImpl(SocialRelation socialRelation) {
		...
		EntityCacheUtil.putResult(
			SocialRelationModelImpl.ENTITY_CACHE_ENABLED,
			SocialRelationImpl.class, socialRelationModelImpl.getPrimaryKey(),
			socialRelationModelImpl, false,
			new Object[] {
				SocialRelationModelImpl.COLUMN_BITMASK_ENABLED,
	...
	public void afterPropertiesSet() {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU1_U2_T");
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!SocialRelationModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				SocialRelationModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
