...
public class DDMDataProviderInstanceLinkPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByD_S", _finderPathFetchByD_S
			).put(
				"finderPathCountByD_S", _finderPathCountByD_S
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(DDMDataProviderInstanceLink.class);
	}
