...
public class AkismetEntryModelImpl
	...
	private AkismetEntryCacheModel _toAkismetEntryCacheModel() {
		AkismetEntryCacheModel akismetEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			akismetEntryCacheModel -> {
				Long modifiedDate = akismetEntryCacheModel.modifiedDate;
