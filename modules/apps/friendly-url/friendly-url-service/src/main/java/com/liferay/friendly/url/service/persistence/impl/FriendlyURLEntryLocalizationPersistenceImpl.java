...
public class FriendlyURLEntryLocalizationPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, FriendlyURLEntryLocalizationImpl.class,
		...
		_finderPathWithoutPaginationFindByFriendlyURLEntryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("FriendlyURLEntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("FriendlyURLEntryId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByFriendlyURLEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByFriendlyURLEntryId_LanguageId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("FriendlyURLEntryId_LanguageId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get(
				"FriendlyURLEntryId_LanguageId"));
		...
		_finderPathFetchByG_C_U = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_U"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_U"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_C_U,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_U,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_C_L = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_L"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_L"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_C_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((friendlyURLEntryLocalizationModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("FriendlyURLEntryId")) !=
						  0)) {
				...
				if (!checkColumns ||
					((friendlyURLEntryLocalizationModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get(
						  "FriendlyURLEntryId_LanguageId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((friendlyURLEntryLocalizationModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_U")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((friendlyURLEntryLocalizationModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_C_L")) != 0)) {
