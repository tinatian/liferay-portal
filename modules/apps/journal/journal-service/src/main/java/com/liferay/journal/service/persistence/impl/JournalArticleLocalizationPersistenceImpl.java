...
public class JournalArticleLocalizationPersistenceImpl
			...
			try {
				...
				if (useFinderCache && productionMode) {
					finderCache.removeResult(
						_finderPathFetchByC_A_L, finderArgs);
				}
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByArticlePK = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class,
			JournalArticleLocalizationImpl.class,
		...
		_finderPathWithoutPaginationFindByArticlePK = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class,
			JournalArticleLocalizationImpl.class,
		...
		_finderPathCountByArticlePK = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByArticlePK",
			new String[] {Long.class.getName()});

		_finderPathFetchByA_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class,
		...
		_finderPathCountByA_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByA_L",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathFetchByC_A_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class,
			JournalArticleLocalizationImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_A_L",
		...
		_finderPathCountByC_A_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class, Long.class,
		...
		_finderPathFetchByC_A_T_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class,
			JournalArticleLocalizationImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_A_T_L",
		...
		_finderPathCountByC_A_T_L = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			JournalArticleLocalizationImpl.class, Long.class,
