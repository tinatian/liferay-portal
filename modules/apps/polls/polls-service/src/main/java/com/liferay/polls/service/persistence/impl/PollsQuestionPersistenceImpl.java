...
public class PollsQuestionPersistenceImpl
	...
	public void clearCache(PollsQuestion pollsQuestion) {
		...
		entityCache.removeResult(
			entityCacheEnabled, PollsQuestionImpl.class, pollsQuestion,
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, PollsQuestionImpl.class, primaryKey);
		}
	}
	...
	public PollsQuestion updateImpl(PollsQuestion pollsQuestion) {
		...
		entityCache.putResult(
			entityCacheEnabled, PollsQuestionImpl.class, pollsQuestion, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, PollsQuestionImpl.class,
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pollsQuestionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {pollsQuestionModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {pollsQuestionModelImpl.getGroupId()};
				}
