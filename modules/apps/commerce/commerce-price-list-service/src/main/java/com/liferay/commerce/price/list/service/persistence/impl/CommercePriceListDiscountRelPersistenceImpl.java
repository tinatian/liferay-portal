...
public class CommercePriceListDiscountRelPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByCDI_CPI", _finderPathFetchByCDI_CPI
			).put(
				"finderPathCountByCDI_CPI", _finderPathCountByCDI_CPI
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(CommercePriceListDiscountRel.class);
	}
