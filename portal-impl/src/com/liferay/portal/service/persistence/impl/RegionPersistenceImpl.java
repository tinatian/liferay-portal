...
public class RegionPersistenceImpl
	...
	public void clearCache(Region region) {
		...
		EntityCacheUtil.removeResult(
			RegionModelImpl.ENTITY_CACHE_ENABLED, RegionImpl.class, region,
	...
	public Region updateImpl(Region region) {
		...
		EntityCacheUtil.putResult(
			RegionModelImpl.ENTITY_CACHE_ENABLED, RegionImpl.class, region,
			false, RegionModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByCountryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("CountryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("CountryId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByCountryId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByCountryId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((regionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CountryId")) != 0)) {

					return new Object[] {regionModelImpl.getCountryId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {regionModelImpl.isActive()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {regionModelImpl.getOriginalActive()};
				}
