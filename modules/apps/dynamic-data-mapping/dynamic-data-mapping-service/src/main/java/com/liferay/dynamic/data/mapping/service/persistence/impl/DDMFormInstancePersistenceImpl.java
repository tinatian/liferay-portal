...
public class DDMFormInstancePersistenceImpl
	...
	public void clearCache(DDMFormInstance ddmFormInstance) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DDMFormInstanceImpl.class, ddmFormInstance,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DDMFormInstanceImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", DDMFormInstanceModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", DDMFormInstanceModelImpl.GROUPID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmFormInstanceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {ddmFormInstanceModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {ddmFormInstanceModelImpl.getGroupId()};
				}
