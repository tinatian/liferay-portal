...
public class DDMContentPersistenceImpl
	...
	public void cacheResult(DDMContent ddmContent) {
		...
		entityCache.putResult(
			entityCacheEnabled, DDMContentImpl.class,
			ddmContent.getPrimaryKey(), ddmContent);
	...
	public void clearCache(DDMContent ddmContent) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DDMContentImpl.class, ddmContent,
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, DDMContentImpl.class, primaryKey);
		}
	}
	...
	public DDMContent updateImpl(DDMContent ddmContent) {
		...
		entityCache.putResult(
			entityCacheEnabled, DDMContentImpl.class, ddmContent, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		DDMContentModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		DDMContentModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DDMContentImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, DDMContentImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", DDMContentModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", DDMContentModelImpl.GROUPID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", DDMContentModelImpl.COMPANYID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmContentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {ddmContentModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {ddmContentModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {ddmContentModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {ddmContentModelImpl.getCompanyId()};
				}
