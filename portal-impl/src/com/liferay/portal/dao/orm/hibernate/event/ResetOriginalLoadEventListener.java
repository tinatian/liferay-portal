 ...
 * @author Tina Tian
 */
public class ResetOriginalLoadEventListener extends DefaultLoadEventListener {

	public static final ResetOriginalLoadEventListener INSTANCE =
		new ResetOriginalLoadEventListener();
