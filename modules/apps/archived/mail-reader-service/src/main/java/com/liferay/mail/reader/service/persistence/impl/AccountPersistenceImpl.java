...
public class AccountPersistenceImpl
	...
	public void clearCache(Account account) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AccountImpl.class, account,
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, AccountImpl.class, primaryKey);
		}
	}
	...
	public Account updateImpl(Account account) {
		...
		entityCache.putResult(
			entityCacheEnabled, AccountImpl.class, account, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AccountImpl.class,
		...
		_finderPathFetchByU_A = new FinderPath(
			finderCacheEnabled, AccountImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByU_A",
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByU_A,
				MapUtil.singletonDictionary(
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((accountModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("UserId")) != 0)) {

					return new Object[] {accountModelImpl.getUserId()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {accountModelImpl.getOriginalUserId()};
				}
