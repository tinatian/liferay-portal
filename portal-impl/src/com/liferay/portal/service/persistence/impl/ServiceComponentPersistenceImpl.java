...
public class ServiceComponentPersistenceImpl
	...
	public ServiceComponent updateImpl(ServiceComponent serviceComponent) {
		...
		ServiceComponent originalServiceComponent = serviceComponent;
		...
		EntityCacheUtil.putResult(
			ServiceComponentImpl.class, originalServiceComponent, false, true);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByBuildNamespace = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "BuildNamespace",
			"findByBuildNamespace",
			new String[] {
		...
		_finderPathWithoutPaginationFindByBuildNamespace = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "BuildNamespace",
		...
		_finderPathFetchByBNS_BNU = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "BNS_BNU", "fetchByBNS_BNU",
			new String[] {String.class.getName(), Long.class.getName()});

		_finderPathCountByBNS_BNU = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "BNS_BNU",
			"countByBNS_BNU",
			new String[] {String.class.getName(), Long.class.getName()});
	}
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = ServiceComponentImpl.class;
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((serviceComponentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("BuildNamespace")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((serviceComponentModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("BNS_BNU")) != 0)) {
