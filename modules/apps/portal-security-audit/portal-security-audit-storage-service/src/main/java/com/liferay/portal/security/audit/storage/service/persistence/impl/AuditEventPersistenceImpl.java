...
public class AuditEventPersistenceImpl
	...
	public void clearCache(AuditEvent auditEvent) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AuditEventImpl.class, auditEvent,
	...
	public AuditEvent updateImpl(AuditEvent auditEvent) {
		...
		entityCache.putResult(
			entityCacheEnabled, AuditEventImpl.class, auditEvent, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AuditEventImpl.class,
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((auditEventModelImpl.getColumnBitmask() &
