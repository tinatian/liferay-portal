	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			MapUtil.singletonDictionary(
				"model.class.name", KaleoTask.class.getName()));

		_finderPathWithPaginationFindAll = _createFinderPath(
			KaleoTaskImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = _createFinderPath(
			KaleoTaskImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathFetchByKaleoNodeId = _createFinderPath(
			KaleoTaskImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByKaleoNodeId",
			new String[] {"kaleoNodeId"});
	...
	private static class KaleoTaskModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(kaleoTaskModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			KaleoTaskModelImpl kaleoTaskModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = kaleoTaskModelImpl.getOriginalAttributeValue(
						attributeName);
				}
				else {
					arguments[i] = kaleoTaskModelImpl.getAttributeValue(
						attributeName);
				}
			}
