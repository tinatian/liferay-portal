...
public class NotificationTemplateAttachmentPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByNTI_OFI", _finderPathFetchByNTI_OFI
			).put(
				"finderPathCountByNTI_OFI", _finderPathCountByNTI_OFI
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(NotificationTemplateAttachment.class);
	}
