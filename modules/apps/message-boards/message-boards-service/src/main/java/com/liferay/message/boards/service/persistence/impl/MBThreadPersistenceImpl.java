...
public class MBThreadPersistenceImpl
	...
	public void clearCache(MBThread mbThread) {
		...
		entityCache.removeResult(
			entityCacheEnabled, MBThreadImpl.class, mbThread,
	...
	public MBThread updateImpl(MBThread mbThread) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBThreadImpl.class, mbThread, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, MBThreadImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, MBThreadImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
		...
		_finderPathFetchByRootMessageId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("RootMessageId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("RootMessageId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByRootMessageId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByRootMessageId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_L = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_L"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_L"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"RootMessageId", MBThreadModelImpl.ROOTMESSAGEID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				MBThreadModelImpl mbThreadModelImpl =
					(MBThreadModelImpl)baseModel;

				if (!checkColumns ||
					((mbThreadModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {mbThreadModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {mbThreadModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {mbThreadModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mbThreadModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("RootMessageId")) != 0)) {

					return new Object[] {mbThreadModelImpl.getRootMessageId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						_getTime(mbThreadModelImpl.getLastPostDate()),
						mbThreadModelImpl.getPriority()
					};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						_getTime(mbThreadModelImpl.getOriginalLastPostDate()),
						mbThreadModelImpl.getOriginalPriority()
					};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mbThreadModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_L")) != 0)) {
