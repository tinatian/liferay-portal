...
public class AssetEntryUsagePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByAssetEntryId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, AssetEntryUsageImpl.class,
			AssetEntryUsageImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByAssetEntryId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByAssetEntryId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, AssetEntryUsageImpl.class,
			AssetEntryUsageImpl.class,
		...
		_finderPathCountByAssetEntryId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, AssetEntryUsageImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathFetchByA_C_C_P = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, AssetEntryUsageImpl.class,
			AssetEntryUsageImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByA_C_C_P",
			new String[] {
		...
		_finderPathCountByA_C_C_P = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, AssetEntryUsageImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByA_C_C_P",
			new String[] {
