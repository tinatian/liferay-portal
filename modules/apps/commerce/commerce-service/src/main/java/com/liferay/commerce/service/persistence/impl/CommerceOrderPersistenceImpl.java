...
public class CommerceOrderPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByG_CP", _finderPathCountByG_CP
			).put(
				...
				"finderPathCountByG_U_O", _finderPathCountByG_U_O
			).put(
				...
				"finderPathCountByG_C_O", _finderPathCountByG_C_O
			).put(
	...
	public void destroy() {
		...
		FinderPath.unregisterFinderPaths(CommerceOrder.class);
	}
