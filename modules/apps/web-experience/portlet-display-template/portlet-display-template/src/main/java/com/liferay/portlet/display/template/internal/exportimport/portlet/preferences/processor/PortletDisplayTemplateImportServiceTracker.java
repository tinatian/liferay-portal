...
import com.liferay.portlet.display.template.exportimport.portlet.preferences.processor.PortletDisplayTemplateImportRegister;
...
public class PortletDisplayTemplateImportServiceTracker {
	...
	public void activate(BundleContext bundleContext) {
		_serviceTracker = new ServiceTracker
			<PortletDisplayTemplateImportRegister,
				...
				bundleContext, PortletDisplayTemplateImportRegister.class,
				new ServiceTrackerCustomizer
					<PortletDisplayTemplateImportRegister,
						ServiceRegistration<Capability>>() {
					@Override
					public ServiceRegistration<Capability> addingService(
						ServiceReference<PortletDisplayTemplateImportRegister>
						serviceReference) {
	...
	private ServiceTracker<PortletDisplayTemplateImportRegister,
