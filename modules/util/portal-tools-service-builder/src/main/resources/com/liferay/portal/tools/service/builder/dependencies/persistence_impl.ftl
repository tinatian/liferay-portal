		...
		try {
			...
			<#if entity.isHierarchicalTree()>
				if (rebuildTreeEnabled) {
					...
					<#if serviceBuilder.isVersionGTE_7_3_0()>
						else if ((${entity.varName}ModelImpl.getOriginalAttributeValue("parent${pkEntityColumn.methodName}") != null) && !Objects.equals(${entity.varName}.getParent${pkEntityColumn.methodName}(), ${entity.varName}ModelImpl.getOriginalAttributeValue("parent${pkEntityColumn.methodName}"))){
