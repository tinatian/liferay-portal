...
public class LayoutFriendlyURLModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (layoutFriendlyURLCacheModel == null) {
			layoutFriendlyURLCacheModel = _dummyLayoutFriendlyURLCacheModel;
		}

		return (T)function.apply(layoutFriendlyURLCacheModel);
	}

	private LayoutFriendlyURLCacheModel _toLayoutFriendlyURLCacheModel() {
		LayoutFriendlyURLCacheModel layoutFriendlyURLCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			layoutFriendlyURLCacheModel -> {
				Long createDate = layoutFriendlyURLCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			layoutFriendlyURLCacheModel -> {
				Long modifiedDate = layoutFriendlyURLCacheModel.modifiedDate;
