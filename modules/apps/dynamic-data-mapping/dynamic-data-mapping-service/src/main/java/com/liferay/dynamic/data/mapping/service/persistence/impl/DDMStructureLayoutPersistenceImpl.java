...
public class DDMStructureLayoutPersistenceImpl
	...
	public void clearCache(DDMStructureLayout ddmStructureLayout) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DDMStructureLayoutImpl.class,
			ddmStructureLayout, _columnBitmaskEnabled);
	}
	...
	public DDMStructureLayout updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, DDMStructureLayoutImpl.class,
			ddmStructureLayout, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DDMStructureLayoutImpl.class,
		...
		_finderPathWithoutPaginationFindByStructureLayoutKey = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("StructureLayoutKey"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("StructureLayoutKey"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByStructureLayoutKey,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByStructureVersionId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("StructureVersionId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("StructureVersionId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByStructureVersionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByStructureVersionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_SV = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_SV"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_SV"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_SV,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_SV,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", DDMStructureLayoutModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", DDMStructureLayoutModelImpl.GROUPID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {ddmStructureLayoutModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmStructureLayoutModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("StructureLayoutKey")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmStructureLayoutModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("StructureVersionId")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((ddmStructureLayoutModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_SV")) != 0)) {
