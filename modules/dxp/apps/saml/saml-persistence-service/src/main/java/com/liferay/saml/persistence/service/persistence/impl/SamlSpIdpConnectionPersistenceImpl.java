...
public class SamlSpIdpConnectionPersistenceImpl
	...
	public void clearCache(SamlSpIdpConnection samlSpIdpConnection) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SamlSpIdpConnectionImpl.class,
			samlSpIdpConnection, _columnBitmaskEnabled);
	}
	...
	public SamlSpIdpConnection updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, SamlSpIdpConnectionImpl.class,
			samlSpIdpConnection, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SamlSpIdpConnectionImpl.class,
		...
		_finderPathFetchByC_SIEI = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_SIEI"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_SIEI"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_SIEI,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_SIEI,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", SamlSpIdpConnectionModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((samlSpIdpConnectionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_SIEI")) != 0)) {
