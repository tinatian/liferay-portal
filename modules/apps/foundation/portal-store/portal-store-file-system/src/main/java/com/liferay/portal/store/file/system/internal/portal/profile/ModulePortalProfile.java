...
package com.liferay.portal.store.file.system.internal.portal.profile;
...
public class ModulePortalProfile extends BaseDSModulePortalProfile {
	...
	public void activate(ComponentContext componentContext) {
		...
		if (dlStoreImpl.equals(FileSystemStore.class.getName())) {
			init(
				componentContext, supportedPortalProfileNames,
				FileSystemStore.class.getName());
		}
		else if (dlStoreImpl.equals(AdvancedFileSystemStore.class.getName())) {
			init(
				componentContext, supportedPortalProfileNames,
