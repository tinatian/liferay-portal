...
public class FriendlyURLEntryPersistenceImpl
	...
	public FriendlyURLEntry[] findByG_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_C_PrevAndNext(
				session, friendlyURLEntry, groupId, classNameId,
	...
	protected FriendlyURLEntry getByG_C_PrevAndNext(
	...
	public FriendlyURLEntry[] findByC_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(
				session, friendlyURLEntry, companyId, classNameId,
				orderByComparator, true);
	...
	protected FriendlyURLEntry getByC_C_PrevAndNext(
		Session session, FriendlyURLEntry friendlyURLEntry, long companyId,
		long classNameId, OrderByComparator<FriendlyURLEntry> orderByComparator,
		boolean previous) {
