...
public class DisplayPageFriendlyURLResolver implements FriendlyURLResolver {
	...
	public String getActualURL(
		...
		String layoutActualURL = portal.getLayoutActualURL(layout, mainPath);
		...
		portal.addPageSubtitle(journalArticle.getTitle(locale), request);
		portal.addPageDescription(
