...
public class PortletPersistenceImpl
	...
	public void clearCache(Portlet portlet) {
		...
		EntityCacheUtil.removeResult(
			PortletModelImpl.ENTITY_CACHE_ENABLED, PortletImpl.class, portlet,
	...
	public void clearCache(List<Portlet> portlets) {
		...
		for (Portlet portlet : portlets) {
			EntityCacheUtil.removeResult(
				PortletModelImpl.ENTITY_CACHE_ENABLED, PortletImpl.class,
				portlet, PortletModelImpl.COLUMN_BITMASK_ENABLED);
		}
	}
	...
	public Portlet updateImpl(Portlet portlet) {
		...
		EntityCacheUtil.putResult(
			PortletModelImpl.ENTITY_CACHE_ENABLED, PortletImpl.class, portlet,
			false, PortletModelImpl.COLUMN_BITMASK_ENABLED);
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", PortletModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CompanyId")) != 0)) {

					return new Object[] {portletModelImpl.getCompanyId()};
				}
