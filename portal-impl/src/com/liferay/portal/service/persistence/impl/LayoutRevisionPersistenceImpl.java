...
public class LayoutRevisionPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((layoutRevisionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				layoutRevisionModelImpl.getCacheModelAttribute(
					"layoutSetBranchId"),
				layoutRevisionModelImpl.getCacheModelAttribute("head"),
				layoutRevisionModelImpl.getCacheModelAttribute("plid")
			};
	...
	public LayoutRevision updateImpl(LayoutRevision layoutRevision) {
		...
		if (isNew) {
			...
			if ((layoutRevisionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					layoutRevisionModelImpl.getCacheModelAttribute("status")
				};
