...
public class MBThreadModelImpl
	...
	public void resetOriginalValues() {
		...
		_mbThreadCacheModel = _toMBThreadCacheModel();
	}

	@Override
	public CacheModel<MBThread> toCacheModel() {
		MBThreadCacheModel mbThreadCacheModel = _toMBThreadCacheModel();
	...
	private MBThreadCacheModel _toMBThreadCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			mbThreadCacheModel -> {
				Long createDate = mbThreadCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			mbThreadCacheModel -> {
				Long modifiedDate = mbThreadCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"lastPostDate",
			mbThreadCacheModel -> {
				Long lastPostDate = mbThreadCacheModel.lastPostDate;
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			mbThreadCacheModel -> {
				Long lastPublishDate = mbThreadCacheModel.lastPublishDate;
		...
		cacheModelGetterFunctions.put(
			"statusDate",
			mbThreadCacheModel -> {
				Long statusDate = mbThreadCacheModel.statusDate;
