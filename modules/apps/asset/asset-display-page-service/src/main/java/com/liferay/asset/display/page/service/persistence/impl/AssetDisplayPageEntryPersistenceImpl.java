...
public class AssetDisplayPageEntryPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			AssetDisplayPageEntryImpl.class, AssetDisplayPageEntryImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			AssetDisplayPageEntryImpl.class, Long.class,
		...
		_finderPathCountByLayoutPageTemplateEntryId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			AssetDisplayPageEntryImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathFetchByG_C_C = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			AssetDisplayPageEntryImpl.class, AssetDisplayPageEntryImpl.class,
