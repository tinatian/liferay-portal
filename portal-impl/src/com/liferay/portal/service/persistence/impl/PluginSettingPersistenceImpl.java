...
public class PluginSettingPersistenceImpl
	...
	public PluginSetting updateImpl(PluginSetting pluginSetting) {
		...
		EntityCacheUtil.putResult(
			PluginSettingModelImpl.ENTITY_CACHE_ENABLED,
			PluginSettingImpl.class, pluginSetting, false,
			PluginSettingModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByC_I_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_I_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_I_T"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_I_T,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_I_T,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", PluginSettingModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pluginSettingModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_I_T")) != 0)) {
