...
public class DynamicQueryEntryTable extends BaseTable<DynamicQueryEntryTable> {
	...
	public final Column<DynamicQueryEntryTable, Long> dynamicQueryEntryId =
		createColumn(
			...
			Column.FLAG_PRIMARY);
	public final Column<DynamicQueryEntryTable, Long> companyId = createColumn(
		"companyId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	public final Column<DynamicQueryEntryTable, Long> userId = createColumn(
...
// LIFERAY-SERVICE-BUILDER-HASH:-1635742520