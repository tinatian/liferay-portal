...
public class MBMailingListPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((mbMailingListModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				mbMailingListModelImpl.getCacheModelAttribute("uuid"),
				mbMailingListModelImpl.getCacheModelAttribute("groupId")
			};
		...
		if ((mbMailingListModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				mbMailingListModelImpl.getCacheModelAttribute("groupId"),
				mbMailingListModelImpl.getCacheModelAttribute("categoryId")
			};
	...
	public MBMailingList updateImpl(MBMailingList mbMailingList) {
		...
		if (isNew) {
			...
			if ((mbMailingListModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					mbMailingListModelImpl.getCacheModelAttribute("uuid"),
					mbMailingListModelImpl.getCacheModelAttribute("companyId")
				};
			...
			if ((mbMailingListModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					mbMailingListModelImpl.getCacheModelAttribute("active")
				};
