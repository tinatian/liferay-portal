...
public class PollsVotePersistenceImpl
	...
	public void clearCache(PollsVote pollsVote) {
		...
		entityCache.removeResult(
			entityCacheEnabled, PollsVoteImpl.class, pollsVote,
	...
	public PollsVote updateImpl(PollsVote pollsVote) {
		...
		entityCache.putResult(
			entityCacheEnabled, PollsVoteImpl.class, pollsVote, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, PollsVoteImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, PollsVoteImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
		...
		_finderPathWithoutPaginationFindByQuestionId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("QuestionId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("QuestionId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByQuestionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByQuestionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByChoiceId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("ChoiceId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ChoiceId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByChoiceId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByChoiceId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByQ_U = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Q_U"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Q_U"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByQ_U,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByQ_U,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", PollsVoteModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"QuestionId", PollsVoteModelImpl.QUESTIONID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"ChoiceId", PollsVoteModelImpl.CHOICEID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pollsVoteModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {pollsVoteModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {pollsVoteModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pollsVoteModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("QuestionId")) != 0)) {

					return new Object[] {pollsVoteModelImpl.getQuestionId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pollsVoteModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("ChoiceId")) != 0)) {

					return new Object[] {pollsVoteModelImpl.getChoiceId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pollsVoteModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Q_U")) != 0)) {
