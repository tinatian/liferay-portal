...
public class KaleoInstancePersistenceImpl
	...
	public void clearCache(KaleoInstance kaleoInstance) {
		...
		entityCache.removeResult(
			entityCacheEnabled, KaleoInstanceImpl.class, kaleoInstance,
	...
	public KaleoInstance updateImpl(KaleoInstance kaleoInstance) {
		...
		entityCache.putResult(
			entityCacheEnabled, KaleoInstanceImpl.class, kaleoInstance, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, KaleoInstanceImpl.class,
		...
		_finderPathWithoutPaginationFindByKaleoDefinitionVersionId =
			new FinderPath(
				...
				"findByKaleoDefinitionVersionId",
				new String[] {Long.class.getName()},
				_ARGUMENTS_BIFUNCTION_MAP.get("KaleoDefinitionVersionId"),
		...
		_finderPathCountByKaleoDefinitionVersionId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("KaleoDefinitionVersionId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("KaleoDefinitionVersionId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByKaleoDefinitionVersionId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByKDVI_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("KDVI_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("KDVI_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByKDVI_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByKDVI_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByCN_CPK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("CN_CPK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("CN_CPK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByCN_CPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByCN_CPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByKII_C_U = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("KII_C_U"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("KII_C_U"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByKII_C_U,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByKII_C_U,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByC_KDN_KDV_CD = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_KDN_KDV_CD"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_KDN_KDV_CD"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_KDN_KDV_CD,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", KaleoInstanceModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoInstanceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CompanyId")) != 0)) {

					return new Object[] {kaleoInstanceModelImpl.getCompanyId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoInstanceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("KDVI_C")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoInstanceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CN_CPK")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoInstanceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("KII_C_U")) != 0)) {
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						...
						kaleoInstanceModelImpl.
							getOriginalKaleoDefinitionVersion(),
						_getTime(
