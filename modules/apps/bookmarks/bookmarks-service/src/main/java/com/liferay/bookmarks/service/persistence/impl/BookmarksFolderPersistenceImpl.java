...
public class BookmarksFolderPersistenceImpl
	...
	public BookmarksFolder updateImpl(BookmarksFolder bookmarksFolder) {
		...
		BookmarksFolder originalBookmarksFolder = bookmarksFolder;
		...
		entityCache.putResult(
			BookmarksFolderImpl.class, originalBookmarksFolder, false, true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = BookmarksFolderImpl.class;
