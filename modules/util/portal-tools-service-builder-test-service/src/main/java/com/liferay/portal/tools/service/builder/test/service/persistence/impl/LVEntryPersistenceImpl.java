...
public class LVEntryPersistenceImpl
	...
	public void clearCache(LVEntry lvEntry) {
		...
		entityCache.removeResult(
			LVEntryModelImpl.ENTITY_CACHE_ENABLED, LVEntryImpl.class, lvEntry,
	...
	public void clearCache(List<LVEntry> lvEntries) {
		...
		for (LVEntry lvEntry : lvEntries) {
			entityCache.removeResult(
				LVEntryModelImpl.ENTITY_CACHE_ENABLED, LVEntryImpl.class,
				lvEntry, LVEntryModelImpl.COLUMN_BITMASK_ENABLED);
		}
	}
	...
	public LVEntry updateImpl(LVEntry lvEntry) {
		...
		entityCache.putResult(
			LVEntryModelImpl.ENTITY_CACHE_ENABLED, LVEntryImpl.class, lvEntry,
			false, LVEntryModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		Bundle bundle = FrameworkUtil.getBundle(LVEntryPersistenceImpl.class);
		...
		_finderPathWithoutPaginationFindByG_UGK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_UGK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_UGK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_UGK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_UGK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByG_UGK_Head = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_UGK_Head"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_UGK_Head"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_UGK_Head,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_UGK_Head,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", LVEntryModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", LVEntryModelImpl.GROUPID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"HeadId", LVEntryModelImpl.HEADID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((lvEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {lvEntryModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {lvEntryModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {lvEntryModelImpl.getGroupId()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {lvEntryModelImpl.getOriginalGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((lvEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_UGK")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((lvEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_UGK_Head")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {lvEntryModelImpl.getHeadId()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {lvEntryModelImpl.getOriginalHeadId()};
				}
