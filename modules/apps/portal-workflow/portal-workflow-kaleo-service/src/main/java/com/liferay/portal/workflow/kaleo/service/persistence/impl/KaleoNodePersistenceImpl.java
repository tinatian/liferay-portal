...
public class KaleoNodePersistenceImpl
	...
	public void clearCache(KaleoNode kaleoNode) {
		...
		entityCache.removeResult(
			entityCacheEnabled, KaleoNodeImpl.class, kaleoNode,
	...
	public KaleoNode updateImpl(KaleoNode kaleoNode) {
		...
		entityCache.putResult(
			entityCacheEnabled, KaleoNodeImpl.class, kaleoNode, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, KaleoNodeImpl.class,
		...
		_finderPathWithoutPaginationFindByC_KDVI = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_KDVI"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_KDVI"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_KDVI,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_KDVI,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", KaleoNodeModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoNodeModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_KDVI")) != 0)) {
