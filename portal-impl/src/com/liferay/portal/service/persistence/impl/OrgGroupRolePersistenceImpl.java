...
public class OrgGroupRolePersistenceImpl
		...
		if (isNew) {
			...
			if ((orgGroupRoleModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					orgGroupRoleModelImpl.getOriginalAttributeValue("groupId")
				};
			...
			if ((orgGroupRoleModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					orgGroupRoleModelImpl.getOriginalAttributeValue("roleId")
				};
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByGroupId = new FinderPath(
			...
			OrgGroupRoleModelImpl.getColumnBitmask("groupId"));
		...
		_finderPathWithoutPaginationFindByRoleId = new FinderPath(
			...
			OrgGroupRoleModelImpl.getColumnBitmask("roleId"));
