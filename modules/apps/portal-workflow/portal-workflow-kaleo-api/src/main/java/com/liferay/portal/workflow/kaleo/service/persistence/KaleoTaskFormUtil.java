...
public class KaleoTaskFormUtil {
	...
	*/
	public static KaleoTaskForm[] findByKaleoDefinitionVersionId_PrevAndNext(
		...
		throws com.liferay.portal.workflow.kaleo.exception.NoSuchTaskFormException {
		return getPersistence()
				   .findByKaleoDefinitionVersionId_PrevAndNext(kaleoTaskFormId,
	...
	*/
	...
	static {
		...
		ServiceTracker<KaleoTaskFormPersistence, KaleoTaskFormPersistence> serviceTracker =
			new ServiceTracker<KaleoTaskFormPersistence, KaleoTaskFormPersistence>(bundle.getBundleContext(),
