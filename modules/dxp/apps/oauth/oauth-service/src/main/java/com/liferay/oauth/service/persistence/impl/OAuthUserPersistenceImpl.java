	...
	protected void clearUniqueFindersCache(
		...
		if ((oAuthUserModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				oAuthUserModelImpl.getCacheModelAttribute("accessToken")
			};
		...
		if ((oAuthUserModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				oAuthUserModelImpl.getCacheModelAttribute("userId"),
				oAuthUserModelImpl.getCacheModelAttribute("oAuthApplicationId")
			};
	...
	public OAuthUser updateImpl(OAuthUser oAuthUser) {
		...
		if (isNew) {
			...
			if ((oAuthUserModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					oAuthUserModelImpl.getCacheModelAttribute(
						"oAuthApplicationId")
				};
