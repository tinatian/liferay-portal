...
public class DLFileRankPersistenceImpl
	...
	public DLFileRank updateImpl(DLFileRank dlFileRank) {
		...
		entityCache.putResult(
			entityCacheEnabled, DLFileRankImpl.class, dlFileRank, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DLFileRankImpl.class,
		...
		_finderPathWithoutPaginationFindByG_U_A = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_U_A"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_U_A"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_U_A,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_U_A,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));

		_finderPathFetchByC_U_F = new FinderPath(
			finderCacheEnabled, DLFileRankImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_U_F",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_U_F"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_U_F"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_U_F,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_U_F,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
