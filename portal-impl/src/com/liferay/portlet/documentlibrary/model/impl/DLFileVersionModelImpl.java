...
public class DLFileVersionModelImpl
	...
	private DLFileVersionCacheModel _toDLFileVersionCacheModel() {
		DLFileVersionCacheModel dlFileVersionCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			dlFileVersionCacheModel -> {
				Long createDate = dlFileVersionCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			dlFileVersionCacheModel -> {
				Long modifiedDate = dlFileVersionCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			dlFileVersionCacheModel -> {
				Long lastPublishDate = dlFileVersionCacheModel.lastPublishDate;
		...
		cacheModelGetterFunctions.put(
			"statusDate",
			dlFileVersionCacheModel -> {
				Long statusDate = dlFileVersionCacheModel.statusDate;
