...
public class MDRRuleGroupPersistenceImpl
	...
	public void clearCache(MDRRuleGroup mdrRuleGroup) {
		...
		entityCache.removeResult(
			entityCacheEnabled, MDRRuleGroupImpl.class, mdrRuleGroup,
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, MDRRuleGroupImpl.class, primaryKey);
		}
	}
	...
	public MDRRuleGroup updateImpl(MDRRuleGroup mdrRuleGroup) {
		...
		entityCache.putResult(
			entityCacheEnabled, MDRRuleGroupImpl.class, mdrRuleGroup, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, MDRRuleGroupImpl.class,
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mdrRuleGroupModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {mdrRuleGroupModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {mdrRuleGroupModelImpl.getGroupId()};
				}
