...
public class MicroblogsEntryModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (microblogsEntryCacheModel == null) {
			microblogsEntryCacheModel = _dummyMicroblogsEntryCacheModel;
		}

		return (T)function.apply(microblogsEntryCacheModel);
	}

	private MicroblogsEntryCacheModel _toMicroblogsEntryCacheModel() {
		MicroblogsEntryCacheModel microblogsEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			microblogsEntryCacheModel -> {
				Long createDate = microblogsEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			microblogsEntryCacheModel -> {
				Long modifiedDate = microblogsEntryCacheModel.modifiedDate;
