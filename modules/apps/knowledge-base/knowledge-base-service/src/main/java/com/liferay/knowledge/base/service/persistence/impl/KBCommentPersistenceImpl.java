...
public class KBCommentPersistenceImpl
	...
	public KBComment updateImpl(KBComment kbComment) {
		...
		entityCache.putResult(
			entityCacheEnabled, KBCommentImpl.class, kbCommentModelImpl, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationCountByC_C_S = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_C_S", "countByC_C_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			});
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = KBCommentImpl.class;
