		...
		if (isNew) {
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					entryModelImpl.getCacheModelAttribute("createDate")
				};
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					entryModelImpl.getCacheModelAttribute("fromUserId")
				};
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					entryModelImpl.getCacheModelAttribute("toUserId")
				};
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					entryModelImpl.getCacheModelAttribute("fromUserId"),
					entryModelImpl.getCacheModelAttribute("toUserId"),
					entryModelImpl.getCacheModelAttribute("content")
				};
