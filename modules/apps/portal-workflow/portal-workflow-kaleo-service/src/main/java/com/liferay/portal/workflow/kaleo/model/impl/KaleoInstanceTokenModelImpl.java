...
public class KaleoInstanceTokenModelImpl
	...
	private KaleoInstanceTokenCacheModel _toKaleoInstanceTokenCacheModel() {
		KaleoInstanceTokenCacheModel kaleoInstanceTokenCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			kaleoInstanceTokenCacheModel -> {
				Long createDate = kaleoInstanceTokenCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			kaleoInstanceTokenCacheModel -> {
				Long modifiedDate = kaleoInstanceTokenCacheModel.modifiedDate;
