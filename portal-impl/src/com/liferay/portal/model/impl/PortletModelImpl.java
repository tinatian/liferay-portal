...
public class PortletModelImpl
	...
	public void resetOriginalValues() {
		...
		_portletCacheModel = _toPortletCacheModel();
	}

	@Override
	public CacheModel<Portlet> toCacheModel() {
		PortletCacheModel portletCacheModel = _toPortletCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		PortletCacheModel portletCacheModel = _portletCacheModel;

		if (portletCacheModel == null) {
			portletCacheModel = _dummyPortletCacheModel;
		}

		return (T)function.apply(portletCacheModel);
	}

	private PortletCacheModel _toPortletCacheModel() {
