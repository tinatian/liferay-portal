...
public class SystemEventPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_S = _createFinderPath(
			SystemEventImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_S", new String[] {"groupId", "systemEventSetKey"});
		...
		_finderPathCountByG_S = _createFinderPath(
			...
			new String[] {"groupId", "systemEventSetKey"});
	...
	private static class SystemEventModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					systemEventModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					systemEventModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			SystemEventModelImpl systemEventModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = systemEventModelImpl.getAttributeValue(
						attributeName);
				}
			}
