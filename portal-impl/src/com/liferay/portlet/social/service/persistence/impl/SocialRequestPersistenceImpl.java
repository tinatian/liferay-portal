...
public class SocialRequestPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((socialRequestModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				socialRequestModelImpl.getCacheModelAttribute("uuid"),
				socialRequestModelImpl.getCacheModelAttribute("groupId")
			};
		...
		if ((socialRequestModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				socialRequestModelImpl.getCacheModelAttribute("userId"),
				socialRequestModelImpl.getCacheModelAttribute("classNameId"),
				socialRequestModelImpl.getCacheModelAttribute("classPK"),
				socialRequestModelImpl.getCacheModelAttribute("type"),
				socialRequestModelImpl.getCacheModelAttribute("receiverUserId")
			};
	...
	public SocialRequest updateImpl(SocialRequest socialRequest) {
		...
		if (isNew) {
			...
			if ((socialRequestModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					socialRequestModelImpl.getCacheModelAttribute("uuid"),
					socialRequestModelImpl.getCacheModelAttribute("companyId")
				};
			...
			if ((socialRequestModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					socialRequestModelImpl.getCacheModelAttribute(
						"receiverUserId")
				};
			...
			if ((socialRequestModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					socialRequestModelImpl.getCacheModelAttribute("userId"),
					socialRequestModelImpl.getCacheModelAttribute("status")
				};
