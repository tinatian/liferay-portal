...
public class AssetListEntryUsagePersistenceImpl
	...
	public void clearCache(AssetListEntryUsage assetListEntryUsage) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AssetListEntryUsageImpl.class,
			assetListEntryUsage, _columnBitmaskEnabled);
	}
	...
	public AssetListEntryUsage updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, AssetListEntryUsageImpl.class,
			assetListEntryUsage, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AssetListEntryUsageImpl.class,
		...
		_finderPathWithoutPaginationFindByAssetListEntryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("AssetListEntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("AssetListEntryId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByAssetListEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByA_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("A_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("A_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByA_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByA_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_C_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", AssetListEntryUsageModelImpl.UUID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((assetListEntryUsageModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("A_C")) != 0)) {
