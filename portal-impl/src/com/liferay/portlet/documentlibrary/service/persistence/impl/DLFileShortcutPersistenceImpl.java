...
public class DLFileShortcutPersistenceImpl
	...
	public DLFileShortcut updateImpl(DLFileShortcut dlFileShortcut) {
		...
		EntityCacheUtil.putResult(
			DLFileShortcutModelImpl.ENTITY_CACHE_ENABLED,
			DLFileShortcutImpl.class, dlFileShortcut, false,
			DLFileShortcutModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByToFileEntryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("ToFileEntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ToFileEntryId"));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByToFileEntryId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByG_F_A = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_F_A"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_F_A"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_F_A,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_F_A,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByG_F_A_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_F_A_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_F_A_S"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_F_A_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_F_A_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", DLFileShortcutModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", DLFileShortcutModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((dlFileShortcutModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {dlFileShortcutModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((dlFileShortcutModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("ToFileEntryId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((dlFileShortcutModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_F_A")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((dlFileShortcutModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_F_A_S")) != 0)) {
