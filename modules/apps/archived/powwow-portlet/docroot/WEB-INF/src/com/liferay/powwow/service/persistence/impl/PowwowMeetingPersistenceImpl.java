...
public class PowwowMeetingPersistenceImpl
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			PowwowMeetingImpl.class, PowwowMeetingImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			PowwowMeetingModelImpl.ENTITY_CACHE_ENABLED,
			PowwowMeetingModelImpl.FINDER_CACHE_ENABLED,
			PowwowMeetingImpl.class, Long.class,
		...
		_finderPathWithPaginationFindByPowwowServerId = FinderPathUtil.create(
			PowwowMeetingModelImpl.ENTITY_CACHE_ENABLED,
			PowwowMeetingModelImpl.FINDER_CACHE_ENABLED,
			PowwowMeetingImpl.class, PowwowMeetingImpl.class,
		...
		_finderPathCountByPowwowServerId = FinderPathUtil.create(
			PowwowMeetingModelImpl.ENTITY_CACHE_ENABLED,
			PowwowMeetingModelImpl.FINDER_CACHE_ENABLED,
			PowwowMeetingImpl.class, Long.class,
		...
		_finderPathWithPaginationFindByPSI_S = FinderPathUtil.create(
			PowwowMeetingModelImpl.ENTITY_CACHE_ENABLED,
			PowwowMeetingModelImpl.FINDER_CACHE_ENABLED,
			PowwowMeetingImpl.class, PowwowMeetingImpl.class,
		...
		_finderPathWithoutPaginationFindByPSI_S = FinderPathUtil.create(
			PowwowMeetingModelImpl.ENTITY_CACHE_ENABLED,
			PowwowMeetingModelImpl.FINDER_CACHE_ENABLED,
			PowwowMeetingImpl.class, PowwowMeetingImpl.class,
		...
		_finderPathCountByPSI_S = FinderPathUtil.create(
			PowwowMeetingModelImpl.ENTITY_CACHE_ENABLED,
			PowwowMeetingModelImpl.FINDER_CACHE_ENABLED,
			PowwowMeetingImpl.class, Long.class,
