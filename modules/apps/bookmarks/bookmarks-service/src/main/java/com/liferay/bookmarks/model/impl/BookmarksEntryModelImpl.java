...
public class BookmarksEntryModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (bookmarksEntryCacheModel == null) {
			bookmarksEntryCacheModel = _dummyBookmarksEntryCacheModel;
		}

		return (T)function.apply(bookmarksEntryCacheModel);
	}

	private BookmarksEntryCacheModel _toBookmarksEntryCacheModel() {
		BookmarksEntryCacheModel bookmarksEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			bookmarksEntryCacheModel -> {
				Long createDate = bookmarksEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			bookmarksEntryCacheModel -> {
				Long modifiedDate = bookmarksEntryCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			bookmarksEntryCacheModel -> {
				Long lastPublishDate = bookmarksEntryCacheModel.lastPublishDate;
		...
		cacheModelGetterFunctions.put(
			"statusDate",
			bookmarksEntryCacheModel -> {
				Long statusDate = bookmarksEntryCacheModel.statusDate;
