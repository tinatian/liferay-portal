	...
	private static class LocalizedEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					localizedEntryModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					localizedEntryModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						localizedEntryModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] = localizedEntryModelImpl.getAttributeValue(
						attributeName);
				}
			}
