...
public class ReleasePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByServletContextName = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("ServletContextName"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ServletContextName"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByServletContextName,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByServletContextName,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
