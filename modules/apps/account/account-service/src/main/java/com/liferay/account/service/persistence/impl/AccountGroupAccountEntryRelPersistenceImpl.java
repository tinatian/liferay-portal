...
public class AccountGroupAccountEntryRelPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathCountByAccountGroupId = _createFinderPath(
			...
			"countByAccountGroupId", new String[] {"accountGroupId"});
		...
		_finderPathFetchByAGI_AEI = _createFinderPath(
			...
			"fetchByAGI_AEI",
			new String[] {"accountGroupId", "accountEntryId"});
	...
	private static class AccountGroupAccountEntryRelModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					accountGroupAccountEntryRelModelImpl, attributeNames,
					original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						accountGroupAccountEntryRelModelImpl.getAttributeValue(
							attributeName);
				}
			}
