...
public class KaleoTransitionModelImpl
	...
	private KaleoTransitionCacheModel _toKaleoTransitionCacheModel() {
		KaleoTransitionCacheModel kaleoTransitionCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			kaleoTransitionCacheModel -> {
				Long createDate = kaleoTransitionCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			kaleoTransitionCacheModel -> {
				Long modifiedDate = kaleoTransitionCacheModel.modifiedDate;
