...
/**
 * The arguments resolver class for retrieving value from CPAttachmentFileEntry.
 *
 * @author Marco Leo
 * @generated
 */
@Component(
	immediate = true,
	service = {
		CPAttachmentFileEntryModelArgumentsResolver.class,
		ArgumentsResolver.class
	}
)
public class CPAttachmentFileEntryModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		long columnBitmask = cpAttachmentFileEntryModelImpl.getColumnBitmask();
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |=
					cpAttachmentFileEntryModelImpl.getColumnBitmask(columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(CPAttachmentFileEntryPersistenceImpl.
