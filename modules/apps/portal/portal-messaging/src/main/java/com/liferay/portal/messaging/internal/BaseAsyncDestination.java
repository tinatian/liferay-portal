...
public abstract class BaseAsyncDestination extends BaseDestination {
	...
	public void setMessageBusThreadLocalHelper(
		MessageBusThreadLocalHelper messageBusThreadLocalHelper) {

		this.messageBusThreadLocalHelper = messageBusThreadLocalHelper;
	}
	...
	protected MessageBusThreadLocalHelper messageBusThreadLocalHelper;
