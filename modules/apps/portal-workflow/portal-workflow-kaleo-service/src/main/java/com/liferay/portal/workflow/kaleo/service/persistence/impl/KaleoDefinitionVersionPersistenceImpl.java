...
public class KaleoDefinitionVersionPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByC_N_V = _createFinderPath(
			...
			"fetchByC_N_V", new String[] {"companyId", "name", "version"});
	...
	private static class KaleoDefinitionVersionModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					kaleoDefinitionVersionModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						kaleoDefinitionVersionModelImpl.getAttributeValue(
							attributeName);
				}
			}
