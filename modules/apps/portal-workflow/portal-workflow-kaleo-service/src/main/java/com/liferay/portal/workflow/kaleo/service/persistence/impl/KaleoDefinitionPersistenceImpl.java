...
public class KaleoDefinitionPersistenceImpl
	...
	public void cacheResult(KaleoDefinition kaleoDefinition) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_N_V"),
			new Object[] {
				kaleoDefinition.getCompanyId(), kaleoDefinition.getName(),
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_N_A"),
			new Object[] {
				kaleoDefinition.getCompanyId(), kaleoDefinition.getName(),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_N_V"), args,
			kaleoDefinitionModelImpl, false);
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_N_A"), args,
			kaleoDefinitionModelImpl, false);
	}
	...
	public KaleoDefinition updateImpl(KaleoDefinition kaleoDefinition) {
		...
		entityCache.putResult(
			entityCacheEnabled, KaleoDefinitionImpl.class,
			kaleoDefinitionModelImpl.getPrimaryKey(), kaleoDefinitionModelImpl,
			false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_N_V");

		_populateFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_N_V");

		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByC_N_A");
