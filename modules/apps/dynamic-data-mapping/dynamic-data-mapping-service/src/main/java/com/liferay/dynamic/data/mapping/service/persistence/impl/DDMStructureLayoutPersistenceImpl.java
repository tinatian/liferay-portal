...
public class DDMStructureLayoutPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathCountByStructureLayoutKey = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByStructureLayoutKey", new String[] {"structureLayoutKey"});

		_finderPathFetchByStructureVersionId = _createFinderPath(
			DDMStructureLayoutImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByStructureVersionId", new String[] {"structureVersionId"});
	...
	private static class DDMStructureLayoutModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					ddmStructureLayoutModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					ddmStructureLayoutModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						ddmStructureLayoutModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] =
						ddmStructureLayoutModelImpl.getAttributeValue(
							attributeName);
				}
			}
