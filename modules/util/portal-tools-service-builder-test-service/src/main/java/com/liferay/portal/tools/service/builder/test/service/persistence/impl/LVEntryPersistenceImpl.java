...
public class LVEntryPersistenceImpl
	...
	public LVEntry updateImpl(LVEntry lvEntry) {
		...
		entityCache.putResult(
			LVEntryModelImpl.ENTITY_CACHE_ENABLED, LVEntryImpl.class,
			lvEntryModelImpl, false, LVEntryModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_UGK = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_UGK", "findByG_UGK",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_UGK = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_UGK", "findByG_UGK",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathCountByG_UGK = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_UGK", "countByG_UGK",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathFetchByG_UGK_Head = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_UGK_Head", "fetchByG_UGK_Head",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName()
			});
		...
		_finderPathCountByG_UGK_Head = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_UGK_Head",
			"countByG_UGK_Head",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName()
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = LVEntryImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				LVEntryModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
				methodName, params);
		}
