 ...
 * @generated
 */
@Component(enabled = false, immediate = true, service = ShippingMethodResource.Factory.class)
@Generated("")
	...
	public ShippingMethodResource.Builder create() {
		return new ShippingMethodResource.Builder() {
			...
			public ShippingMethodResource build() {
				...
				return (ShippingMethodResource)ProxyUtil.newProxyInstance(
					ShippingMethodResource.class.getClassLoader(),
					new Class<?>[] {ShippingMethodResource.class},
