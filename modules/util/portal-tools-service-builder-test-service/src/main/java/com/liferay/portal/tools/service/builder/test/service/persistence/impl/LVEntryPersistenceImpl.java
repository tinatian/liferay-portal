...
public class LVEntryPersistenceImpl extends BasePersistenceImpl<LVEntry>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2_SQL = "lvEntry.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_SQL = "(lvEntry.uuid_ IS NULL OR lvEntry.uuid_ = '')";
	...
	public LVEntry fetchByUUID_G(String uuid, long groupId, boolean head,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_UUID_G_HEAD_2_SQL);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_SQL = "lvEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_SQL = "(lvEntry.uuid_ IS NULL OR lvEntry.uuid_ = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2_SQL = "lvEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_HEAD_2_SQL = "lvEntry.head = ?";
	...
	public LVEntry fetchByG_UGK(long groupId, String uniqueGroupKey,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_UGK_HEAD_2_SQL);
	...
	private static final String _FINDER_COLUMN_G_UGK_GROUPID_2_SQL = "lvEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_UGK_UNIQUEGROUPKEY_2_SQL = "lvEntry.uniqueGroupKey = ? AND ";
	private static final String _FINDER_COLUMN_G_UGK_UNIQUEGROUPKEY_3_SQL = "(lvEntry.uniqueGroupKey IS NULL OR lvEntry.uniqueGroupKey = '') AND ";
	private static final String _FINDER_COLUMN_G_UGK_HEAD_2_SQL = "lvEntry.head = ?";
