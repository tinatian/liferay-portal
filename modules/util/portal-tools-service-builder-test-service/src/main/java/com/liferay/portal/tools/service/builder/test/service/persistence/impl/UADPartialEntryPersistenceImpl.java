...
public class UADPartialEntryPersistenceImpl
	...
	public UADPartialEntry updateImpl(UADPartialEntry uadPartialEntry) {
		...
		UADPartialEntry originalUADPartialEntry = uadPartialEntry;
		...
		entityCache.putResult(
			UADPartialEntryImpl.class, originalUADPartialEntry, false, true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = UADPartialEntryImpl.class;
