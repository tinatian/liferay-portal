...
public class DynamicQueryEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newDynamicQueryEntry.setCompanyId(RandomTestUtil.nextLong());

		newDynamicQueryEntry.setUserId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingDynamicQueryEntry.getCompanyId(),
			newDynamicQueryEntry.getCompanyId());
		Assert.assertEquals(
			existingDynamicQueryEntry.getUserId(),
			newDynamicQueryEntry.getUserId());
		Assert.assertEquals(
	...
	protected OrderByComparator<DynamicQueryEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"DynamicQueryEntry", "dynamicQueryEntryId", true, "companyId", true,
			"userId", true, "createDate", true, "modifiedDate", true, "name",
			true, "description", true, "amount", true, "status", true);
	}
	...
	protected DynamicQueryEntry addDynamicQueryEntry() throws Exception {
		...
		dynamicQueryEntry.setCompanyId(RandomTestUtil.nextLong());

		dynamicQueryEntry.setUserId(RandomTestUtil.nextLong());
...
// LIFERAY-SERVICE-BUILDER-HASH:-1498275564