...
public class CommercePriceListAccountRelPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByCAI_CPI", _finderPathFetchByCAI_CPI
			).put(
				"finderPathCountByCAI_CPI", _finderPathCountByCAI_CPI
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(CommercePriceListAccountRel.class);
	}
