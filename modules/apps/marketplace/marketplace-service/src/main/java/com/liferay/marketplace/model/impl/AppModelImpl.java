...
public class AppModelImpl extends BaseModelImpl<App> implements AppModel {
	...
	public void setRemoteAppId(long remoteAppId) {
		if (_originalValues[REMOTEAPPID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[REMOTEAPPID_COLUMN_INDEX] = _remoteAppId;
		}
	...
	public long getOriginalRemoteAppId() {
		Object originalValue = _originalValues[REMOTEAPPID_COLUMN_INDEX];

		if (originalValue == INITIAL_MARKER) {
			originalValue = _remoteAppId;
		}
	...
	public void setCategory(String category) {
		if (_originalValues[CATEGORY_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[CATEGORY_COLUMN_INDEX] = _category;
		}
	...
	public String getOriginalCategory() {
		Object originalValue = _originalValues[CATEGORY_COLUMN_INDEX];

		if (originalValue == INITIAL_MARKER) {
			originalValue = _category;
		}
	...
	public void resetOriginalValues() {
		...
		appModelImpl._columnBitmask = null;
	}
