...
public class DLFolderPersistenceImpl
	...
	public void cacheResult(DLFolder dlFolder) {
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByR_M"),
			new Object[] {dlFolder.getRepositoryId(), dlFolder.isMountPoint()},
			dlFolder);

		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_P_N"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		FinderCacheUtil.putResult(
			...
			args, Long.valueOf(1), false);
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByR_M"), args,
			dlFolderModelImpl, false);
		...
		FinderCacheUtil.putResult(
			...
			args, Long.valueOf(1), false);
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_P_N"), args,
			dlFolderModelImpl, false);
	}
	...
	public DLFolder updateImpl(DLFolder dlFolder) {
		...
		EntityCacheUtil.putResult(
			DLFolderModelImpl.ENTITY_CACHE_ENABLED, DLFolderImpl.class,
			dlFolderModelImpl.getPrimaryKey(), dlFolderModelImpl, false,
			new Object[] {
				DLFolderModelImpl.COLUMN_BITMASK_ENABLED,
	...
	public void afterPropertiesSet() {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByR_M");
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_P_N");
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!DLFolderModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				DLFolderModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
