	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {amImageEntryModelImpl.getOriginalUuid()};
			});
		...
		_finderPathWithPaginationFindByConfigurationUuid = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, AMImageEntryImpl.class,
			AMImageEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByConfigurationUuid",
			new String[] {
		...
		_finderPathWithoutPaginationFindByConfigurationUuid = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, AMImageEntryImpl.class,
			AMImageEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByConfigurationUuid = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, AMImageEntryImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathWithPaginationFindByFileVersionId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, AMImageEntryImpl.class,
			AMImageEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByFileVersionId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByFileVersionId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, AMImageEntryImpl.class,
			AMImageEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			...
			baseModel -> {
				...
				return new Object[] {amImageEntryModelImpl.getFileVersionId()};
			},
			baseModel -> {
				AMImageEntryModelImpl amImageEntryModelImpl =
					(AMImageEntryModelImpl)baseModel;
		...
		_finderPathCountByFileVersionId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, AMImageEntryImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
