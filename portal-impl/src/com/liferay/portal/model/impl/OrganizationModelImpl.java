...
public class OrganizationModelImpl
	...
	private OrganizationCacheModel _toOrganizationCacheModel() {
		OrganizationCacheModel organizationCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			organizationCacheModel -> {
				Long createDate = organizationCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			organizationCacheModel -> {
				Long modifiedDate = organizationCacheModel.modifiedDate;
