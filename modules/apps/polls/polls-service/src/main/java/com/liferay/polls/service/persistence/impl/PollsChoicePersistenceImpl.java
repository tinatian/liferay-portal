...
public class PollsChoicePersistenceImpl
	...
	public void clearCache(PollsChoice pollsChoice) {
		...
		entityCache.removeResult(
			entityCacheEnabled, PollsChoiceImpl.class, pollsChoice,
	...
	public PollsChoice updateImpl(PollsChoice pollsChoice) {
		...
		entityCache.putResult(
			entityCacheEnabled, PollsChoiceImpl.class, pollsChoice, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, PollsChoiceImpl.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			finderCacheEnabled, PollsChoiceImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
		...
		_finderPathFetchByQ_N = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Q_N"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Q_N"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByQ_N,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByQ_N,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pollsChoiceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {pollsChoiceModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {pollsChoiceModelImpl.getQuestionId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((pollsChoiceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Q_N")) != 0)) {
