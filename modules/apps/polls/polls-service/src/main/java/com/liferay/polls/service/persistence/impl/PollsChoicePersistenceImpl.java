...
public class PollsChoicePersistenceImpl
	...
	public PollsChoice updateImpl(PollsChoice pollsChoice) {
		...
		entityCache.putResult(
			entityCacheEnabled, PollsChoiceImpl.class, pollsChoiceModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByQ_N = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "Q_N", "fetchByQ_N",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathCountByQ_N = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "Q_N", "countByQ_N",
			new String[] {Long.class.getName(), String.class.getName()});
	}
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = PollsChoiceImpl.class;
