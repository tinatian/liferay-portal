...
public class StyleBookEntryModelImpl
	...
	private StyleBookEntryCacheModel _toStyleBookEntryCacheModel() {
		StyleBookEntryCacheModel styleBookEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			styleBookEntryCacheModel -> {
				Long createDate = styleBookEntryCacheModel.createDate;
