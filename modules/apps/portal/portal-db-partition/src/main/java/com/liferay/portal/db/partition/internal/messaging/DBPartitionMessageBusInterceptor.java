...
public class DBPartitionMessageBusInterceptor implements MessageBusInterceptor {
	...
	public boolean intercept(
		...
		if (_databasePartitionEnabled &&
			!isExcluded(destinationName, message)) {
	...
	protected boolean isExcluded(String destinationName, Message message) {
		if ((message.getLong("companyId") != CompanyConstants.SYSTEM) ||
