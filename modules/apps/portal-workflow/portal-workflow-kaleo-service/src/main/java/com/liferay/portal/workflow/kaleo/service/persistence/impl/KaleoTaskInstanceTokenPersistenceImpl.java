...
public class KaleoTaskInstanceTokenPersistenceImpl
	...
	public void cacheResult(KaleoTaskInstanceToken kaleoTaskInstanceToken) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByKII_KTI"),
			new Object[] {
				kaleoTaskInstanceToken.getKaleoInstanceId(),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByKII_KTI"), args,
	...
	public KaleoTaskInstanceToken updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, KaleoTaskInstanceTokenImpl.class,
			kaleoTaskInstanceTokenModelImpl.getPrimaryKey(),
			kaleoTaskInstanceTokenModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByKII_KTI");
