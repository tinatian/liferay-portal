...
public class KaleoProcessPersistenceImpl
	...
	public void cacheResult(KaleoProcess kaleoProcess) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByDDLRecordSetId"),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByDDLRecordSetId"),
			args, kaleoProcessModelImpl, false);
	}
	...
	public KaleoProcess updateImpl(KaleoProcess kaleoProcess) {
		...
		entityCache.putResult(
			entityCacheEnabled, KaleoProcessImpl.class,
			kaleoProcessModelImpl.getPrimaryKey(), kaleoProcessModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, kaleoProcessModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByDDLRecordSetId");
