...
public class CustomizedImportCapabilityServiceTracker {

	@Activate
	public void activate(BundleContext bundleContext) {
		_serviceTracker =
			new ServiceTracker<CustomizedImportCapabilityRegister,
				ServiceRegistration<Capability>>(
					bundleContext, CustomizedImportCapabilityRegister.class,
					new ServiceTrackerCustomizer
						<CustomizedImportCapabilityRegister,
							ServiceRegistration<Capability>>() {

						@Override
						public ServiceRegistration<Capability> addingService(
							ServiceReference<CustomizedImportCapabilityRegister>
								serviceReference) {
	...
	private ServiceTracker<CustomizedImportCapabilityRegister,
