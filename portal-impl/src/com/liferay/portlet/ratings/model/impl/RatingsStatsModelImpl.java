...
public class RatingsStatsModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		RatingsStatsCacheModel ratingsStatsCacheModel = _ratingsStatsCacheModel;

		if (ratingsStatsCacheModel == null) {
			ratingsStatsCacheModel = _dummyRatingsStatsCacheModel;
		}

		return (T)function.apply(ratingsStatsCacheModel);
	}

	private RatingsStatsCacheModel _toRatingsStatsCacheModel() {
		RatingsStatsCacheModel ratingsStatsCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			...
			ratingsStatsCacheModel -> {
				Long createDate = ratingsStatsCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			ratingsStatsCacheModel -> {
				Long modifiedDate = ratingsStatsCacheModel.modifiedDate;
