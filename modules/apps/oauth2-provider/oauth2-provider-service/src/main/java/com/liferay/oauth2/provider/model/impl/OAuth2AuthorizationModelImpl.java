...
public class OAuth2AuthorizationModelImpl
	...
	private OAuth2AuthorizationCacheModel _toOAuth2AuthorizationCacheModel() {
		OAuth2AuthorizationCacheModel oAuth2AuthorizationCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			oAuth2AuthorizationCacheModel -> {
				Long createDate = oAuth2AuthorizationCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			...
			oAuth2AuthorizationCacheModel -> {
				...
				return new Date(accessTokenCreateDate);
			});
		...
		cacheModelGetterFunctions.put(
			...
			oAuth2AuthorizationCacheModel -> {
				...
				return new Date(accessTokenExpirationDate);
			});
		...
		cacheModelGetterFunctions.put(
			...
			oAuth2AuthorizationCacheModel -> {
				...
				return new Date(refreshTokenCreateDate);
			});
		...
		cacheModelGetterFunctions.put(
			...
			oAuth2AuthorizationCacheModel -> {
				...
				return new Date(refreshTokenExpirationDate);
			});
