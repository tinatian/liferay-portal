...
public class RatingsEntryModelImpl
	...
	private RatingsEntryCacheModel _toRatingsEntryCacheModel() {
		RatingsEntryCacheModel ratingsEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			ratingsEntryCacheModel -> {
				Long createDate = ratingsEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			ratingsEntryCacheModel -> {
				Long modifiedDate = ratingsEntryCacheModel.modifiedDate;
