...
public class AnnouncementsEntryPersistenceImpl
	...
	public AnnouncementsEntry updateImpl(
		...
		AnnouncementsEntry originalAnnouncementsEntry = announcementsEntry;
		...
		EntityCacheUtil.putResult(
			AnnouncementsEntryImpl.class, originalAnnouncementsEntry, false,
			true);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByC_C_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_C_A", "findByC_C_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});

		_finderPathCountByC_C_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_C_A", "countByC_C_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});

		_finderPathWithPaginationFindByC_C_C_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_C_C_A", "findByC_C_C_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathWithoutPaginationFindByC_C_C_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_C_C_A",
			"findByC_C_C_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Boolean.class.getName()
		...
		_finderPathCountByC_C_C_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_C_C_A",
			"countByC_C_C_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AnnouncementsEntryImpl.class;
