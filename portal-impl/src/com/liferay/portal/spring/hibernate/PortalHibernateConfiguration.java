...
import com.liferay.portal.dao.orm.hibernate.event.ResetOriginalLoadEventListener;
import com.liferay.portal.dao.orm.hibernate.event.ResetOriginalPostLoadEventListener;
			...
			if (_mvccEnabled) {
				...
				eventListeners.setLoadEventListeners(
					new LoadEventListener[] {
						ResetOriginalLoadEventListener.INSTANCE
					});
				eventListeners.setPostLoadEventListeners(
					new PostLoadEventListener[] {
						ResetOriginalPostLoadEventListener.INSTANCE
					});
