...
public class BackgroundTaskModelImpl
	...
	private BackgroundTaskCacheModel _toBackgroundTaskCacheModel() {
		BackgroundTaskCacheModel backgroundTaskCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			backgroundTaskCacheModel -> {
				Long createDate = backgroundTaskCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			backgroundTaskCacheModel -> {
				Long modifiedDate = backgroundTaskCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"completionDate",
			backgroundTaskCacheModel -> {
				Long completionDate = backgroundTaskCacheModel.completionDate;
