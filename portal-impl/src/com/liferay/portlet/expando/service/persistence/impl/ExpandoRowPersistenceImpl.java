...
public class ExpandoRowPersistenceImpl
	...
	public void cacheResult(ExpandoRow expandoRow) {
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByT_C"),
	...
	protected void cacheUniqueFindersCache(
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByT_C"), args,
	...
	public ExpandoRow updateImpl(ExpandoRow expandoRow) {
		...
		EntityCacheUtil.putResult(
			ExpandoRowModelImpl.ENTITY_CACHE_ENABLED, ExpandoRowImpl.class,
			expandoRowModelImpl.getPrimaryKey(), expandoRowModelImpl, false,
			new Object[] {
				ExpandoRowModelImpl.COLUMN_BITMASK_ENABLED,
	...
	public void afterPropertiesSet() {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByT_C");
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!ExpandoRowModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				ExpandoRowModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
