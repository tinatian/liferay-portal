...
public class AssetListEntryPersistenceImpl
	...
	public void clearCache(AssetListEntry assetListEntry) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AssetListEntryImpl.class, assetListEntry,
	...
	public AssetListEntry updateImpl(AssetListEntry assetListEntry) {
		...
		entityCache.putResult(
			entityCacheEnabled, AssetListEntryImpl.class, assetListEntry, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationCountByGroupId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "GroupId", "countByGroupId",
			new String[] {Long.class.getName()});

		_finderPathFetchByG_ALEK = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_ALEK", "fetchByG_ALEK",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathCountByG_ALEK = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_ALEK",
			"countByG_ALEK",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathFetchByG_T = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_T", "fetchByG_T",
			new String[] {Long.class.getName(), String.class.getName()});
		...
		_finderPathWithPaginationFindByG_LikeT = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_LikeT", "findByG_LikeT",
			new String[] {
		...
		_finderPathWithPaginationCountByG_LikeT = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_LikeT", "countByG_LikeT",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathWithPaginationFindByG_TY = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_TY", "findByG_TY",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_TY = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_TY", "findByG_TY",
			new String[] {Long.class.getName(), Integer.class.getName()});

		_finderPathCountByG_TY = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_TY", "countByG_TY",
			new String[] {Long.class.getName(), Integer.class.getName()});

		_finderPathWithPaginationFindByG_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_AET", "findByG_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_AET", "findByG_AET",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathCountByG_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_AET", "countByG_AET",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathWithPaginationCountByG_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_AET", "countByG_AET",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathWithPaginationFindByG_LikeT_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_LikeT_AET",
			"findByG_LikeT_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName(), Integer.class.getName(),
		...
		_finderPathWithPaginationCountByG_LikeT_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_LikeT_AET",
			"countByG_LikeT_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathWithPaginationFindByG_AES_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_AES_AET",
			"findByG_AES_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName(), Integer.class.getName(),
		...
		_finderPathWithoutPaginationFindByG_AES_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_AES_AET",
			"findByG_AES_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
		...
		_finderPathCountByG_AES_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_AES_AET",
			"countByG_AES_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathWithPaginationCountByG_AES_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_AES_AET",
			"countByG_AES_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathWithPaginationFindByG_LikeT_AES_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_LikeT_AES_AET",
			"findByG_LikeT_AES_AET",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathWithPaginationCountByG_LikeT_AES_AET = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "G_LikeT_AES_AET",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AssetListEntryImpl.class;
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", AssetListEntryModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", AssetListEntryModelImpl.GROUPID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((assetListEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {assetListEntryModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {assetListEntryModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((assetListEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_ALEK")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((assetListEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_TY")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((assetListEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_AET")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((assetListEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_AES_AET")) != 0)) {
