...
public class SocialActivitySettingPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByG_C_A", _finderPathCountByG_C_A
			).put(
				"finderPathFetchByG_C_A_N", _finderPathFetchByG_C_A_N
			).put(
				"finderPathCountByG_C_A_N", _finderPathCountByG_C_A_N
			).build());
	...
	public void destroy() {
		...
		FinderPath.unregisterFinderPaths(SocialActivitySetting.class);
	}
