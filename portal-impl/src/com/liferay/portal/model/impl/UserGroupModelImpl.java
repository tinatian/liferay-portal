...
public class UserGroupModelImpl
	...
	public long getOriginalParentUserGroupId() {
		return getOriginalAttributeValue("parentUserGroupId");
	}
	...
	public void resetOriginalValues() {
		...
		_userGroupCacheModel = _toUserGroupCacheModel();
	}

	@Override
	public CacheModel<UserGroup> toCacheModel() {
		UserGroupCacheModel userGroupCacheModel = _toUserGroupCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		UserGroupCacheModel userGroupCacheModel = _userGroupCacheModel;

		if (userGroupCacheModel == null) {
			userGroupCacheModel = _dummyUserGroupCacheModel;
		}

		return (T)function.apply(userGroupCacheModel);
	}

	private UserGroupCacheModel _toUserGroupCacheModel() {
	...
	private static final UserGroupCacheModel _dummyUserGroupCacheModel =
		new UserGroupCacheModel();
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			userGroupCacheModel -> {
				Long createDate = userGroupCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			userGroupCacheModel -> {
				Long modifiedDate = userGroupCacheModel.modifiedDate;
