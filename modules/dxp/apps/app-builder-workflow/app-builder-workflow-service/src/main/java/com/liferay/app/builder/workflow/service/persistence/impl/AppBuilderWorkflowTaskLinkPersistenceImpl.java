...
public class AppBuilderWorkflowTaskLinkPersistenceImpl
	...
	public void cacheResult(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_D_W"),
			new Object[] {
				appBuilderWorkflowTaskLink.getAppBuilderAppId(),
				appBuilderWorkflowTaskLink.getDdmStructureLayoutId(),
				appBuilderWorkflowTaskLink.getWorkflowTaskName()
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_D_W"), args,
	...
	public AppBuilderWorkflowTaskLink updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, AppBuilderWorkflowTaskLinkImpl.class,
			appBuilderWorkflowTaskLinkModelImpl.getPrimaryKey(),
			appBuilderWorkflowTaskLinkModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_D_W");
