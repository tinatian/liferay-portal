...
public class StatusModelImpl
	...
	public void resetOriginalValues() {
		...
		_statusCacheModel = _toStatusCacheModel();
	}

	@Override
	public CacheModel<Status> toCacheModel() {
		StatusCacheModel statusCacheModel = _toStatusCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		StatusCacheModel statusCacheModel = _statusCacheModel;

		if (statusCacheModel == null) {
			statusCacheModel = _dummyStatusCacheModel;
		}

		return (T)function.apply(statusCacheModel);
	}

	private StatusCacheModel _toStatusCacheModel() {
