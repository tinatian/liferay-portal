...
import com.liferay.portlet.display.template.exportimport.portlet.preferences.processor.DefaultExportCapabilityRegister;
...
public class DefaultExportCapabilityServiceTracker {

	@Activate
	public void activate(BundleContext bundleContext) {
		_serviceTracker =
			new ServiceTracker<DefaultExportCapabilityRegister,
				ServiceRegistration<Capability>>(
					bundleContext, DefaultExportCapabilityRegister.class,
					new ServiceTrackerCustomizer
						<DefaultExportCapabilityRegister,
							ServiceRegistration<Capability>>() {

						@Override
						public ServiceRegistration<Capability> addingService(
							ServiceReference<DefaultExportCapabilityRegister>
							serviceReference) {
	...
	private ServiceTracker<DefaultExportCapabilityRegister,
