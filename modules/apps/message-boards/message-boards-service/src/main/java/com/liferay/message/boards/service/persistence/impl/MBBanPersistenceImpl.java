...
public class MBBanPersistenceImpl
	...
	public MBBan updateImpl(MBBan mbBan) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBBanImpl.class, mbBanModelImpl, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByBanUserId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "BanUserId",
			"findByBanUserId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByBanUserId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "BanUserId",
		...
		_finderPathFetchByG_B = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_B", "fetchByG_B",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathCountByG_B = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_B", "countByG_B",
			new String[] {Long.class.getName(), Long.class.getName()});
	}
