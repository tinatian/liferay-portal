...
public class UserPersistenceImpl
	...
	public void clearCache(User user) {
		...
		EntityCacheUtil.removeResult(
			UserModelImpl.ENTITY_CACHE_ENABLED, UserImpl.class, user,
	...
	public User updateImpl(User user) {
		...
		EntityCacheUtil.putResult(
			UserModelImpl.ENTITY_CACHE_ENABLED, UserImpl.class, user, false,
			UserModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByContactId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("ContactId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ContactId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByContactId,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByContactId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByEmailAddress = new FinderPath(
			...
			new String[] {String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("EmailAddress"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("EmailAddress"));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByEmailAddress,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByPortraitId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("PortraitId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("PortraitId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByPortraitId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByPortraitId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_U = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_U"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_U"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_U,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_U,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByC_CD = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_CD"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_CD"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_CD,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_CD,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByC_MD = new FinderPath(
			...
			new String[] {Long.class.getName(), Date.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_MD"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_MD"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_MD,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_MD,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_DU = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_DU"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_DU"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_DU,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_DU,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_SN = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_SN"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_SN"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_SN,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_SN,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_EA = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_EA"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_EA"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_EA,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_EA,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_FID = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_FID"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_FID"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_FID,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_FID,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_GUID = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_GUID"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_GUID"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_GUID,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_GUID,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_O = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_O"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_O"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_O,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_O,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByC_CD_MD = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_CD_MD"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_CD_MD"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_CD_MD,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_CD_MD,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByC_DU_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_DU_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_DU_S"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_DU_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_DU_S,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_ERC = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_ERC"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_ERC"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_ERC,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_ERC,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put("Uuid", UserModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", UserModelImpl.COMPANYID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"ContactId", UserModelImpl.CONTACTID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"EmailAddress", UserModelImpl.EMAILADDRESS_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"PortraitId", UserModelImpl.PORTRAITID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {userModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {userModelImpl.getOriginalUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {userModelImpl.getCompanyId()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {userModelImpl.getOriginalCompanyId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("ContactId")) != 0)) {

					return new Object[] {userModelImpl.getContactId()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {userModelImpl.getOriginalContactId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("EmailAddress")) != 0)) {

					return new Object[] {userModelImpl.getEmailAddress()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("PortraitId")) != 0)) {

					return new Object[] {userModelImpl.getPortraitId()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {userModelImpl.getOriginalPortraitId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_U")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_CD")) != 0)) {

					return new Object[] {
						userModelImpl.getCompanyId(),
						_getTime(userModelImpl.getCreateDate())
					};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						userModelImpl.getOriginalCompanyId(),
						_getTime(userModelImpl.getOriginalCreateDate())
					};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_MD")) != 0)) {

					return new Object[] {
						userModelImpl.getCompanyId(),
						_getTime(userModelImpl.getModifiedDate())
					};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						userModelImpl.getOriginalCompanyId(),
						_getTime(userModelImpl.getOriginalModifiedDate())
					};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_DU")) != 0)) {

					return new Object[] {
						userModelImpl.getCompanyId(),
						userModelImpl.isDefaultUser()
					};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_SN")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_EA")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_FID")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_GUID")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_O")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_CD_MD")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((userModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_DU_S")) != 0)) {
