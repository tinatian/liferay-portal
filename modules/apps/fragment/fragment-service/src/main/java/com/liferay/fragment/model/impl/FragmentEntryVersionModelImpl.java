...
public class FragmentEntryVersionModelImpl
	...
	private FragmentEntryVersionCacheModel _toFragmentEntryVersionCacheModel() {
		FragmentEntryVersionCacheModel fragmentEntryVersionCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			fragmentEntryVersionCacheModel -> {
				Long createDate = fragmentEntryVersionCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			fragmentEntryVersionCacheModel -> {
				Long modifiedDate = fragmentEntryVersionCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"statusDate",
			fragmentEntryVersionCacheModel -> {
				Long statusDate = fragmentEntryVersionCacheModel.statusDate;
