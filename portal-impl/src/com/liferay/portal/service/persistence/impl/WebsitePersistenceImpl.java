...
public class WebsitePersistenceImpl
	...
	public Website updateImpl(Website website) {
		...
		EntityCacheUtil.putResult(
			WebsiteModelImpl.ENTITY_CACHE_ENABLED, WebsiteImpl.class,
			websiteModelImpl, false, WebsiteModelImpl.COLUMN_BITMASK_ENABLED);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = WebsiteImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				WebsiteModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
				methodName, params);
		}
