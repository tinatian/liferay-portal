...
public class SiteFriendlyURLPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByG_C_L", _finderPathFetchByG_C_L
			).put(
				"finderPathCountByG_C_L", _finderPathCountByG_C_L
			).put(
				"finderPathFetchByC_F_L", _finderPathFetchByC_F_L
			).put(
				"finderPathCountByC_F_L", _finderPathCountByC_F_L
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(SiteFriendlyURL.class);
	}
