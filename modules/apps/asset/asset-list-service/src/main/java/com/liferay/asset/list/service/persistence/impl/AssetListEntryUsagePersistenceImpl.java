...
public class AssetListEntryUsagePersistenceImpl
	...
	public AssetListEntryUsage updateImpl(
		...
		AssetListEntryUsage originalAssetListEntryUsage = assetListEntryUsage;
		...
		entityCache.putResult(
			AssetListEntryUsageImpl.class, originalAssetListEntryUsage, false,
			true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByA_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "A_C", "findByA_C",
			new String[] {
		...
		_finderPathWithoutPaginationFindByA_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "A_C", "findByA_C",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathCountByA_C = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "A_C", "countByA_C",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathFetchByC_C_P = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_C_P", "fetchByC_C_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AssetListEntryUsageImpl.class;
