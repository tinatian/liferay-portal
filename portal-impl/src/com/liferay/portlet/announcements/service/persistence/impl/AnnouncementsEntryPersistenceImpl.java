...
public class AnnouncementsEntryPersistenceImpl
	...
	public AnnouncementsEntry updateImpl(
		...
		EntityCacheUtil.putResult(
			AnnouncementsEntryModelImpl.ENTITY_CACHE_ENABLED,
			AnnouncementsEntryImpl.class,
			announcementsEntryModelImpl.getPrimaryKey(),
			announcementsEntryModelImpl, false,
			new Object[] {
				AnnouncementsEntryModelImpl.COLUMN_BITMASK_ENABLED,
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!AnnouncementsEntryModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
			...
			key -> {
				...
				if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
					finderPath = new FinderPath(
						AnnouncementsEntryModelImpl.ENTITY_CACHE_ENABLED, true,
