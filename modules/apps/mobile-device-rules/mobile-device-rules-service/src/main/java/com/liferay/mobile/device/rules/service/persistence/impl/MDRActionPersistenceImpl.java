...
public class MDRActionPersistenceImpl
	...
	public MDRAction updateImpl(MDRAction mdrAction) {
		...
		entityCache.putResult(
			entityCacheEnabled, MDRActionImpl.class, mdrActionModelImpl, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByRuleGroupInstanceId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "RuleGroupInstanceId",
			"findByRuleGroupInstanceId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByRuleGroupInstanceId =
			_createFinderPath(
				...
				"RuleGroupInstanceId", "findByRuleGroupInstanceId",
				new String[] {Long.class.getName()});

		_finderPathCountByRuleGroupInstanceId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "RuleGroupInstanceId",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = MDRActionImpl.class;
