...
public class SegmentsEntryRelPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SegmentsEntryRelImpl.class,
		...
		_finderPathWithoutPaginationFindByG_CN_CPK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_CN_CPK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_CN_CPK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_CN_CPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_CN_CPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByS_CN_CPK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("S_CN_CPK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("S_CN_CPK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByS_CN_CPK,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByS_CN_CPK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
