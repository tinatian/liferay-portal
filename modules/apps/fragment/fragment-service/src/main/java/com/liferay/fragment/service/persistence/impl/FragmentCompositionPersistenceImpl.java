...
public class FragmentCompositionPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByG_FCK", _finderPathFetchByG_FCK
			).put(
				"finderPathCountByG_FCK", _finderPathCountByG_FCK
			).put(
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(FragmentComposition.class);
	}
