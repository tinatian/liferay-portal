...
public class KaleoTaskFormInstancePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByKaleoTaskId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, KaleoTaskFormInstanceImpl.class,
		...
		_finderPathWithoutPaginationFindByKaleoTaskId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, KaleoTaskFormInstanceImpl.class,
		...
		_finderPathCountByKaleoTaskId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, Long.class,
		...
		_finderPathFetchByKaleoTaskFormId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, KaleoTaskFormInstanceImpl.class,
		...
		_finderPathCountByKaleoTaskFormId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled,
			KaleoTaskFormInstanceImpl.class, Long.class,
