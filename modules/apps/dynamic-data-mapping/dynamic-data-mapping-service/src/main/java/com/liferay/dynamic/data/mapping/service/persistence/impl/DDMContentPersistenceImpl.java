...
public class DDMContentPersistenceImpl
	...
	public void cacheResult(DDMContent ddmContent) {
		...
		entityCache.putResult(
			...
			ddmContent.getPrimaryKey(), ddmContent, _columnBitmaskEnabled,
			((DDMContentModelImpl)ddmContent).getColumnBitmask());
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByGroupId = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {ddmContentModelImpl.getOriginalGroupId()};
			});
