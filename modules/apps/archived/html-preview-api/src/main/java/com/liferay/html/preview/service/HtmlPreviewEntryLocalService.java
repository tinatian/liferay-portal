...
/**
 * Provides the local service interface for HtmlPreviewEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HtmlPreviewEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HtmlPreviewEntryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.html.preview.service.impl.HtmlPreviewEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the html preview entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HtmlPreviewEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
