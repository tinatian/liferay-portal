...
public class LayoutBranchPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByL_P_N = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_P_N"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_P_N"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByL_P_N,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_P_N,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByL_P_M = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("L_P_M"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("L_P_M"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByL_P_M,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByL_P_M,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
