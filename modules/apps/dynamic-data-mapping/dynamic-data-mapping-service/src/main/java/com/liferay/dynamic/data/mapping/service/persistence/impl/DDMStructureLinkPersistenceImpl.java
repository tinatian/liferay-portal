...
public class DDMStructureLinkPersistenceImpl
	...
	public DDMStructureLink updateImpl(DDMStructureLink ddmStructureLink) {
		...
		entityCache.putResult(
			entityCacheEnabled, DDMStructureLinkImpl.class,
			ddmStructureLinkModelImpl, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByC_C_S = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_C_S", "fetchByC_C_S",
			new String[] {
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = DDMStructureLinkImpl.class;
