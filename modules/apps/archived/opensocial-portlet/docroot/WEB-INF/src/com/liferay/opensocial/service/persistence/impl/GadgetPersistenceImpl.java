	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = registry.registerService(
			...
			HashMapBuilder.<String, Object>put(
				"model.class.name", Gadget.class.getName()
			).build());
	...
	private static class GadgetModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(gadgetModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			GadgetModelImpl gadgetModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = gadgetModelImpl.getOriginalAttributeValue(
						attributeName);
				}
				else {
					arguments[i] = gadgetModelImpl.getAttributeValue(
						attributeName);
				}
			}
