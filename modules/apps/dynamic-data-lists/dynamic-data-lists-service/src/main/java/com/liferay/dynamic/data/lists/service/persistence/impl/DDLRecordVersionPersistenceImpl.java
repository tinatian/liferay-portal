...
public class DDLRecordVersionPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((ddlRecordVersionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				ddlRecordVersionModelImpl.getCacheModelAttribute("recordId"),
				ddlRecordVersionModelImpl.getCacheModelAttribute("version")
			};
	...
	public DDLRecordVersion updateImpl(DDLRecordVersion ddlRecordVersion) {
		...
		if (isNew) {
			...
			if ((ddlRecordVersionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ddlRecordVersionModelImpl.getCacheModelAttribute(
						"recordSetId"),
					ddlRecordVersionModelImpl.getCacheModelAttribute(
						"recordSetVersion")
				};
			...
			if ((ddlRecordVersionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ddlRecordVersionModelImpl.getCacheModelAttribute(
						"recordId"),
					ddlRecordVersionModelImpl.getCacheModelAttribute("status")
				};
			...
			if ((ddlRecordVersionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ddlRecordVersionModelImpl.getCacheModelAttribute("userId"),
					ddlRecordVersionModelImpl.getCacheModelAttribute(
						"recordSetId"),
					ddlRecordVersionModelImpl.getCacheModelAttribute(
						"recordSetVersion"),
