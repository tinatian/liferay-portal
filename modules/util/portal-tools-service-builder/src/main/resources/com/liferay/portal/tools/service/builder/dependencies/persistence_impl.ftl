...
public class ${entity.name}PersistenceImpl extends BasePersistenceImpl<${entity.name}> implements ${entity.name}Persistence {
	...
	<#else>
		...
		<#if entity.isHierarchicalTree()>
			_finderPathWithPaginationCountAncestors = FinderPathUtil.create(
				${entityCacheEnabled},
				${finderCacheEnabled},
				${entity.name}Impl.class,
				Long.class,
			...
			_finderPathWithPaginationCountDescendants = FinderPathUtil.create(
				${entityCacheEnabled},
				${finderCacheEnabled},
				${entity.name}Impl.class,
				Long.class,
			...
			_finderPathWithPaginationGetAncestors = FinderPathUtil.create(
				${entityCacheEnabled},
				${finderCacheEnabled},
				${entity.name}Impl.class,
				${entity.name}Impl.class,
			...
			_finderPathWithPaginationGetDescendants = FinderPathUtil.create(
				${entityCacheEnabled},
				${finderCacheEnabled},
				${entity.name}Impl.class,
				${entity.name}Impl.class,
		...
		<#list entity.entityFinders as entityFinder>
			...
			<#if entityFinder.isCollection()>
				_finderPathWithPaginationFindBy${entityFinder.name} = FinderPathUtil.create(
					${entityCacheEnabled},
					${finderCacheEnabled},
					${entity.name}Impl.class,
					${entity.name}Impl.class,
				...
				<#if !entityFinder.hasCustomComparator()>
					_finderPathWithoutPaginationFindBy${entityFinder.name} = FinderPathUtil.create(
						${entityCacheEnabled},
						${finderCacheEnabled},
						${entity.name}Impl.class,
						${entity.name}Impl.class,
			...
			<#if !entityFinder.isCollection() || entityFinder.isUnique()>
				_finderPathFetchBy${entityFinder.name} = FinderPathUtil.create(
					${entityCacheEnabled},
					${finderCacheEnabled},
					${entity.name}Impl.class,
					${entity.name}Impl.class,
			...
			<#if !entityFinder.hasCustomComparator()>
				_finderPathCountBy${entityFinder.name} = FinderPathUtil.create(
					${entityCacheEnabled},
					${finderCacheEnabled},
					${entity.name}Impl.class,
					Long.class,
			...
			<#if entityFinder.hasArrayableOperator() || entityFinder.hasCustomComparator()>
				_finderPathWithPaginationCountBy${entityFinder.name} = FinderPathUtil.create(
					${entityCacheEnabled},
					${finderCacheEnabled},
					${entity.name}Impl.class,
					Long.class,
