...
package com.liferay.portal.store.ignore.duplicates.wrapper.internal.portal.profile;
...
import com.liferay.portal.store.ignore.duplicates.wrapper.internal.IgnoreDuplicatesFileSystemStoreWrapper;
	...
	public void activate(ComponentContext componentContext) {
		...
		if (dlStoreImpl.equals(
			...
			init(
				...
				IgnoreDuplicatesFileSystemStoreWrapper.class.getName());
		}
			...
			init(
				componentContext, supportedPortalProfileNames,
				IgnoreDuplicatesAdvancedFileSystemStoreWrapper.class.getName());
		}
		else {
			init(componentContext, supportedPortalProfileNames);
		}
	}
