...
public class AssetEntryAssetCategoryRelPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AssetEntryAssetCategoryRelImpl.class,
		...
		_finderPathWithoutPaginationFindByAssetCategoryId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("AssetCategoryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("AssetCategoryId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByAssetCategoryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((assetEntryAssetCategoryRelModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("AssetCategoryId")) != 0)) {
