...
public class SiteNavigationMenuPersistenceImpl
	...
	public SiteNavigationMenu updateImpl(
		...
		SiteNavigationMenu originalSiteNavigationMenu = siteNavigationMenu;
		...
		entityCache.putResult(
			SiteNavigationMenuImpl.class, originalSiteNavigationMenu, false,
			true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SiteNavigationMenuImpl.class;
