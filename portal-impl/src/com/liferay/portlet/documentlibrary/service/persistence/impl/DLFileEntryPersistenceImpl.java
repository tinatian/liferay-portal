...
public class DLFileEntryPersistenceImpl extends BasePersistenceImpl<DLFileEntry>
	...
	public List<DLFileEntry> findByUuid(String uuid, int start, int end,
		...
		if (retrieveFromCache) {
			list = (List<DLFileEntry>)FinderCacheUtil.getResult(finderPath,
					finderArgs, this);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2_SQL = "dlFileEntry.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3_SQL = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid_ = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2_SQL = "dlFileEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3_SQL = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid_ = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2_SQL = "dlFileEntry.groupId = ?";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_SQL = "dlFileEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_SQL = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid_ = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2_SQL = "dlFileEntry.companyId = ?";
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2_SQL = "dlFileEntry.groupId = ?";
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2_SQL = "dlFileEntry.companyId = ?";
	...
	private static final String _FINDER_COLUMN_REPOSITORYID_REPOSITORYID_2_SQL = "dlFileEntry.repositoryId = ?";
	...
	private static final String _FINDER_COLUMN_MIMETYPE_MIMETYPE_2_SQL = "dlFileEntry.mimeType = ?";
	private static final String _FINDER_COLUMN_MIMETYPE_MIMETYPE_3_SQL = "(dlFileEntry.mimeType IS NULL OR dlFileEntry.mimeType = '')";
	...
	public List<DLFileEntry> findByFileEntryTypeId(long fileEntryTypeId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_FILEENTRYTYPEID_FILEENTRYTYPEID_2_SQL);
	...
	private static final String _FINDER_COLUMN_FILEENTRYTYPEID_FILEENTRYTYPEID_2_SQL =
	 ...
	 */
	@Override
	public List<DLFileEntry> findBySmallImageId(long smallImageId, int start,
		int end) {
	...
	public List<DLFileEntry> findBySmallImageId(long smallImageId, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_SMALLIMAGEID_SMALLIMAGEID_2_SQL);
	 ...
	 */
	@Override
	public DLFileEntry findBySmallImageId_First(long smallImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchBySmallImageId_First(smallImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchBySmallImageId_First(long smallImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		List<DLFileEntry> list = findBySmallImageId(smallImageId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry findBySmallImageId_Last(long smallImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchBySmallImageId_Last(smallImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchBySmallImageId_Last(long smallImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		...
		List<DLFileEntry> list = findBySmallImageId(smallImageId, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry[] findBySmallImageId_PrevAndNext(long fileEntryId,
		...
		try {
			...
			array[0] = getBySmallImageId_PrevAndNext(session, dlFileEntry,
					smallImageId, orderByComparator, true);

			array[1] = dlFileEntry;

			array[2] = getBySmallImageId_PrevAndNext(session, dlFileEntry,
	...
	protected DLFileEntry getBySmallImageId_PrevAndNext(Session session,
		DLFileEntry dlFileEntry, long smallImageId,
		OrderByComparator<DLFileEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FINDER_COLUMN_SMALLIMAGEID_SMALLIMAGEID_2_SQL = "dlFileEntry.smallImageId = ?";
	...
	public List<DLFileEntry> findByLargeImageId(long largeImageId) {
		return findByLargeImageId(largeImageId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<DLFileEntry> findByLargeImageId(long largeImageId, int start,
		int end) {
	...
	public List<DLFileEntry> findByLargeImageId(long largeImageId, int start,
		int end, OrderByComparator<DLFileEntry> orderByComparator) {
		return findByLargeImageId(largeImageId, start, end, orderByComparator,
			true);
	}
	...
	public List<DLFileEntry> findByLargeImageId(long largeImageId, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_LARGEIMAGEID_LARGEIMAGEID_2_SQL);
	 ...
	 */
	@Override
	public DLFileEntry findByLargeImageId_First(long largeImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByLargeImageId_First(largeImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByLargeImageId_First(long largeImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		List<DLFileEntry> list = findByLargeImageId(largeImageId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry findByLargeImageId_Last(long largeImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByLargeImageId_Last(largeImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByLargeImageId_Last(long largeImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		...
		List<DLFileEntry> list = findByLargeImageId(largeImageId, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry[] findByLargeImageId_PrevAndNext(long fileEntryId,
		...
		try {
			...
			array[0] = getByLargeImageId_PrevAndNext(session, dlFileEntry,
					largeImageId, orderByComparator, true);

			array[1] = dlFileEntry;

			array[2] = getByLargeImageId_PrevAndNext(session, dlFileEntry,
					largeImageId, orderByComparator, false);
	...
	protected DLFileEntry getByLargeImageId_PrevAndNext(Session session,
		DLFileEntry dlFileEntry, long largeImageId,
		OrderByComparator<DLFileEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FINDER_COLUMN_LARGEIMAGEID_LARGEIMAGEID_2_SQL = "dlFileEntry.largeImageId = ?";
	...
	public List<DLFileEntry> findByCustom1ImageId(long custom1ImageId,
		int start, int end, OrderByComparator<DLFileEntry> orderByComparator) {
		return findByCustom1ImageId(custom1ImageId, start, end,
			orderByComparator, true);
	}
	...
	public List<DLFileEntry> findByCustom1ImageId(long custom1ImageId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_CUSTOM1IMAGEID_CUSTOM1IMAGEID_2_SQL);
	 ...
	 */
	@Override
	public DLFileEntry findByCustom1ImageId_First(long custom1ImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByCustom1ImageId_First(custom1ImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByCustom1ImageId_First(long custom1ImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		List<DLFileEntry> list = findByCustom1ImageId(custom1ImageId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry findByCustom1ImageId_Last(long custom1ImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByCustom1ImageId_Last(custom1ImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByCustom1ImageId_Last(long custom1ImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		...
		List<DLFileEntry> list = findByCustom1ImageId(custom1ImageId,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry[] findByCustom1ImageId_PrevAndNext(long fileEntryId,
		...
		try {
			...
			array[0] = getByCustom1ImageId_PrevAndNext(session, dlFileEntry,
					custom1ImageId, orderByComparator, true);

			array[1] = dlFileEntry;

			array[2] = getByCustom1ImageId_PrevAndNext(session, dlFileEntry,
					custom1ImageId, orderByComparator, false);
	...
	protected DLFileEntry getByCustom1ImageId_PrevAndNext(Session session,
		DLFileEntry dlFileEntry, long custom1ImageId,
		OrderByComparator<DLFileEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	private static final String _FINDER_COLUMN_CUSTOM1IMAGEID_CUSTOM1IMAGEID_2_SQL =
	...
	public List<DLFileEntry> findByCustom2ImageId(long custom2ImageId) {
		return findByCustom2ImageId(custom2ImageId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<DLFileEntry> findByCustom2ImageId(long custom2ImageId,
		int start, int end, OrderByComparator<DLFileEntry> orderByComparator) {
		return findByCustom2ImageId(custom2ImageId, start, end,
			orderByComparator, true);
	}
	...
	public List<DLFileEntry> findByCustom2ImageId(long custom2ImageId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_CUSTOM2IMAGEID_CUSTOM2IMAGEID_2_SQL);
	 ...
	 */
	@Override
	public DLFileEntry findByCustom2ImageId_First(long custom2ImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByCustom2ImageId_First(custom2ImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByCustom2ImageId_First(long custom2ImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		List<DLFileEntry> list = findByCustom2ImageId(custom2ImageId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry findByCustom2ImageId_Last(long custom2ImageId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByCustom2ImageId_Last(custom2ImageId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByCustom2ImageId_Last(long custom2ImageId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		...
		List<DLFileEntry> list = findByCustom2ImageId(custom2ImageId,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry[] findByCustom2ImageId_PrevAndNext(long fileEntryId,
		...
		try {
			...
			array[0] = getByCustom2ImageId_PrevAndNext(session, dlFileEntry,
					custom2ImageId, orderByComparator, true);

			array[1] = dlFileEntry;

			array[2] = getByCustom2ImageId_PrevAndNext(session, dlFileEntry,
					custom2ImageId, orderByComparator, false);
	...
	protected DLFileEntry getByCustom2ImageId_PrevAndNext(Session session,
	...
	private static final String _FINDER_COLUMN_CUSTOM2IMAGEID_CUSTOM2IMAGEID_2_SQL =
	...
	private static final String _FINDER_COLUMN_G_U_GROUPID_2_SQL = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_USERID_2_SQL = "dlFileEntry.userId = ?";
	...
	public List<DLFileEntry> findByG_F(long groupId, long folderId, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_F_FOLDERID_2_SQL);
	...
	public List<DLFileEntry> filterFindByG_F(long groupId, long[] folderIds,
		...
		if (folderIds.length > 0) {
			...
			query.append(_FINDER_COLUMN_G_F_FOLDERID_7_SQL);
	...
	public List<DLFileEntry> findByG_F(long groupId, long[] folderIds,
		...
		if (retrieveFromCache) {
			list = (List<DLFileEntry>)FinderCacheUtil.getResult(_finderPathWithPaginationFindByG_F,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationFindByG_F,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationFindByG_F,
					finderArgs);
	...
	public int countByG_F(long groupId, long[] folderIds) {
		...
		Long count = (Long)FinderCacheUtil.getResult(_finderPathWithPaginationCountByG_F,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationCountByG_F,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationCountByG_F,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_G_F_GROUPID_2_SQL = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_FOLDERID_2_SQL = "dlFileEntry.folderId = ?";
	private static final String _FINDER_COLUMN_G_F_FOLDERID_7_SQL = "dlFileEntry.folderId IN (";
	...
	public List<DLFileEntry> findByR_F(long repositoryId, long folderId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_R_F_REPOSITORYID_2_SQL);

			query.append(_FINDER_COLUMN_R_F_FOLDERID_2_SQL);
	...
	private static final String _FINDER_COLUMN_R_F_REPOSITORYID_2_SQL = "dlFileEntry.repositoryId = ? AND ";
	private static final String _FINDER_COLUMN_R_F_FOLDERID_2_SQL = "dlFileEntry.folderId = ?";
	...
	public List<DLFileEntry> findByF_N(long folderId, String name, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_N_FOLDERID_2_SQL);

			boolean bindName = false;

			if (name.isEmpty()) {
				query.append(_FINDER_COLUMN_F_N_NAME_3_SQL);
			}
			else {
				bindName = true;

				query.append(_FINDER_COLUMN_F_N_NAME_2_SQL);
			}
	...
	private static final String _FINDER_COLUMN_F_N_FOLDERID_2_SQL = "dlFileEntry.folderId = ? AND ";
	private static final String _FINDER_COLUMN_F_N_NAME_2_SQL = "dlFileEntry.name = ?";
	private static final String _FINDER_COLUMN_F_N_NAME_3_SQL = "(dlFileEntry.name IS NULL OR dlFileEntry.name = '')";
	...
	public List<DLFileEntry> findByG_U_F(long groupId, long userId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_U_F_FOLDERID_2_SQL);
	...
	public List<DLFileEntry> filterFindByG_U_F(long groupId, long userId,
		...
		if (folderIds.length > 0) {
			...
			query.append(_FINDER_COLUMN_G_U_F_FOLDERID_7_SQL);
	...
	public List<DLFileEntry> findByG_U_F(long groupId, long userId,
		...
		if (retrieveFromCache) {
			list = (List<DLFileEntry>)FinderCacheUtil.getResult(_finderPathWithPaginationFindByG_U_F,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationFindByG_U_F,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationFindByG_U_F,
					finderArgs);
	...
	public int countByG_U_F(long groupId, long userId, long[] folderIds) {
		...
		Long count = (Long)FinderCacheUtil.getResult(_finderPathWithPaginationCountByG_U_F,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationCountByG_U_F,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationCountByG_U_F,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_G_U_F_GROUPID_2_SQL = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_F_USERID_2_SQL = "dlFileEntry.userId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_F_FOLDERID_2_SQL = "dlFileEntry.folderId = ?";
	private static final String _FINDER_COLUMN_G_U_F_FOLDERID_7_SQL = "dlFileEntry.folderId IN (";
	...
	public DLFileEntry fetchByG_F_N(long groupId, long folderId, String name,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByG_F_N,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_F_N_GROUPID_2_SQL);

			query.append(_FINDER_COLUMN_G_F_N_FOLDERID_2_SQL);

			boolean bindName = false;

			if (name.isEmpty()) {
				query.append(_FINDER_COLUMN_G_F_N_NAME_3_SQL);
			}
			else {
				bindName = true;

				query.append(_FINDER_COLUMN_G_F_N_NAME_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByG_F_N,
						finderArgs, list);
				}
				else {
					DLFileEntry dlFileEntry = list.get(0);
				...
				FinderCacheUtil.removeResult(_finderPathFetchByG_F_N, finderArgs);
	...
	private static final String _FINDER_COLUMN_G_F_N_GROUPID_2_SQL = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_N_FOLDERID_2_SQL = "dlFileEntry.folderId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_N_NAME_2_SQL = "dlFileEntry.name = ?";
	private static final String _FINDER_COLUMN_G_F_N_NAME_3_SQL = "(dlFileEntry.name IS NULL OR dlFileEntry.name = '')";
	...
	public DLFileEntry fetchByG_F_FN(long groupId, long folderId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByG_F_FN,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_F_FN_GROUPID_2_SQL);

			query.append(_FINDER_COLUMN_G_F_FN_FOLDERID_2_SQL);

			boolean bindFileName = false;

			if (fileName.isEmpty()) {
				query.append(_FINDER_COLUMN_G_F_FN_FILENAME_3_SQL);
			}
			else {
				bindFileName = true;

				query.append(_FINDER_COLUMN_G_F_FN_FILENAME_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByG_F_FN,
						finderArgs, list);
				}
				else {
					DLFileEntry dlFileEntry = list.get(0);
				...
				FinderCacheUtil.removeResult(_finderPathFetchByG_F_FN,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_G_F_FN_GROUPID_2_SQL = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_FN_FOLDERID_2_SQL = "dlFileEntry.folderId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_FN_FILENAME_2_SQL = "dlFileEntry.fileName = ?";
	private static final String _FINDER_COLUMN_G_F_FN_FILENAME_3_SQL = "(dlFileEntry.fileName IS NULL OR dlFileEntry.fileName = '')";
	...
	public DLFileEntry fetchByG_F_T(long groupId, long folderId, String title,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(_finderPathFetchByG_F_T,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_F_T_GROUPID_2_SQL);

			query.append(_FINDER_COLUMN_G_F_T_FOLDERID_2_SQL);

			boolean bindTitle = false;

			if (title.isEmpty()) {
				query.append(_FINDER_COLUMN_G_F_T_TITLE_3_SQL);
			}
			else {
				bindTitle = true;

				query.append(_FINDER_COLUMN_G_F_T_TITLE_2_SQL);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(_finderPathFetchByG_F_T,
						finderArgs, list);
				}
				else {
					DLFileEntry dlFileEntry = list.get(0);
				...
				FinderCacheUtil.removeResult(_finderPathFetchByG_F_T, finderArgs);
	...
	private static final String _FINDER_COLUMN_G_F_T_GROUPID_2_SQL = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_T_FOLDERID_2_SQL = "dlFileEntry.folderId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_T_TITLE_2_SQL = "dlFileEntry.title = ?";
	private static final String _FINDER_COLUMN_G_F_T_TITLE_3_SQL = "(dlFileEntry.title IS NULL OR dlFileEntry.title = '')";
	...
	public List<DLFileEntry> findByG_F_F(long groupId, long folderId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_F_F_GROUPID_2_SQL);

			query.append(_FINDER_COLUMN_G_F_F_FOLDERID_2_SQL);

			query.append(_FINDER_COLUMN_G_F_F_FILEENTRYTYPEID_2_SQL);
	...
	public List<DLFileEntry> filterFindByG_F_F(long groupId, long[] folderIds,
		...
		if (folderIds.length > 0) {
			...
			query.append(_FINDER_COLUMN_G_F_F_FOLDERID_7_SQL);
	...
	public List<DLFileEntry> findByG_F_F(long groupId, long[] folderIds,
		...
		if (retrieveFromCache) {
			list = (List<DLFileEntry>)FinderCacheUtil.getResult(_finderPathWithPaginationFindByG_F_F,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationFindByG_F_F,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationFindByG_F_F,
					finderArgs);
	...
	public int countByG_F_F(long groupId, long[] folderIds, long fileEntryTypeId) {
		...
		Long count = (Long)FinderCacheUtil.getResult(_finderPathWithPaginationCountByG_F_F,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(_finderPathWithPaginationCountByG_F_F,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(_finderPathWithPaginationCountByG_F_F,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_G_F_F_GROUPID_2_SQL = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_F_FOLDERID_2_SQL = "dlFileEntry.folderId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_F_FOLDERID_7_SQL = "dlFileEntry.folderId IN (";
	private static final String _FINDER_COLUMN_G_F_F_FILEENTRYTYPEID_2_SQL = "dlFileEntry.fileEntryTypeId = ?";
	...
	public List<DLFileEntry> findByS_L_C1_C2(long smallImageId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_S_L_C1_C2_SMALLIMAGEID_2_SQL);

			query.append(_FINDER_COLUMN_S_L_C1_C2_LARGEIMAGEID_2_SQL);

			query.append(_FINDER_COLUMN_S_L_C1_C2_CUSTOM1IMAGEID_2_SQL);

			query.append(_FINDER_COLUMN_S_L_C1_C2_CUSTOM2IMAGEID_2_SQL);
	...
	private static final String _FINDER_COLUMN_S_L_C1_C2_SMALLIMAGEID_2_SQL = "dlFileEntry.smallImageId = ? AND ";
	private static final String _FINDER_COLUMN_S_L_C1_C2_LARGEIMAGEID_2_SQL = "dlFileEntry.largeImageId = ? AND ";
	private static final String _FINDER_COLUMN_S_L_C1_C2_CUSTOM1IMAGEID_2_SQL = "dlFileEntry.custom1ImageId = ? AND ";
	private static final String _FINDER_COLUMN_S_L_C1_C2_CUSTOM2IMAGEID_2_SQL = "dlFileEntry.custom2ImageId = ?";
	...
	protected void cacheUniqueFindersCache(
		...
		FinderCacheUtil.putResult(_finderPathCountByG_F_N, args,
			Long.valueOf(1), false);
		FinderCacheUtil.putResult(_finderPathFetchByG_F_N, args,
			dlFileEntryModelImpl, false);
		...
		FinderCacheUtil.putResult(_finderPathCountByG_F_FN, args,
			Long.valueOf(1), false);
		FinderCacheUtil.putResult(_finderPathFetchByG_F_FN, args,
			dlFileEntryModelImpl, false);
		...
		FinderCacheUtil.putResult(_finderPathCountByG_F_T, args,
			Long.valueOf(1), false);
		FinderCacheUtil.putResult(_finderPathFetchByG_F_T, args,
			dlFileEntryModelImpl, false);
	}
	...
	public DLFileEntry updateImpl(DLFileEntry dlFileEntry) {
		...
		if (!DLFileEntryModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByMimeType,
				args);

			args = new Object[] { dlFileEntryModelImpl.getFileEntryTypeId() };

			FinderCacheUtil.removeResult(_finderPathCountByFileEntryTypeId, args);
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByFileEntryTypeId,
				args);

			args = new Object[] { dlFileEntryModelImpl.getSmallImageId() };

			FinderCacheUtil.removeResult(_finderPathCountBySmallImageId, args);
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindBySmallImageId,
				args);

			args = new Object[] { dlFileEntryModelImpl.getLargeImageId() };

			FinderCacheUtil.removeResult(_finderPathCountByLargeImageId, args);
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByLargeImageId,
				args);

			args = new Object[] { dlFileEntryModelImpl.getCustom1ImageId() };

			FinderCacheUtil.removeResult(_finderPathCountByCustom1ImageId, args);
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByCustom1ImageId,
				args);

			args = new Object[] { dlFileEntryModelImpl.getCustom2ImageId() };

			FinderCacheUtil.removeResult(_finderPathCountByCustom2ImageId, args);
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByCustom2ImageId,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByR_F,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByF_N,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByG_F_F,
				args);
			...
			FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByS_L_C1_C2,
				args);
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByMimeType.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByFileEntryTypeId.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalFileEntryTypeId()
					};

				FinderCacheUtil.removeResult(_finderPathCountByFileEntryTypeId,
					args);
				FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByFileEntryTypeId,
					args);
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
				...
				FinderCacheUtil.removeResult(_finderPathCountBySmallImageId,
					args);
				FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindBySmallImageId,
					args);
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByLargeImageId.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalLargeImageId()
					};

				FinderCacheUtil.removeResult(_finderPathCountByLargeImageId,
					args);
				FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByLargeImageId,
					args);
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByCustom1ImageId.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalCustom1ImageId()
					};

				FinderCacheUtil.removeResult(_finderPathCountByCustom1ImageId,
					args);
				FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByCustom1ImageId,
					args);
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByCustom2ImageId.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalCustom2ImageId()
					};

				FinderCacheUtil.removeResult(_finderPathCountByCustom2ImageId,
					args);
				FinderCacheUtil.removeResult(_finderPathWithoutPaginationFindByCustom2ImageId,
					args);
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByR_F.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalRepositoryId(),
						dlFileEntryModelImpl.getOriginalFolderId()
					};
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByF_N.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalFolderId(),
						dlFileEntryModelImpl.getOriginalName()
					};
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByG_F_F.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalGroupId(),
						dlFileEntryModelImpl.getOriginalFolderId(),
						dlFileEntryModelImpl.getOriginalFileEntryTypeId()
			...
			if ((dlFileEntryModelImpl.getColumnBitmask() &
					_finderPathWithoutPaginationFindByS_L_C1_C2.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileEntryModelImpl.getOriginalSmallImageId(),
						dlFileEntryModelImpl.getOriginalLargeImageId(),
						dlFileEntryModelImpl.getOriginalCustom1ImageId(),
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll",
				new String[0]);

		_finderPathCountAll = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
				new String[0]);

		_finderPathWithPaginationFindByUuid = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByUuid",
				new String[] {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByUuid = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
				new String[] { String.class.getName() });

		_finderPathFetchByUUID_G = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
				"fetchByUUID_G",
				new String[] { String.class.getName(), Long.class.getName() },
				DLFileEntryModelImpl.UUID_COLUMN_BITMASK |
				DLFileEntryModelImpl.GROUPID_COLUMN_BITMASK);

		_finderPathCountByUUID_G = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUUID_G",
				new String[] { String.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByUuid_C = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByUuid_C",
				new String[] {
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByUuid_C = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
				new String[] { String.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByGroupId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByGroupId",
				new String[] {
		...
		_finderPathWithoutPaginationFindByGroupId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByGroupId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByGroupId",
				new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByCompanyId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByCompanyId",
				new String[] {
		...
		_finderPathWithoutPaginationFindByCompanyId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByCompanyId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompanyId",
				new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByRepositoryId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByRepositoryId",
				new String[] {
		...
		_finderPathWithoutPaginationFindByRepositoryId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByRepositoryId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"countByRepositoryId", new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByMimeType = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByMimeType",
				new String[] {
		...
		_finderPathWithoutPaginationFindByMimeType = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByMimeType = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByMimeType",
				new String[] { String.class.getName() });

		_finderPathWithPaginationFindByFileEntryTypeId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathWithoutPaginationFindByFileEntryTypeId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByFileEntryTypeId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"countByFileEntryTypeId", new String[] { Long.class.getName() });

		_finderPathWithPaginationFindBySmallImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findBySmallImageId",
				new String[] {
		...
		_finderPathWithoutPaginationFindBySmallImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountBySmallImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"countBySmallImageId", new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByLargeImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByLargeImageId",
				new String[] {
		...
		_finderPathWithoutPaginationFindByLargeImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByLargeImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"countByLargeImageId", new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByCustom1ImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathWithoutPaginationFindByCustom1ImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByCustom1ImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"countByCustom1ImageId", new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByCustom2ImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathWithoutPaginationFindByCustom2ImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByCustom2ImageId = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
				"countByCustom2ImageId", new String[] { Long.class.getName() });

		_finderPathWithPaginationFindByG_U = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByG_U",
				new String[] {
		...
		_finderPathWithoutPaginationFindByG_U = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByG_U = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_U",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByG_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByG_F",
				new String[] {
		...
		_finderPathWithoutPaginationFindByG_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByG_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_F",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathWithPaginationCountByG_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_F",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByR_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByR_F",
				new String[] {
		...
		_finderPathWithoutPaginationFindByR_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByR_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByR_F",
				new String[] { Long.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByF_N = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByF_N",
				new String[] {
		...
		_finderPathWithoutPaginationFindByF_N = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByF_N = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_N",
				new String[] { Long.class.getName(), String.class.getName() });

		_finderPathWithPaginationFindByG_U_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByG_U_F",
				new String[] {
		...
		_finderPathWithoutPaginationFindByG_U_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByG_U_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationCountByG_U_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathFetchByG_F_N = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
				"fetchByG_F_N",
				new String[] {
		...
		_finderPathCountByG_F_N = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathFetchByG_F_FN = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
				"fetchByG_F_FN",
				new String[] {
		...
		_finderPathCountByG_F_FN = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathFetchByG_F_T = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
				"fetchByG_F_T",
				new String[] {
		...
		_finderPathCountByG_F_T = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationFindByG_F_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByG_F_F",
				new String[] {
		...
		_finderPathWithoutPaginationFindByG_F_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByG_F_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationCountByG_F_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithPaginationFindByS_L_C1_C2 = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
				"findByS_L_C1_C2",
				new String[] {
		...
		_finderPathWithoutPaginationFindByS_L_C1_C2 = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED,
				DLFileEntryImpl.class,
		...
		_finderPathCountByS_L_C1_C2 = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
				DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
