...
public class LayoutFriendlyURLPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByP_F", _finderPathCountByP_F
			).put(
				...
				"finderPathFetchByP_L", _finderPathFetchByP_L
			).put(
				"finderPathCountByP_L", _finderPathCountByP_L
			).put(
				...
				"finderPathFetchByG_P_F_L", _finderPathFetchByG_P_F_L
			).put(
				"finderPathCountByG_P_F_L", _finderPathCountByG_P_F_L
			).build());
	...
	public void destroy() {
		...
		FinderPath.unregisterFinderPaths(LayoutFriendlyURL.class);
	}
