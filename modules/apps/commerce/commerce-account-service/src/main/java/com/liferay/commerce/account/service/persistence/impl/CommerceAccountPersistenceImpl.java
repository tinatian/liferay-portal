...
public class CommerceAccountPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			MapUtil.singletonDictionary(
				"model.class.name", CommerceAccount.class.getName()));
	...
	private static class CommerceAccountModelArgumentsResolver
		...
		private final String _className = CommerceAccountImpl.class.getName();
		private final String _tableName =
			CommerceAccountTable.INSTANCE.getTableName();
