...
/**
 * Provides the local service utility for UniqueIndexWithLongTypeEntry. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.UniqueIndexWithLongTypeEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UniqueIndexWithLongTypeEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.UniqueIndexWithLongTypeEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static UniqueIndexWithLongTypeEntry addUniqueIndexWithLongTypeEntry(
		UniqueIndexWithLongTypeEntry uniqueIndexWithLongTypeEntry) {

		return getService().addUniqueIndexWithLongTypeEntry(
	 ...
	 */
	public static UniqueIndexWithLongTypeEntry
		createUniqueIndexWithLongTypeEntry(
			long uniqueIndexWithLongTypeEntryId) {

		return getService().createUniqueIndexWithLongTypeEntry(
	...
	public static UniqueIndexWithLongTypeEntry
		...
		return getService().deleteUniqueIndexWithLongTypeEntry(
			uniqueIndexWithLongTypeEntryId);
	}
	...
	public static UniqueIndexWithLongTypeEntry
		fetchUniqueIndexWithLongTypeEntry(long uniqueIndexWithLongTypeEntryId) {

		return getService().fetchUniqueIndexWithLongTypeEntry(
			uniqueIndexWithLongTypeEntryId);
	}
	 ...
	 */
	public static List<UniqueIndexWithLongTypeEntry>
		getUniqueIndexWithLongTypeEntries(int start, int end) {

		return getService().getUniqueIndexWithLongTypeEntries(start, end);
	}
	 ...
	 */
	public static int getUniqueIndexWithLongTypeEntriesCount() {
		return getService().getUniqueIndexWithLongTypeEntriesCount();
	}
	 ...
	 * @throws PortalException if a unique index with long type entry with the primary key could not be found
	 */
	public static UniqueIndexWithLongTypeEntry getUniqueIndexWithLongTypeEntry(
			long uniqueIndexWithLongTypeEntryId)
		throws PortalException {

		return getService().getUniqueIndexWithLongTypeEntry(
			uniqueIndexWithLongTypeEntryId);
	}
	 ...
	 */
	public static UniqueIndexWithLongTypeEntry
		updateUniqueIndexWithLongTypeEntry(
			UniqueIndexWithLongTypeEntry uniqueIndexWithLongTypeEntry) {

		return getService().updateUniqueIndexWithLongTypeEntry(
			uniqueIndexWithLongTypeEntry);
	}

	public static UniqueIndexWithLongTypeEntryLocalService getService() {
		return _service;
	}

	public static void setService(
		UniqueIndexWithLongTypeEntryLocalService service) {

		_service = service;
	}

	private static volatile UniqueIndexWithLongTypeEntryLocalService _service;
