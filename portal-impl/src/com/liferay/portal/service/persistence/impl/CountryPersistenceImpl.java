	...
	protected void clearUniqueFindersCache(
		...
		if ((countryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				countryModelImpl.getCacheModelAttribute("name")
			};
		...
		if ((countryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				countryModelImpl.getCacheModelAttribute("a2")
			};
		...
		if ((countryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				countryModelImpl.getCacheModelAttribute("a3")
			};
	...
	public Country updateImpl(Country country) {
		...
		if (isNew) {
			...
			if ((countryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					countryModelImpl.getCacheModelAttribute("active")
				};
