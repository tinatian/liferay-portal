...
public class VersionedEntryModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (versionedEntryCacheModel == null) {
			versionedEntryCacheModel = _dummyVersionedEntryCacheModel;
		}

		return (T)function.apply(versionedEntryCacheModel);
	}

	private VersionedEntryCacheModel _toVersionedEntryCacheModel() {
		VersionedEntryCacheModel versionedEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"head", versionedEntryCacheModel -> versionedEntryCacheModel.head);
