	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByDDMStructureId =
			FinderPathUtil.create(
				...
				DEDataListViewImpl.class, DEDataListViewImpl.class,
		...
		_finderPathWithPaginationFindByG_C_DDMSI = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DEDataListViewImpl.class,
			DEDataListViewImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_C_DDMSI",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_C_DDMSI = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DEDataListViewImpl.class,
			DEDataListViewImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_C_DDMSI",
			new String[] {
		...
		_finderPathCountByG_C_DDMSI = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DEDataListViewImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_C_DDMSI",
			new String[] {
