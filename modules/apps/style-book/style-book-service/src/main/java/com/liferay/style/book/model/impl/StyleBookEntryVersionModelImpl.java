...
public class StyleBookEntryVersionModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (styleBookEntryVersionCacheModel == null) {
			styleBookEntryVersionCacheModel =
				_dummyStyleBookEntryVersionCacheModel;
		}

		return (T)function.apply(styleBookEntryVersionCacheModel);
	}

	private StyleBookEntryVersionCacheModel
		_toStyleBookEntryVersionCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			styleBookEntryVersionCacheModel -> {
				Long createDate = styleBookEntryVersionCacheModel.createDate;
