...
public class LayoutPrototypePersistenceImpl
	...
	public LayoutPrototype updateImpl(LayoutPrototype layoutPrototype) {
		...
		EntityCacheUtil.putResult(
			LayoutPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutPrototypeImpl.class, layoutPrototype, false,
			LayoutPrototypeModelImpl.COLUMN_BITMASK_ENABLED);
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", LayoutPrototypeModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", LayoutPrototypeModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPrototypeModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {layoutPrototypeModelImpl.getUuid()};
				}
