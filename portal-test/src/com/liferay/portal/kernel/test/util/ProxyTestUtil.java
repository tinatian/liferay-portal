...
public class ProxyTestUtil {
	...
	public static <T> T setMethodDoExpected(
		...
		proxyInvocationHandler.registerMethod(expectedResult, methodName);
	...
	private static class ProxyInvocationHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args)
			...
			if (result != null) {
				...
				else if (_NULL_HOLDER.equals(result)) {
					return null;
				}
		...
		public void registerMethod(Object expectedResult, String methodName)
			throws Exception {
			...
			if (registeredResult != null) {
				_results.put(methodName, result);
			}
			else {
