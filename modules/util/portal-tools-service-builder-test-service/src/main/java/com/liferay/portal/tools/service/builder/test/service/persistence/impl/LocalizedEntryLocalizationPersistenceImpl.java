...
public class LocalizedEntryLocalizationPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByLocalizedEntryId = FinderPathUtil.create(
			LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			LocalizedEntryLocalizationImpl.class,
			LocalizedEntryLocalizationImpl.class,
		...
		_finderPathCountByLocalizedEntryId = FinderPathUtil.create(
			LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			LocalizedEntryLocalizationImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathFetchByLocalizedEntryId_LanguageId = FinderPathUtil.create(
			LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			LocalizedEntryLocalizationImpl.class,
		...
		_finderPathCountByLocalizedEntryId_LanguageId = FinderPathUtil.create(
			LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationModelImpl.FINDER_CACHE_ENABLED,
			LocalizedEntryLocalizationImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
