...
public class SamlSpIdpConnectionPersistenceImpl
	...
	public SamlSpIdpConnection updateImpl(
		...
		SamlSpIdpConnection originalSamlSpIdpConnection = samlSpIdpConnection;
		...
		entityCache.putResult(
			SamlSpIdpConnectionImpl.class, originalSamlSpIdpConnection, false,
			true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByC_SIEI = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_SIEI", "fetchByC_SIEI",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathCountByC_SIEI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_SIEI",
			"countByC_SIEI",
			new String[] {Long.class.getName(), String.class.getName()});
	}
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SamlSpIdpConnectionImpl.class;
