...
public class AssetListEntryAssetEntryRelPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AssetListEntryAssetEntryRelImpl.class,
		...
		_finderPathFetchByA_S_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("A_S_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("A_S_P"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByA_S_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByA_S_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
