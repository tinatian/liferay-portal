...
public class CPDefinitionOptionRelPersistenceImpl
			...
			if (result == null) {
				...
				try {
					...
					if (list.isEmpty()) {
						...
						CPDefinitionOptionRel cpDefinitionOptionRel = list.get(
							0);
	...
	public CPDefinitionOptionRel fetchByCPOptionId_First(
		...
		List<CPDefinitionOptionRel> list = findByCPOptionId(
	...
	public CPDefinitionOptionRel findByCPOptionId_Last(
		...
		CPDefinitionOptionRel cpDefinitionOptionRel = fetchByCPOptionId_Last(
			CPOptionId, orderByComparator);
	...
	public CPDefinitionOptionRel[] findByCPOptionId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCPOptionId_PrevAndNext(
				session, cpDefinitionOptionRel, CPOptionId, orderByComparator,
				true);
	...
	protected CPDefinitionOptionRel getByCPOptionId_PrevAndNext(
		Session session, CPDefinitionOptionRel cpDefinitionOptionRel,
		long CPOptionId,
		OrderByComparator<CPDefinitionOptionRel> orderByComparator,
		boolean previous) {
