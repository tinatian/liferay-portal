...
public class MicroblogsEntryPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByU_T = _createFinderPath(
			MicroblogsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByU_T", new String[] {"userId", "type"});
		...
		_finderPathWithPaginationFindByC_CCNI_T = _createFinderPath(
			MicroblogsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_CCNI_T",
			new String[] {"companyId", "creatorClassNameId", "type"});
		...
		_finderPathWithPaginationFindByCCNI_CCPK_T = _createFinderPath(
			MicroblogsEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByCCNI_CCPK_T",
			new String[] {"creatorClassNameId", "creatorClassPK", "type"});
	...
	private static class MicroblogsEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					microblogsEntryModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					microblogsEntryModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = microblogsEntryModelImpl.getAttributeValue(
						attributeName);
				}
			}
