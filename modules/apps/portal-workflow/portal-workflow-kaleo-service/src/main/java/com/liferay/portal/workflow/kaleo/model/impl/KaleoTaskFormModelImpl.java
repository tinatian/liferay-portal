...
public class KaleoTaskFormModelImpl
	...
	private KaleoTaskFormCacheModel _toKaleoTaskFormCacheModel() {
		KaleoTaskFormCacheModel kaleoTaskFormCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			kaleoTaskFormCacheModel -> {
				Long createDate = kaleoTaskFormCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			kaleoTaskFormCacheModel -> {
				Long modifiedDate = kaleoTaskFormCacheModel.modifiedDate;
