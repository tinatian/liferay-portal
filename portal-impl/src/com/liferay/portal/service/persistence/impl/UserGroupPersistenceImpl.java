...
public class UserGroupPersistenceImpl extends BasePersistenceImpl<UserGroup>
	...
	public List<UserGroup> findByC_P(long companyId, long parentUserGroupId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_P_PARENTUSERGROUPID_2_SQL);
	...
	public List<UserGroup> findByU_C_P(long userGroupId, long companyId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_U_C_P_USERGROUPID_2_SQL);

			query.append(_FINDER_COLUMN_U_C_P_COMPANYID_2_SQL);

			query.append(_FINDER_COLUMN_U_C_P_PARENTUSERGROUPID_2_SQL);
