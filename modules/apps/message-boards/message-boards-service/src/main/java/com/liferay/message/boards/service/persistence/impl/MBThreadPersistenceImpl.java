...
public class MBThreadPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByRootMessageId = _createFinderPath(
			...
			"fetchByRootMessageId", new String[] {"rootMessageId"});

		_finderPathCountByRootMessageId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByRootMessageId", new String[] {"rootMessageId"});
		...
		_finderPathWithPaginationFindByG_NotC = _createFinderPath(
			MBThreadImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_NotC", new String[] {"groupId", "categoryId"});
		...
		_finderPathWithPaginationFindByC_P = _createFinderPath(
			MBThreadImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_P", new String[] {"categoryId", "priority"});
		...
		_finderPathCountByC_P = _createFinderPath(
			...
			new String[] {"categoryId", "priority"});

		_finderPathWithPaginationFindByL_P = _createFinderPath(
			MBThreadImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByL_P", new String[] {"lastPostDate", "priority"});
		...
		_finderPathCountByL_P = _createFinderPath(
			...
			new String[] {"lastPostDate", "priority"});
		...
		_finderPathWithPaginationCountByG_C_S = _createFinderPath(
			...
			new String[] {"groupId", "categoryId", "status"});

		_finderPathWithPaginationFindByG_C_NotS = _createFinderPath(
			MBThreadImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_C_NotS", new String[] {"groupId", "categoryId", "status"});
		...
		_finderPathWithPaginationFindByG_NotC_S = _createFinderPath(
			MBThreadImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_NotC_S", new String[] {"groupId", "categoryId", "status"});
	...
	private static class MBThreadModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(mbThreadModelImpl, attributeNames, original);
			}
		...
		private Object[] _getValue(
			MBThreadModelImpl mbThreadModelImpl, String[] attributeNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = mbThreadModelImpl.getOriginalAttributeValue(
						attributeName);
				}
				else {
					arguments[i] = mbThreadModelImpl.getAttributeValue(
						attributeName);
				}
			}
