...
public class WorkflowMetricsSLADefinitionPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByWMSLAD_A = _createFinderPath(
			WorkflowMetricsSLADefinitionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByWMSLAD_A", new String[] {"wmSLADefinitionId", "active_"});

		_finderPathCountByWMSLAD_A = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByWMSLAD_A", new String[] {"wmSLADefinitionId", "active_"});
		...
		_finderPathWithPaginationFindByC_A_P = _createFinderPath(
			...
			new String[] {"companyId", "active_", "processId"});
		...
		_finderPathCountByC_A_P = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByC_A_P", new String[] {"companyId", "active_", "processId"});
