...
public class CommerceDiscountPersistenceImpl
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathCountByC_C_A, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByC_C_A, args, commerceDiscountModelImpl, false);
	...
	public void afterPropertiesSet() {
			...
			new HashMapDictionary() {
				{
					...
					put(
						"table.name",
						CommerceDiscountTable.INSTANCE.getTableName());
				}
			});
		...
		_finderPathFetchByC_C_A = _createFinderPath(
