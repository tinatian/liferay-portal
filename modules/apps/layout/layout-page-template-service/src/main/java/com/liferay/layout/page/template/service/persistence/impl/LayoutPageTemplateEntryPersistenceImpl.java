...
public class LayoutPageTemplateEntryPersistenceImpl
	...
	public LayoutPageTemplateEntry updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, LayoutPageTemplateEntryImpl.class,
			layoutPageTemplateEntry, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, LayoutPageTemplateEntryImpl.class,
		...
		_finderPathWithoutPaginationFindByLayoutPrototypeId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("LayoutPrototypeId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("LayoutPrototypeId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByLayoutPrototypeId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByPlid = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("Plid"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Plid"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByPlid,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByPlid,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_L = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_L"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_L"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByG_LPTEK = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_LPTEK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_LPTEK"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_LPTEK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_LPTEK,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_N = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_L_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_L_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_L_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_L_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_L_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_L_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_L_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_L_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_L_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_L_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByG_N_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_N_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_T_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_T_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_T_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_C_T = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_T"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_T"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_C_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_C_D = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_D"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_D"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C_D,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_C_D,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_T_D = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_T_D"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_T_D"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_T_D,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_T_D,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_T_D_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_T_D_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_T_D_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_T_D_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_T_D_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_C_T_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_T_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_T_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_C_T_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_C_C_D_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_D_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_C_C_D_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_C_C_D_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_C_C_D_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"Plid", LayoutPageTemplateEntryModelImpl.PLID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("LayoutPrototypeId")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Plid")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_L")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_LPTEK")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_L_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_L_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N_T")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_T_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_C_D")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_T_D")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_T_D_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_C_T_S")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateEntryModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_C_C_D_S")) != 0)) {
