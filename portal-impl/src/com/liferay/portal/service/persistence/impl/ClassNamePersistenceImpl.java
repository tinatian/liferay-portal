...
public class ClassNamePersistenceImpl
	...
	public void clearCache(ClassName className) {
		...
		EntityCacheUtil.removeResult(
			ClassNameModelImpl.ENTITY_CACHE_ENABLED, ClassNameImpl.class,
			className, ClassNameModelImpl.COLUMN_BITMASK_ENABLED);
	}
	...
	public ClassName updateImpl(ClassName className) {
		...
		EntityCacheUtil.putResult(
			ClassNameModelImpl.ENTITY_CACHE_ENABLED, ClassNameImpl.class,
			className, false, ClassNameModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByValue = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Value"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Value"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByValue,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByValue,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
