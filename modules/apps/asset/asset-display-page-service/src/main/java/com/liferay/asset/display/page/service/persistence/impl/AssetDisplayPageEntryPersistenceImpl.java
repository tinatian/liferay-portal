...
public class AssetDisplayPageEntryPersistenceImpl
	...
	public void clearCache(AssetDisplayPageEntry assetDisplayPageEntry) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AssetDisplayPageEntryImpl.class,
			assetDisplayPageEntry, _columnBitmaskEnabled);
	}
	...
	public AssetDisplayPageEntry updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, AssetDisplayPageEntryImpl.class,
			assetDisplayPageEntry, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AssetDisplayPageEntryImpl.class,
		...
		_finderPathWithoutPaginationFindByLayoutPageTemplateEntryId =
			new FinderPath(
				...
				"findByLayoutPageTemplateEntryId",
				new String[] {Long.class.getName()},
				_ARGUMENTS_BIFUNCTION_MAP.get("LayoutPageTemplateEntryId"),
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByLayoutPageTemplateEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_C_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", AssetDisplayPageEntryModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", AssetDisplayPageEntryModelImpl.GROUPID_COLUMN_BITMASK);
