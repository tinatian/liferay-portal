...
public class SyncDevicePersistenceImpl
	...
	public SyncDevice updateImpl(SyncDevice syncDevice) {
		...
		entityCache.putResult(
			entityCacheEnabled, SyncDeviceImpl.class, syncDeviceModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationCountByC_U = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_U", "countByC_U",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SyncDeviceImpl.class;
