...
public class LayoutSEOSitePersistenceImpl
	...
	public void clearCache(LayoutSEOSite layoutSEOSite) {
		...
		entityCache.removeResult(
			entityCacheEnabled, LayoutSEOSiteImpl.class, layoutSEOSite,
	...
	public LayoutSEOSite updateImpl(LayoutSEOSite layoutSEOSite) {
		...
		entityCache.putResult(
			entityCacheEnabled, LayoutSEOSiteImpl.class, layoutSEOSite, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, LayoutSEOSiteImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", LayoutSEOSiteModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", LayoutSEOSiteModelImpl.GROUPID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutSEOSiteModelImpl.getColumnBitmask() &
