...
public class SamlIdpSpSessionPersistenceImpl
	...
	public SamlIdpSpSession updateImpl(SamlIdpSpSession samlIdpSpSession) {
		...
		entityCache.putResult(
			entityCacheEnabled, SamlIdpSpSessionImpl.class,
			samlIdpSpSessionModelImpl, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindBySamlIdpSsoSessionId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "SamlIdpSsoSessionId",
			"findBySamlIdpSsoSessionId",
			new String[] {
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SamlIdpSpSessionImpl.class;
