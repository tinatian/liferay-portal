...
public class MBThreadFlagPersistenceImpl
	...
	public MBThreadFlag updateImpl(MBThreadFlag mbThreadFlag) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBThreadFlagImpl.class, mbThreadFlagModelImpl,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByU_T = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "U_T", "fetchByU_T",
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = MBThreadFlagImpl.class;
