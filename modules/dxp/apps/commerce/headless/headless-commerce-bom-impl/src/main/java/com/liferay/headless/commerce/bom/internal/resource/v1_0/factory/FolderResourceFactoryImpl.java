 ...
 * @generated
 */
@Component(enabled = false, immediate = true, service = FolderResource.Factory.class)
@Generated("")
public class FolderResourceFactoryImpl implements FolderResource.Factory {
	...
	public FolderResource.Builder create() {
		return new FolderResource.Builder() {
			...
			@Override
			public FolderResource.Builder httpServletRequest(
			...
			@Override
			public FolderResource.Builder preferredLocale(
	...
	private Object _invoke(
		...
		folderResource.setContextAcceptLanguage(
		...
		folderResource.setContextHttpServletRequest(httpServletRequest);
