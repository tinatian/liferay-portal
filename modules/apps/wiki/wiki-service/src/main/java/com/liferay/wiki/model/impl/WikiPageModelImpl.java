...
public class WikiPageModelImpl
	...
	public void setMvccVersion(long mvccVersion) {
		...
		if (!isNew() && (_wikiPageCacheModel == null)) {
	...
	public long getOriginalNodeId() {
		return getCacheModelAttribute("nodeId");
	}
	...
	public String getOriginalFormat() {
		return getCacheModelAttribute("format");
	}
	...
	public String getOriginalParentTitle() {
		return getCacheModelAttribute("parentTitle");
	}
	...
	public String getOriginalRedirectTitle() {
		return getCacheModelAttribute("redirectTitle");
	}
