...
public abstract class FolderLocalServiceBaseImpl
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return folderPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FolderLocalServiceImpl#deleteFolder(Folder) to avoid orphaned data");
		}
	...
	public void loadFinderCache(FinderPath[] finderPaths) {
		folderPersistence.loadFinderCache(finderPaths);
	}
