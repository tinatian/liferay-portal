...
public class DDLRecordSetPersistenceImpl
	...
	public void cacheResult(DDLRecordSet ddlRecordSet) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_R"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_R"), args,
			ddlRecordSetModelImpl, false);
	}
	...
	public DDLRecordSet updateImpl(DDLRecordSet ddlRecordSet) {
		...
		entityCache.putResult(
			entityCacheEnabled, DDLRecordSetImpl.class,
			ddlRecordSetModelImpl.getPrimaryKey(), ddlRecordSetModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, ddlRecordSetModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_R");
