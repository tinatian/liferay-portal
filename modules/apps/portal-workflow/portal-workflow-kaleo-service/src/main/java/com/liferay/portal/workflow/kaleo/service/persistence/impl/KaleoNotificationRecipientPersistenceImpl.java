...
public class KaleoNotificationRecipientPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, KaleoNotificationRecipientImpl.class,
		...
		_finderPathWithoutPaginationFindByKaleoNotificationId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("KaleoNotificationId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("KaleoNotificationId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByKaleoNotificationId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((kaleoNotificationRecipientModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("KaleoNotificationId")) !=
						  0)) {
