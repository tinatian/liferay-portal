...
public class MDRRuleServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(MDRRuleServiceUtil.class);

		_serviceTracker = new ServiceTracker<MDRRuleService, MDRRuleService>(bundle.getBundleContext(),
