...
public class WorkflowMetricsSLADefinitionPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByWMSLAD_A = _createFinderPath(
			WorkflowMetricsSLADefinitionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByWMSLAD_A",
			new String[] {"workflowMetricsSLADefinitionId", "active"});
		...
		_finderPathWithPaginationFindByC_A_P = _createFinderPath(
			...
			new String[] {"companyId", "active", "processId"});
		...
		_finderPathWithPaginationFindByC_A_P_S = _createFinderPath(
			...
			new String[] {"companyId", "active", "processId", "status"});
	...
	private static class WorkflowMetricsSLADefinitionModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					workflowMetricsSLADefinitionModelImpl, attributeNames,
					original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						workflowMetricsSLADefinitionModelImpl.getAttributeValue(
							attributeName);
				}
			}
