...
import com.liferay.portlet.display.template.exportimport.portlet.preferences.processor.PortletDisplayTemplateExportRegister;
...
public class PortletDisplayTemplateExportServiceTracker {
	...
	public void activate(BundleContext bundleContext) {
		_serviceTracker = new ServiceTracker
			<PortletDisplayTemplateExportRegister,
				...
				bundleContext, PortletDisplayTemplateExportRegister.class,
				new ServiceTrackerCustomizer
					<PortletDisplayTemplateExportRegister,
						ServiceRegistration<Capability>>() {
					@Override
					public ServiceRegistration<Capability> addingService(
						ServiceReference<PortletDisplayTemplateExportRegister>
						serviceReference) {
	...
	private ServiceTracker<PortletDisplayTemplateExportRegister,
