...
public class UserGroupGroupRolePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathCountByUserGroupId = _createFinderPath(
			...
			"countByUserGroupId", new String[] {"userGroupId"});
		...
		_finderPathWithPaginationFindByU_G = _createFinderPath(
			...
			new String[] {"userGroupId", "groupId"});
		...
		_finderPathFetchByU_G_R = _createFinderPath(
			...
			"fetchByU_G_R", new String[] {"userGroupId", "groupId", "roleId"});

		_finderPathCountByU_G_R = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByU_G_R", new String[] {"userGroupId", "groupId", "roleId"});
	}
	...
	private static class UserGroupGroupRoleModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					userGroupGroupRoleModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					userGroupGroupRoleModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						userGroupGroupRoleModelImpl.getAttributeValue(
							attributeName);
				}
			}
