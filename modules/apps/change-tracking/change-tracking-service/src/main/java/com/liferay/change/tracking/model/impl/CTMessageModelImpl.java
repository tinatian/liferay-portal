...
public class CTMessageModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table CTMessage (mvccVersion LONG default 0 not null,ctMessageId LONG not null primary key,companyId LONG,userId LONG,ctCollectionId LONG,messageContent TEXT null)";
	...
	static {
		...
		attributeGetterFunctions.put("userId", CTMessage::getUserId);
		attributeSetterBiConsumers.put(
			"userId", (BiConsumer<CTMessage, Long>)CTMessage::setUserId);
	...
	public Object clone() {
		...
		ctMessageImpl.setUserId(getUserId());
	...
	public CacheModel<CTMessage> toCacheModel() {
		...
		ctMessageCacheModel.userId = getUserId();
