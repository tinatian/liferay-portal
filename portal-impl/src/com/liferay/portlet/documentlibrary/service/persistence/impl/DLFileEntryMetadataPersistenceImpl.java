...
public class DLFileEntryMetadataPersistenceImpl
	...
	public DLFileEntryMetadata updateImpl(
		...
		DLFileEntryMetadata originalDLFileEntryMetadata = dlFileEntryMetadata;
		...
		EntityCacheUtil.putResult(
			DLFileEntryMetadataImpl.class, originalDLFileEntryMetadata, false,
			true);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByD_F = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "D_F", "fetchByD_F",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathCountByD_F = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "D_F", "countByD_F",
			new String[] {Long.class.getName(), Long.class.getName()});
	}
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = DLFileEntryMetadataImpl.class;
