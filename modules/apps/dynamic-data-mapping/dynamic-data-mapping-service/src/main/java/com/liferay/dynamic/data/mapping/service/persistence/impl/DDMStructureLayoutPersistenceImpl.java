...
public class DDMStructureLayoutPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			DDMStructureLayoutImpl.class, DDMStructureLayoutImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMStructureLayoutImpl.class, Long.class,
		...
		_finderPathCountByStructureLayoutKey = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMStructureLayoutImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByStructureLayoutKey", new String[] {String.class.getName()});

		_finderPathFetchByStructureVersionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMStructureLayoutImpl.class, DDMStructureLayoutImpl.class,
		...
		_finderPathCountByStructureVersionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMStructureLayoutImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathWithPaginationFindByG_C_SV = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMStructureLayoutImpl.class, DDMStructureLayoutImpl.class,
		...
		_finderPathWithoutPaginationFindByG_C_SV = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMStructureLayoutImpl.class, DDMStructureLayoutImpl.class,
		...
		_finderPathCountByG_C_SV = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMStructureLayoutImpl.class, Long.class,
