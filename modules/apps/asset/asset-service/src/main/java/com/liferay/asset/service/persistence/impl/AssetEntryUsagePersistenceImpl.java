...
public class AssetEntryUsagePersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByAssetEntryId = _createFinderPath(
			AssetEntryUsageImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByAssetEntryId", new String[] {"assetEntryId"});
		...
		_finderPathCountByAssetEntryId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByAssetEntryId", new String[] {"assetEntryId"});
		...
		_finderPathWithPaginationFindByC_C_P = _createFinderPath(
			AssetEntryUsageImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_C_P",
			new String[] {"containerType", "containerKey", "plid"});
	...
	private static class AssetEntryUsageModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					assetEntryUsageModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					assetEntryUsageModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						assetEntryUsageModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] = assetEntryUsageModelImpl.getAttributeValue(
						attributeName);
				}
			}
