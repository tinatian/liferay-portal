...
public class BackgroundTaskPersistenceImpl
	...
	public void clearCache(BackgroundTask backgroundTask) {
		...
		entityCache.removeResult(
			entityCacheEnabled, BackgroundTaskImpl.class, backgroundTask,
	...
	public BackgroundTask updateImpl(BackgroundTask backgroundTask) {
		...
		entityCache.putResult(
			entityCacheEnabled, BackgroundTaskImpl.class, backgroundTask, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, BackgroundTaskImpl.class,
		...
		_finderPathWithoutPaginationFindByCompleted = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("Completed"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("Completed"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByCompleted,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByCompleted,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N_T,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_T_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_T_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_T_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_T_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_T_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByG_N_T_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_T_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_T_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_N_T_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_N_T_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((backgroundTaskModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("GroupId")) != 0)) {

					return new Object[] {backgroundTaskModelImpl.getGroupId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						backgroundTaskModelImpl.getCompanyId()
					};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((backgroundTaskModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Completed")) != 0)) {

					return new Object[] {backgroundTaskModelImpl.isCompleted()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {backgroundTaskModelImpl.getStatus()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((backgroundTaskModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_T_C")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((backgroundTaskModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_N_T_C")) != 0)) {
