...
public class SamlIdpSsoSessionModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (samlIdpSsoSessionCacheModel == null) {
			samlIdpSsoSessionCacheModel = _dummySamlIdpSsoSessionCacheModel;
		}

		return (T)function.apply(samlIdpSsoSessionCacheModel);
	}

	private SamlIdpSsoSessionCacheModel _toSamlIdpSsoSessionCacheModel() {
		SamlIdpSsoSessionCacheModel samlIdpSsoSessionCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			samlIdpSsoSessionCacheModel -> {
				Long createDate = samlIdpSsoSessionCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			samlIdpSsoSessionCacheModel -> {
				Long modifiedDate = samlIdpSsoSessionCacheModel.modifiedDate;
