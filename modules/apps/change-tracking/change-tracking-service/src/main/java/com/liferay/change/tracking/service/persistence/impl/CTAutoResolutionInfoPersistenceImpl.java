...
public class CTAutoResolutionInfoPersistenceImpl
	...
	public CTAutoResolutionInfo updateImpl(
		...
		CTAutoResolutionInfo originalCTAutoResolutionInfo =
			ctAutoResolutionInfo;
		...
		entityCache.putResult(
			CTAutoResolutionInfoImpl.class, originalCTAutoResolutionInfo, false,
			true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByC_MCNI_SMCPK = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_MCNI_SMCPK",
			"findByC_MCNI_SMCPK",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_MCNI_SMCPK = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_MCNI_SMCPK",
			"findByC_MCNI_SMCPK",
			new String[] {
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = CTAutoResolutionInfoImpl.class;
