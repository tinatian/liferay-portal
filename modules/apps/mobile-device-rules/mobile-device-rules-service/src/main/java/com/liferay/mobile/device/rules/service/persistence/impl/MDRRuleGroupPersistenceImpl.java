	...
	private static class MDRRuleGroupModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					mdrRuleGroupModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					mdrRuleGroupModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						mdrRuleGroupModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] = mdrRuleGroupModelImpl.getAttributeValue(
						attributeName);
				}
			}
