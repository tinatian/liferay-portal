...
public class MBMailingListPersistenceImpl
	...
	public void clearCache(MBMailingList mbMailingList) {
		...
		entityCache.removeResult(
			entityCacheEnabled, MBMailingListImpl.class, mbMailingList,
	...
	public MBMailingList updateImpl(MBMailingList mbMailingList) {
		...
		entityCache.putResult(
			entityCacheEnabled, MBMailingListImpl.class, mbMailingList, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, MBMailingListImpl.class,
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", MBMailingListModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"Active", MBMailingListModelImpl.ACTIVE_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mbMailingListModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("Uuid")) != 0)) {

					return new Object[] {mbMailingListModelImpl.getUuid()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {mbMailingListModelImpl.isActive()};
				}
