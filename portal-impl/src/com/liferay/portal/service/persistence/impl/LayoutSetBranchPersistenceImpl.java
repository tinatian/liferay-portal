	...
	private static class LayoutSetBranchModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					layoutSetBranchModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					layoutSetBranchModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						layoutSetBranchModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] = layoutSetBranchModelImpl.getAttributeValue(
						attributeName);
				}
			}
