...
public class KBFolderModelImpl
	...
	public void setParentKBFolderId(long parentKBFolderId) {
		if (_originalValues[PARENTKBFOLDERID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[PARENTKBFOLDERID_COLUMN_INDEX] = _parentKBFolderId;
		}
	...
	public long getOriginalParentKBFolderId() {
		Object originalValue = _originalValues[PARENTKBFOLDERID_COLUMN_INDEX];

		if (originalValue == INITIAL_MARKER) {
			originalValue = _parentKBFolderId;
		}
	...
	public void resetOriginalValues() {
		...
		kbFolderModelImpl._columnBitmask = null;
	}
