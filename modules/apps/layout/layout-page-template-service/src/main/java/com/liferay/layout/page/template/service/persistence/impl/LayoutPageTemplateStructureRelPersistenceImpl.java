...
public class LayoutPageTemplateStructureRelPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, LayoutPageTemplateStructureRelImpl.class,
		...
		_finderPathWithoutPaginationFindByLayoutPageTemplateStructureId =
			new FinderPath(
				...
				_ARGUMENTS_BIFUNCTION_MAP.get("LayoutPageTemplateStructureId"),
		...
		_finderPathWithoutPaginationFindBySegmentsExperienceId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("SegmentsExperienceId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("SegmentsExperienceId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountBySegmentsExperienceId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByL_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
				...
				if (!checkColumns ||
					((layoutPageTemplateStructureRelModelImpl.
					  ...
					  _FINDER_PATH_BITMASK_MAP.get(
						  "LayoutPageTemplateStructureId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((layoutPageTemplateStructureRelModelImpl.
						getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("SegmentsExperienceId")) !=
						  0)) {
