...
public class TicketPersistenceImpl
	...
	public void clearCache(Ticket ticket) {
		EntityCacheUtil.removeResult(TicketImpl.class, ticket.getPrimaryKey());
	...
	protected void clearUniqueFindersCache(
		...
		if ((ticketModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				ticketModelImpl.getCacheModelAttribute("key")
			};
	...
	public Ticket updateImpl(Ticket ticket) {
		...
		if (isNew) {
			...
			if ((ticketModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ticketModelImpl.getCacheModelAttribute("classNameId"),
					ticketModelImpl.getCacheModelAttribute("classPK"),
					ticketModelImpl.getCacheModelAttribute("type")
				};
			...
			if ((ticketModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ticketModelImpl.getCacheModelAttribute("companyId"),
					ticketModelImpl.getCacheModelAttribute("classNameId"),
					ticketModelImpl.getCacheModelAttribute("classPK"),
					ticketModelImpl.getCacheModelAttribute("type")
				};
