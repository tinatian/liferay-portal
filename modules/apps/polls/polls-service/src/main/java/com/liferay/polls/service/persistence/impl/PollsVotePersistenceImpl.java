...
public class PollsVotePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathFetchByUUID_G = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
		...
		_finderPathWithPaginationFindByQuestionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByQuestionId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByQuestionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByQuestionId", new String[] {Long.class.getName()},
			PollsVoteModelImpl.QUESTIONID_COLUMN_BITMASK);

		_finderPathCountByQuestionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByQuestionId", new String[] {Long.class.getName()});

		_finderPathWithPaginationFindByChoiceId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByChoiceId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByChoiceId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByChoiceId", new String[] {Long.class.getName()},
			PollsVoteModelImpl.CHOICEID_COLUMN_BITMASK);

		_finderPathCountByChoiceId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByChoiceId", new String[] {Long.class.getName()});

		_finderPathWithPaginationFindByQ_U = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByQ_U",
			new String[] {
		...
		_finderPathWithoutPaginationFindByQ_U = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			PollsVoteImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByQ_U",
		...
		_finderPathCountByQ_U = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, PollsVoteImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByQ_U",
			new String[] {Long.class.getName(), Long.class.getName()});
	}
