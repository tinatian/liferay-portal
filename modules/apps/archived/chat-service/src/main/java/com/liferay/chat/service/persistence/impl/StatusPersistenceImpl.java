...
public class StatusPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((statusModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				statusModelImpl.getOriginalAttributeValue("userId")
			};
	...
	public Status updateImpl(Status status) {
		...
		if (isNew) {
			...
			if ((statusModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					statusModelImpl.getOriginalAttributeValue("modifiedDate")
				};
			...
			if ((statusModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					statusModelImpl.getOriginalAttributeValue("online")
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByOnline = new FinderPath(
			...
			StatusModelImpl.getColumnBitmask("online"));
