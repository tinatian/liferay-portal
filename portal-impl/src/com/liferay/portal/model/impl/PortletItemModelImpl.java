...
public class PortletItemModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		PortletItemCacheModel portletItemCacheModel = _portletItemCacheModel;

		if (portletItemCacheModel == null) {
			portletItemCacheModel = _dummyPortletItemCacheModel;
		}

		return (T)function.apply(portletItemCacheModel);
	}

	private PortletItemCacheModel _toPortletItemCacheModel() {
		PortletItemCacheModel portletItemCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			portletItemCacheModel -> {
				Long createDate = portletItemCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			portletItemCacheModel -> {
				Long modifiedDate = portletItemCacheModel.modifiedDate;
