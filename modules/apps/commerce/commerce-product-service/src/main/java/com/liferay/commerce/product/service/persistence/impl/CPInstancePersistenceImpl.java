...
public class CPInstancePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByG_ST", _finderPathCountByG_ST
			).put(
				...
				"finderPathCountByC_SKU", _finderPathCountByC_SKU
			).put(
				...
				"finderPathCountByC_ST", _finderPathCountByC_ST
			).put(
	...
	public void destroy() {
		...
		FinderPath.unregisterFinderPaths(CPInstance.class);
	}
