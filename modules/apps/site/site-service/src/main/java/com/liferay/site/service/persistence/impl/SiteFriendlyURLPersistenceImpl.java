...
public class SiteFriendlyURLPersistenceImpl
	...
	public void clearCache(SiteFriendlyURL siteFriendlyURL) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SiteFriendlyURLImpl.class, siteFriendlyURL,
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SiteFriendlyURLImpl.class,
		...
		_finderPathWithoutPaginationFindByC_G = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_G"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_G"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_G,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_G,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByC_G_L = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_G_L"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_G_L"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_G_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_G_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByC_F_L = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_F_L"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_F_L"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_F_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_F_L,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", SiteFriendlyURLModelImpl.UUID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((siteFriendlyURLModelImpl.getColumnBitmask() &
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((siteFriendlyURLModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_G")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((siteFriendlyURLModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_G_L")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((siteFriendlyURLModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_F_L")) != 0)) {
