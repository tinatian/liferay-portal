...
public class ChangesetCollectionPersistenceImpl
	...
	public ChangesetCollection updateImpl(
		...
		ChangesetCollection originalChangesetCollection = changesetCollection;
		...
		entityCache.putResult(
			ChangesetCollectionImpl.class, originalChangesetCollection, false,
			true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithoutPaginationFindByC_N = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_N", "findByC_N",
			new String[] {Long.class.getName(), String.class.getName()});
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = ChangesetCollectionImpl.class;
