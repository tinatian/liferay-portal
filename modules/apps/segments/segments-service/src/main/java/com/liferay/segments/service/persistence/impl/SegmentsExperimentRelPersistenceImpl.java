...
public class SegmentsExperimentRelPersistenceImpl
	...
	public void clearCache(SegmentsExperimentRel segmentsExperimentRel) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SegmentsExperimentRelImpl.class,
			segmentsExperimentRel, _columnBitmaskEnabled);
	}
	...
	public SegmentsExperimentRel updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, SegmentsExperimentRelImpl.class,
			segmentsExperimentRel, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SegmentsExperimentRelImpl.class,
		...
		_finderPathWithoutPaginationFindBySegmentsExperimentId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("SegmentsExperimentId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("SegmentsExperimentId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountBySegmentsExperimentId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByS_S,
				MapUtil.singletonDictionary(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((segmentsExperimentRelModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("SegmentsExperimentId")) !=
						  0)) {
