...
public class AccountGroupPersistenceImpl
	...
	public void clearCache(AccountGroup accountGroup) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AccountGroupImpl.class, accountGroup,
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByC_ERC, args, accountGroupModelImpl, false);
	}
	...
	public AccountGroup updateImpl(AccountGroup accountGroup) {
		...
		entityCache.putResult(
			entityCacheEnabled, AccountGroupImpl.class, accountGroup, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AccountGroupImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", AccountGroupModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((accountGroupModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("CompanyId")) != 0)) {

					return new Object[] {accountGroupModelImpl.getCompanyId()};
				}
