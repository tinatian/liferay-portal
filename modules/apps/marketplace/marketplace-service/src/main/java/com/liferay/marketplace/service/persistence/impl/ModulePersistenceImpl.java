...
public class ModulePersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByAppId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			ModuleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByAppId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByAppId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			ModuleImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByAppId", new String[] {Long.class.getName()},
			ModuleModelImpl.APPID_COLUMN_BITMASK);

		_finderPathCountByAppId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByBundleSymbolicName = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByBundleSymbolicName", new String[] {String.class.getName()});

		_finderPathWithPaginationFindByContextName = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			ModuleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByContextName",
			new String[] {
		...
		_finderPathWithoutPaginationFindByContextName = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			ModuleImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByContextName", new String[] {String.class.getName()},
			ModuleModelImpl.CONTEXTNAME_COLUMN_BITMASK);

		_finderPathCountByContextName = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByContextName", new String[] {String.class.getName()});

		_finderPathFetchByA_CN = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
		...
		_finderPathCountByA_CN = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByA_CN",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathFetchByA_BSN_BV = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
		...
		_finderPathCountByA_BSN_BV = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, ModuleImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByA_BSN_BV",
			new String[] {
