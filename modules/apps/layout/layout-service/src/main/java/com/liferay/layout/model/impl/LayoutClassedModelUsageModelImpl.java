...
public class LayoutClassedModelUsageModelImpl
	...
	public void setLayoutClassedModelUsageId(long layoutClassedModelUsageId) {
		_columnBitmask |= _columnBitmasks.get("layoutClassedModelUsageId");
	...
	public void resetOriginalValues() {
		...
		_layoutClassedModelUsageCacheModel =
			_toLayoutClassedModelUsageCacheModel();
	}
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (layoutClassedModelUsageCacheModel == null) {
			layoutClassedModelUsageCacheModel =
				_dummyLayoutClassedModelUsageCacheModel;
		}

		return (T)function.apply(layoutClassedModelUsageCacheModel);
	}
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			layoutClassedModelUsageCacheModel -> {
				Long createDate = layoutClassedModelUsageCacheModel.createDate;
