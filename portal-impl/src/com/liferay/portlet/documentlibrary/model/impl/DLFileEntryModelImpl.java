...
public class DLFileEntryModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		DLFileEntryCacheModel dlFileEntryCacheModel = _dlFileEntryCacheModel;

		if (dlFileEntryCacheModel == null) {
			dlFileEntryCacheModel = _dummyDLFileEntryCacheModel;
		}

		return (T)function.apply(dlFileEntryCacheModel);
	}

	private DLFileEntryCacheModel _toDLFileEntryCacheModel() {
		DLFileEntryCacheModel dlFileEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			dlFileEntryCacheModel -> {
				Long createDate = dlFileEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			dlFileEntryCacheModel -> {
				Long modifiedDate = dlFileEntryCacheModel.modifiedDate;
		...
		columnBitmasks.put("size", 16777216L);
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			dlFileEntryCacheModel -> {
				Long lastPublishDate = dlFileEntryCacheModel.lastPublishDate;
