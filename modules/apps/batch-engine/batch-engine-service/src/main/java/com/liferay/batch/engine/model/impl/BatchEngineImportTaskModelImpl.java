...
public class BatchEngineImportTaskModelImpl
	...
	private BatchEngineImportTaskCacheModel
		_toBatchEngineImportTaskCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			batchEngineImportTaskCacheModel -> {
				Long createDate = batchEngineImportTaskCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"endTime",
			batchEngineImportTaskCacheModel -> {
				Long endTime = batchEngineImportTaskCacheModel.endTime;
		...
		cacheModelGetterFunctions.put(
			"startTime",
			batchEngineImportTaskCacheModel -> {
				Long startTime = batchEngineImportTaskCacheModel.startTime;
