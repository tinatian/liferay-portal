...
public class MembershipRequestPersistenceImpl
	...
	public MembershipRequest updateImpl(MembershipRequest membershipRequest) {
		...
		MembershipRequest originalMembershipRequest = membershipRequest;
		...
		EntityCacheUtil.putResult(
			MembershipRequestImpl.class, originalMembershipRequest, false,
			true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = MembershipRequestImpl.class;
