...
public class DynamicQueryEntryPersistenceImpl
	...
	/**
	 * Caches the dynamic query entry in the entity cache if it is enabled.
	 *
	 * @param dynamicQueryEntry the dynamic query entry
	 */
	@Override
	public void cacheResult(DynamicQueryEntry dynamicQueryEntry) {
		entityCache.putResult(
			DynamicQueryEntryImpl.class, dynamicQueryEntry.getPrimaryKey(),
			dynamicQueryEntry);
	}
	...
	/**
	 * Caches the dynamic query entries in the entity cache if it is enabled.
	 *
	 * @param dynamicQueryEntries the dynamic query entries
	 */
	@Override
	public void cacheResult(List<DynamicQueryEntry> dynamicQueryEntries) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (dynamicQueryEntries.size() >
				 _valueObjectFinderCacheListThreshold))) {

			return;
		}

		for (DynamicQueryEntry dynamicQueryEntry : dynamicQueryEntries) {
			if (entityCache.getResult(
					DynamicQueryEntryImpl.class,
					dynamicQueryEntry.getPrimaryKey()) == null) {

				cacheResult(dynamicQueryEntry);
			}
		}
	}
	...
	public DynamicQueryEntry updateImpl(DynamicQueryEntry dynamicQueryEntry) {
		...
		entityCache.putResult(
			DynamicQueryEntryImpl.class, dynamicQueryEntry, false, true);
	...
	private static final String _ENTITY_ALIAS_PREFIX =
		DynamicQueryEntryModelImpl.ENTITY_ALIAS + ".";
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DynamicQueryEntryPersistenceImpl.class);
...
// LIFERAY-SERVICE-BUILDER-HASH:-626354948