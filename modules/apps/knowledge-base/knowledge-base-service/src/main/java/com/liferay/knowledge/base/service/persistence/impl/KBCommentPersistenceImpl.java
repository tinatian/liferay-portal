...
public class KBCommentPersistenceImpl
	...
	public void clearCache(List<KBComment> kbComments) {
		for (KBComment kbComment : kbComments) {
			entityCache.removeResult(
				entityCacheEnabled, KBCommentImpl.class,
				kbComment.getPrimaryKey(), kbComment,
				new Object[] {
					_columnBitmaskEnabled,
					((KBCommentModelImpl)kbComment).getColumnBitmask()
				});
	...
	public KBComment updateImpl(KBComment kbComment) {
		...
		entityCache.putResult(
			entityCacheEnabled, KBCommentImpl.class,
			kbCommentModelImpl.getPrimaryKey(), kbCommentModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, kbCommentModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		Bundle bundle = FrameworkUtil.getBundle(KBCommentPersistenceImpl.class);
