...
public class ImageModelImpl extends BaseModelImpl<Image> implements ImageModel {
	...
	public int getOriginalSize() {
		return getOriginalAttributeValue("size");
	}
	...
	public void resetOriginalValues() {
		...
		_imageCacheModel = _toImageCacheModel();
	}

	@Override
	public CacheModel<Image> toCacheModel() {
		ImageCacheModel imageCacheModel = _toImageCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		ImageCacheModel imageCacheModel = _imageCacheModel;

		if (imageCacheModel == null) {
			imageCacheModel = _dummyImageCacheModel;
		}

		return (T)function.apply(imageCacheModel);
	}

	private ImageCacheModel _toImageCacheModel() {
	...
	private static final ImageCacheModel _dummyImageCacheModel =
		new ImageCacheModel();
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			imageCacheModel -> {
				Long modifiedDate = imageCacheModel.modifiedDate;
