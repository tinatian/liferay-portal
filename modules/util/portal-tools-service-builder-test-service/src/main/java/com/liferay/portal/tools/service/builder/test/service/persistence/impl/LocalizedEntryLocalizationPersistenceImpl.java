...
public class LocalizedEntryLocalizationPersistenceImpl
	...
	public LocalizedEntryLocalization updateImpl(
		...
		entityCache.putResult(
			LocalizedEntryLocalizationModelImpl.ENTITY_CACHE_ENABLED,
			LocalizedEntryLocalizationImpl.class, localizedEntryLocalization,
			false, LocalizedEntryLocalizationModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByLocalizedEntryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("LocalizedEntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("LocalizedEntryId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByLocalizedEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByLocalizedEntryId_LanguageId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("LocalizedEntryId_LanguageId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get(
				"LocalizedEntryId_LanguageId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByLocalizedEntryId_LanguageId,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByLocalizedEntryId_LanguageId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((localizedEntryLocalizationModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("LocalizedEntryId")) != 0)) {
