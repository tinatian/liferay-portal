...
public class PollsQuestionPersistenceImpl
	...
	public void cacheResult(PollsQuestion pollsQuestion) {
		entityCache.putResult(
			...
			new Object[] {
				...
				((PollsQuestionModelImpl)pollsQuestion).getColumnBitmask()
			});
	...
	public PollsQuestion updateImpl(PollsQuestion pollsQuestion) {
		...
		entityCache.putResult(
			entityCacheEnabled, PollsQuestionImpl.class,
			pollsQuestionModelImpl.getPrimaryKey(), pollsQuestionModelImpl,
			false,
			new Object[] {
				_columnBitmaskEnabled, pollsQuestionModelImpl.getColumnBitmask()
			});
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		...
		return _finderPathMap.computeIfAbsent(
			...
			key -> {
				Class<?> returnClass = PollsQuestionImpl.class;
