...
public class FragmentEntryLinkModelImpl
	...
	public static final int FRAGMENTENTRYLINKID_COLUMN_INDEX = 2;
	...
	public static final int ORIGINALFRAGMENTENTRYLINKID_COLUMN_INDEX = 9;

	public static final int FRAGMENTENTRYID_COLUMN_INDEX = 10;

	public static final int SEGMENTSEXPERIENCEID_COLUMN_INDEX = 11;

	public static final int CLASSNAMEID_COLUMN_INDEX = 12;

	public static final int CLASSPK_COLUMN_INDEX = 13;

	public static final int CSS_COLUMN_INDEX = 14;

	public static final int HTML_COLUMN_INDEX = 15;

	public static final int JS_COLUMN_INDEX = 16;

	public static final int CONFIGURATION_COLUMN_INDEX = 17;

	public static final int EDITABLEVALUES_COLUMN_INDEX = 18;

	public static final int NAMESPACE_COLUMN_INDEX = 19;

	public static final int POSITION_COLUMN_INDEX = 20;

	public static final int RENDERERKEY_COLUMN_INDEX = 21;

	public static final int LASTPROPAGATIONDATE_COLUMN_INDEX = 22;
	...
	public void setFragmentEntryId(long fragmentEntryId) {
		if (_originalValues[FRAGMENTENTRYID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[FRAGMENTENTRYID_COLUMN_INDEX] = _fragmentEntryId;
		}
	...
	public long getOriginalFragmentEntryId() {
		Object originalValue = _originalValues[FRAGMENTENTRYID_COLUMN_INDEX];

		if (originalValue == INITIAL_MARKER) {
			originalValue = _fragmentEntryId;
		}
	...
	public void setRendererKey(String rendererKey) {
		if (_originalValues[RENDERERKEY_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[RENDERERKEY_COLUMN_INDEX] = _rendererKey;
		}
	...
	public String getOriginalRendererKey() {
		Object originalValue = _originalValues[RENDERERKEY_COLUMN_INDEX];

		if (originalValue == INITIAL_MARKER) {
			originalValue = _rendererKey;
		}
	...
	public void resetOriginalValues() {
		...
		fragmentEntryLinkModelImpl._columnBitmask = null;
	}
