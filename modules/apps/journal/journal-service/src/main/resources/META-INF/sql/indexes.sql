...
create unique index IX_DC52A47C on JournalArticle (groupId, classNameId, ctCollectionId, DDMStructureId);
...
create unique index IX_8160B2E7 on JournalArticleLocalization (articlePK, ctCollectionId, companyId);
...
create unique index IX_BE4CE27C on JournalFolder (groupId, ctCollectionId, name[$COLUMN_LENGTH:100$]);
