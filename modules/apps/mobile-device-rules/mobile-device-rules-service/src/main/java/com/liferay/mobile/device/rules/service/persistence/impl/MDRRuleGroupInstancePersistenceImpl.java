...
public class MDRRuleGroupInstancePersistenceImpl
	...
	public void clearCache(MDRRuleGroupInstance mdrRuleGroupInstance) {
		...
		entityCache.removeResult(
			entityCacheEnabled, MDRRuleGroupInstanceImpl.class,
			mdrRuleGroupInstance, _columnBitmaskEnabled);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, MDRRuleGroupInstanceImpl.class, primaryKey);
		}
	}
	...
	public MDRRuleGroupInstance updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, MDRRuleGroupInstanceImpl.class,
			mdrRuleGroupInstance, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		MDRRuleGroupInstanceModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		MDRRuleGroupInstanceModelImpl.setFinderCacheEnabled(finderCacheEnabled);

		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, MDRRuleGroupInstanceImpl.class,
		...
		_finderPathWithoutPaginationFindByRuleGroupId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("RuleGroupId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("RuleGroupId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByRuleGroupId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByRuleGroupId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByC_C_R = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_C_R"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_C_R"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_C_R,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_C_R,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", MDRRuleGroupInstanceModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", MDRRuleGroupInstanceModelImpl.GROUPID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mdrRuleGroupInstanceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("RuleGroupId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((mdrRuleGroupInstanceModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_C_R")) != 0)) {
