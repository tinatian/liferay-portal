...
public class KaleoConditionModelImpl
	...
	private KaleoConditionCacheModel _toKaleoConditionCacheModel() {
		KaleoConditionCacheModel kaleoConditionCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			kaleoConditionCacheModel -> {
				Long createDate = kaleoConditionCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			kaleoConditionCacheModel -> {
				Long modifiedDate = kaleoConditionCacheModel.modifiedDate;
