...
public class FolderPersistenceImpl
	...
	public void cacheResult(Folder folder) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_F"),
	...
	protected void cacheUniqueFindersCache(FolderModelImpl folderModelImpl) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_F"), args,
			folderModelImpl, false);
	}
	...
	public Folder updateImpl(Folder folder) {
		...
		entityCache.putResult(
			entityCacheEnabled, FolderImpl.class,
			folderModelImpl.getPrimaryKey(), folderModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, folderModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		Bundle bundle = FrameworkUtil.getBundle(FolderPersistenceImpl.class);
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByA_F");
		...
		_COLUMN_BITMASK_ARRAY_MAP.put(
			...
			new Object[] {
				...
				(Function<BaseModel<?>, Object[]>)baseModel -> {
					FolderModelImpl folderModelImpl =
						(FolderModelImpl)baseModel;
