...
public class CommercePriceListChannelRelPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathFetchByCCI_CPI", _finderPathFetchByCCI_CPI
			).put(
				"finderPathCountByCCI_CPI", _finderPathCountByCCI_CPI
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(CommercePriceListChannelRel.class);
	}
