...
public class AccountEntryUserRelPersistenceImpl
	...
	public AccountEntryUserRel updateImpl(
		...
		AccountEntryUserRel originalAccountEntryUserRel = accountEntryUserRel;
		...
		entityCache.putResult(
			AccountEntryUserRelImpl.class, originalAccountEntryUserRel, false,
			true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByAEI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "AEI", "findByAEI",
			new String[] {
		...
		_finderPathWithoutPaginationFindByAEI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "AEI", "findByAEI",
			new String[] {Long.class.getName()});

		_finderPathCountByAEI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "AEI", "countByAEI",
			new String[] {Long.class.getName()});

		_finderPathWithPaginationFindByAUI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "AUI", "findByAUI",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			});
		...
		_finderPathWithoutPaginationFindByAUI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "AUI", "findByAUI",
			new String[] {Long.class.getName()});

		_finderPathCountByAUI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "AUI", "countByAUI",
			new String[] {Long.class.getName()});

		_finderPathFetchByAEI_AUI = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "AEI_AUI", "fetchByAEI_AUI",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathCountByAEI_AUI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "AEI_AUI",
			"countByAEI_AUI",
			new String[] {Long.class.getName(), Long.class.getName()});
	}
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = AccountEntryUserRelImpl.class;
