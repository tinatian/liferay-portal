...
public class FriendlyURLEntryModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (friendlyURLEntryCacheModel == null) {
			friendlyURLEntryCacheModel = _dummyFriendlyURLEntryCacheModel;
		}

		return (T)function.apply(friendlyURLEntryCacheModel);
	}

	private FriendlyURLEntryCacheModel _toFriendlyURLEntryCacheModel() {
		FriendlyURLEntryCacheModel friendlyURLEntryCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			friendlyURLEntryCacheModel -> {
				Long createDate = friendlyURLEntryCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			friendlyURLEntryCacheModel -> {
				Long modifiedDate = friendlyURLEntryCacheModel.modifiedDate;
