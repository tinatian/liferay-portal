...
public class DDMFormInstanceVersionPersistenceImpl
	...
	public DDMFormInstanceVersion updateImpl(
		...
		DDMFormInstanceVersion originalDDMFormInstanceVersion =
			ddmFormInstanceVersion;
		...
		entityCache.putResult(
			DDMFormInstanceVersionImpl.class, originalDDMFormInstanceVersion,
			false, true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = DDMFormInstanceVersionImpl.class;
