...
public class SPIClassPathContextListenerTest {
	...
	public void setUp() throws Exception {
		...
		props.put(PropsKeys.JDBC_DEFAULT_DRIVER_CLASS_NAME, driverClassName);
		props.put(PropsKeys.INTRABAND_IMPL, StringPool.BLANK);
		props.put(PropsKeys.INTRABAND_TIMEOUT_DEFAULT, StringPool.BLANK);
		props.put(PropsKeys.INTRABAND_WELDER_IMPL, StringPool.BLANK);
