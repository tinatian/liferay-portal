...
public class WikiPageModelImpl
	...
	public void resetOriginalValues() {
		...
		_wikiPageCacheModel = _toWikiPageCacheModel();
	}

	@Override
	public CacheModel<WikiPage> toCacheModel() {
		WikiPageCacheModel wikiPageCacheModel = _toWikiPageCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		WikiPageCacheModel wikiPageCacheModel = _wikiPageCacheModel;

		if (wikiPageCacheModel == null) {
			wikiPageCacheModel = _dummyWikiPageCacheModel;
		}

		return (T)function.apply(wikiPageCacheModel);
	}

	private WikiPageCacheModel _toWikiPageCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			wikiPageCacheModel -> {
				Long createDate = wikiPageCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			wikiPageCacheModel -> {
				Long modifiedDate = wikiPageCacheModel.modifiedDate;
		...
		cacheModelGetterFunctions.put(
			"lastPublishDate",
			wikiPageCacheModel -> {
				Long lastPublishDate = wikiPageCacheModel.lastPublishDate;
		...
		cacheModelGetterFunctions.put(
			"statusDate",
			wikiPageCacheModel -> {
				Long statusDate = wikiPageCacheModel.statusDate;
