...
public class UserGroupRolePersistenceImpl
	...
	public void cacheResult(UserGroupRole userGroupRole) {
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU_G_R"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		FinderCacheUtil.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU_G_R"), args,
			userGroupRoleModelImpl, false);
	}
	...
	public UserGroupRole updateImpl(UserGroupRole userGroupRole) {
		...
		EntityCacheUtil.putResult(
			UserGroupRoleModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupRoleImpl.class, userGroupRoleModelImpl.getPrimaryKey(),
			userGroupRoleModelImpl, false,
			new Object[] {
				UserGroupRoleModelImpl.COLUMN_BITMASK_ENABLED,
	...
	public void afterPropertiesSet() {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByU_G_R");
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!UserGroupRoleModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		Class<?> returnClass = UserGroupRoleImpl.class;
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				UserGroupRoleModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
