...
public class SocialActivityAchievementPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_F = _createFinderPath(
			...
			new String[] {"groupId", "firstInGroup"});
		...
		_finderPathCountByG_U_F = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByG_U_F", new String[] {"groupId", "userId", "firstInGroup"});
	}
	...
	private static class SocialActivityAchievementModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					socialActivityAchievementModelImpl, attributeNames,
					original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						socialActivityAchievementModelImpl.getAttributeValue(
							attributeName);
				}
			}
