...
public class LazyBlobEntityPersistenceImpl
	...
	public void clearCache(LazyBlobEntity lazyBlobEntity) {
		...
		entityCache.removeResult(
			LazyBlobEntityModelImpl.ENTITY_CACHE_ENABLED,
			LazyBlobEntityImpl.class, lazyBlobEntity,
	...
	public LazyBlobEntity updateImpl(LazyBlobEntity lazyBlobEntity) {
		...
		entityCache.putResult(
			LazyBlobEntityModelImpl.ENTITY_CACHE_ENABLED,
			LazyBlobEntityImpl.class, lazyBlobEntityModelImpl, false,
			LazyBlobEntityModelImpl.COLUMN_BITMASK_ENABLED);
	...
	private FinderPath _createFinderPath(
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				LazyBlobEntityModelImpl.FINDER_CACHE_ENABLED, returnClass,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", LazyBlobEntityModelImpl.UUID_COLUMN_BITMASK);
