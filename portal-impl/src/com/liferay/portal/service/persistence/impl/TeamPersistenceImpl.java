...
public class TeamPersistenceImpl
	...
	public Team updateImpl(Team team) {
		...
		EntityCacheUtil.putResult(
			TeamModelImpl.ENTITY_CACHE_ENABLED, TeamImpl.class, teamModelImpl,
			false, TeamModelImpl.COLUMN_BITMASK_ENABLED);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = TeamImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				TeamModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
				methodName, params);
		}
