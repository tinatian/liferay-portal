...
public class CTSContentPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, CTSContentImpl.class,
		...
		_finderPathWithoutPaginationFindByC_R_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_R_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_R_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_R_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_R_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByC_R_P_S = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_R_P_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_R_P_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByC_R_P_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_R_P_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByC_R_P_V_S = new FinderPath(
			finderCacheEnabled, CTSContentImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_R_P_V_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName(),
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_R_P_V_S"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_R_P_V_S"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_R_P_V_S,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_R_P_V_S,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
