...
public class SAPEntryPersistenceImpl
	...
	public SAPEntry updateImpl(SAPEntry sapEntry) {
		...
		entityCache.putResult(
			entityCacheEnabled, SAPEntryImpl.class,
			sapEntryModelImpl.getPrimaryKey(), sapEntryModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, sapEntryModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		Bundle bundle = FrameworkUtil.getBundle(SAPEntryPersistenceImpl.class);
