...
public class SiteFriendlyURLPersistenceImpl
	...
	public SiteFriendlyURL updateImpl(SiteFriendlyURL siteFriendlyURL) {
		...
		SiteFriendlyURL originalSiteFriendlyURL = siteFriendlyURL;
		...
		entityCache.putResult(
			SiteFriendlyURLImpl.class, originalSiteFriendlyURL, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByC_G = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "C_G", "findByC_G",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_G = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_G", "findByC_G",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathCountByC_G = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_G", "countByC_G",
			new String[] {Long.class.getName(), Long.class.getName()});
		...
		_finderPathFetchByC_G_L = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_G_L", "fetchByC_G_L",
			new String[] {
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByC_G_L = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_G_L", "countByC_G_L",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
		...
		_finderPathFetchByC_F_L = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_F_L", "fetchByC_F_L",
			new String[] {
		...
		_finderPathCountByC_F_L = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_F_L", "countByC_F_L",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			});
