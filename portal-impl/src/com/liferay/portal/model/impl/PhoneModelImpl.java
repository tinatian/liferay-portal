...
public class PhoneModelImpl extends BaseModelImpl<Phone> implements PhoneModel {
	...
	public void resetOriginalValues() {
		...
		_phoneCacheModel = _toPhoneCacheModel();
	}

	@Override
	public CacheModel<Phone> toCacheModel() {
		PhoneCacheModel phoneCacheModel = _toPhoneCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		PhoneCacheModel phoneCacheModel = _phoneCacheModel;

		if (phoneCacheModel == null) {
			phoneCacheModel = _dummyPhoneCacheModel;
		}

		return (T)function.apply(phoneCacheModel);
	}

	private PhoneCacheModel _toPhoneCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			phoneCacheModel -> {
				Long createDate = phoneCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			phoneCacheModel -> {
				Long modifiedDate = phoneCacheModel.modifiedDate;
		...
		columnBitmasks.put("number", 1024L);
		...
		columnBitmasks.put("primary", 8192L);
