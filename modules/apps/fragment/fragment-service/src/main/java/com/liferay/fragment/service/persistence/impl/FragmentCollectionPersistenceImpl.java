...
public class FragmentCollectionPersistenceImpl
	...
	public void clearCache(FragmentCollection fragmentCollection) {
		...
		entityCache.removeResult(
			entityCacheEnabled, FragmentCollectionImpl.class,
			fragmentCollection, _columnBitmaskEnabled);
	}
	...
	public FragmentCollection updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, FragmentCollectionImpl.class,
			fragmentCollection, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, FragmentCollectionImpl.class,
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {fragmentCollectionModelImpl.getUuid()};
				}
		...
		_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					...
					return new Object[] {
						fragmentCollectionModelImpl.getOriginalGroupId(),
						fragmentCollectionModelImpl.
							getOriginalFragmentCollectionKey()
					};
				}
