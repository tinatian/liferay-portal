...
public class SourcePersistenceImpl
	...
	public void clearCache(Source source) {
		entityCache.removeResult(SourceImpl.class, source.getPrimaryKey());
	...
	protected void clearUniqueFindersCache(
		...
		if ((sourceModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				sourceModelImpl.getCacheModelAttribute("uuid"),
				sourceModelImpl.getCacheModelAttribute("groupId")
			};
	...
	public Source updateImpl(Source source) {
		...
		if (isNew) {
			...
			if ((sourceModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					sourceModelImpl.getCacheModelAttribute("uuid"),
					sourceModelImpl.getCacheModelAttribute("companyId")
				};
