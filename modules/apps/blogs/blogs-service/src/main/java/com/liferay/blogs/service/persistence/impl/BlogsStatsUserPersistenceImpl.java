...
public class BlogsStatsUserPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_NotE = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, BlogsStatsUserImpl.class,
			BlogsStatsUserImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_NotE",
			new String[] {
		...
		_finderPathWithPaginationCountByG_NotE = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, BlogsStatsUserImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_NotE",
			new String[] {Long.class.getName(), Integer.class.getName()});

		_finderPathWithPaginationFindByC_NotE = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, BlogsStatsUserImpl.class,
			BlogsStatsUserImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_NotE",
			new String[] {
		...
		_finderPathWithPaginationCountByC_NotE = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, BlogsStatsUserImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_NotE",
			new String[] {Long.class.getName(), Integer.class.getName()});

		_finderPathWithPaginationFindByU_L = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, BlogsStatsUserImpl.class,
			BlogsStatsUserImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByU_L",
			new String[] {
		...
		_finderPathWithoutPaginationFindByU_L = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, BlogsStatsUserImpl.class,
			BlogsStatsUserImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByU_L",
		...
		_finderPathCountByU_L = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, BlogsStatsUserImpl.class,
