...
public class AccountEntryOrganizationRelPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByA_O = _createFinderPath(
			...
			"fetchByA_O", new String[] {"accountEntryId", "organizationId"});
	...
	private static class AccountEntryOrganizationRelModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					accountEntryOrganizationRelModelImpl, attributeNames,
					original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						accountEntryOrganizationRelModelImpl.getAttributeValue(
							attributeName);
				}
			}
