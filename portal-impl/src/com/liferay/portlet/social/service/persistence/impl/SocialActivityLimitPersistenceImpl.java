...
public class SocialActivityLimitPersistenceImpl
	...
	public SocialActivityLimit updateImpl(
		...
		SocialActivityLimit originalSocialActivityLimit = socialActivityLimit;
		...
		EntityCacheUtil.putResult(
			SocialActivityLimitImpl.class, originalSocialActivityLimit, false,
			true);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByG_U_C_C_A_A = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "G_U_C_C_A_A", "fetchByG_U_C_C_A_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Long.class.getName(),
		...
		_finderPathCountByG_U_C_C_A_A = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "G_U_C_C_A_A",
			"countByG_U_C_C_A_A",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Long.class.getName(), Long.class.getName(),
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SocialActivityLimitImpl.class;
