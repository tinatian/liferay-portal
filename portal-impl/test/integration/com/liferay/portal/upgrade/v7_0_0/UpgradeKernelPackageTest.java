...
public class UpgradeKernelPackageTest extends UpgradeKernelPackage {
	...
	public void testUpgradeTable() throws Exception {
		try {
			...
			_insertTableValues(
				"ClassName_", "0", String.valueOf(increment(ClassName.class)),
				StringBundler.concat("'PREFIX_", _OLD_RESOURCE_NAME, "'"));
			_insertTableValues(
				"ClassName_", "1", String.valueOf(increment(ClassName.class)),
				StringBundler.concat("'", _NEW_RESOURCE_NAME, "_POSTFIX'"));
			...
			_clearData("ClassName_", "value", _OLD_RESOURCE_NAME);
			_clearData("ClassName_", "value", _NEW_RESOURCE_NAME);
		}
	}
