...
public class LVEntryVersionPersistenceImpl
	...
	public void clearCache(LVEntryVersion lvEntryVersion) {
		...
		entityCache.removeResult(
			LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionImpl.class, lvEntryVersion,
	...
	public LVEntryVersion updateImpl(LVEntryVersion lvEntryVersion) {
		...
		entityCache.putResult(
			LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionImpl.class, lvEntryVersion, false,
			LVEntryVersionModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByLvEntryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("LvEntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("LvEntryId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByLvEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByLvEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByLvEntryId_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("LvEntryId_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("LvEntryId_Version"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByLvEntryId_Version,
				MapUtil.singletonDictionary(
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByLvEntryId_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByG_UGK_Version = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_UGK_Version"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_UGK_Version"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByG_UGK_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByG_UGK_Version,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((lvEntryVersionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("LvEntryId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((lvEntryVersionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("LvEntryId_Version")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((lvEntryVersionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("G_UGK_Version")) != 0)) {
