...
/**
 * Provides the local service utility for EagerFinderCacheEntry. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.EagerFinderCacheEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EagerFinderCacheEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.EagerFinderCacheEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EagerFinderCacheEntry addEagerFinderCacheEntry(
		EagerFinderCacheEntry eagerFinderCacheEntry) {

		return getService().addEagerFinderCacheEntry(eagerFinderCacheEntry);
	}
	 ...
	 */
	public static EagerFinderCacheEntry createEagerFinderCacheEntry(
		long eagerFinderCacheEntryId) {

		return getService().createEagerFinderCacheEntry(
	 ...
	 */
	public static EagerFinderCacheEntry deleteEagerFinderCacheEntry(
		EagerFinderCacheEntry eagerFinderCacheEntry) {

		return getService().deleteEagerFinderCacheEntry(eagerFinderCacheEntry);
	}
	...
	public static EagerFinderCacheEntry deleteEagerFinderCacheEntry(
		...
		return getService().deleteEagerFinderCacheEntry(
			eagerFinderCacheEntryId);
	}
	...
	public static EagerFinderCacheEntry fetchEagerFinderCacheEntry(
		long eagerFinderCacheEntryId) {

		return getService().fetchEagerFinderCacheEntry(eagerFinderCacheEntryId);
	}
	 ...
	 */
	public static List<EagerFinderCacheEntry> getEagerFinderCacheEntries(
		int start, int end) {

		return getService().getEagerFinderCacheEntries(start, end);
	}
	 ...
	 */
	public static int getEagerFinderCacheEntriesCount() {
		return getService().getEagerFinderCacheEntriesCount();
	}
	 ...
	 * @throws PortalException if a eager finder cache entry with the primary key could not be found
	 */
	public static EagerFinderCacheEntry getEagerFinderCacheEntry(
			long eagerFinderCacheEntryId)
		throws PortalException {

		return getService().getEagerFinderCacheEntry(eagerFinderCacheEntryId);
	}
	 ...
	 */
	public static EagerFinderCacheEntry updateEagerFinderCacheEntry(
		EagerFinderCacheEntry eagerFinderCacheEntry) {

		return getService().updateEagerFinderCacheEntry(eagerFinderCacheEntry);
	}

	public static EagerFinderCacheEntryLocalService getService() {
		return _service;
	}

	private static volatile EagerFinderCacheEntryLocalService _service;
