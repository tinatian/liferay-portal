...
public class MembershipRequestModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (membershipRequestCacheModel == null) {
			membershipRequestCacheModel = _dummyMembershipRequestCacheModel;
		}

		return (T)function.apply(membershipRequestCacheModel);
	}

	private MembershipRequestCacheModel _toMembershipRequestCacheModel() {
		MembershipRequestCacheModel membershipRequestCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			membershipRequestCacheModel -> {
				Long createDate = membershipRequestCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"replyDate",
			membershipRequestCacheModel -> {
				Long replyDate = membershipRequestCacheModel.replyDate;
