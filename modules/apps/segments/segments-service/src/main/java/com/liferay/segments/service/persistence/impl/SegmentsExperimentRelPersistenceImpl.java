...
public class SegmentsExperimentRelPersistenceImpl
	...
	public SegmentsExperimentRel updateImpl(
		...
		SegmentsExperimentRel originalSegmentsExperimentRel =
			segmentsExperimentRel;
		...
		entityCache.putResult(
			SegmentsExperimentRelImpl.class, originalSegmentsExperimentRel,
			false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindBySegmentsExperimentId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "SegmentsExperimentId",
			"findBySegmentsExperimentId",
			new String[] {
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SegmentsExperimentRelImpl.class;
