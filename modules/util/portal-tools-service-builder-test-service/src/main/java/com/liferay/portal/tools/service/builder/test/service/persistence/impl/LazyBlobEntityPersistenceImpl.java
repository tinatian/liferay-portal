	...
	private static class LazyBlobEntityModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					lazyBlobEntityModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					lazyBlobEntityModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						lazyBlobEntityModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] = lazyBlobEntityModelImpl.getAttributeValue(
						attributeName);
				}
			}
