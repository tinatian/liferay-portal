...
public class LayoutPageTemplateCollectionPersistenceImpl
	...
	public void cacheResult(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_LPTCK"),
			new Object[] {
				layoutPageTemplateCollection.getGroupId(),
				layoutPageTemplateCollection.
					getLayoutPageTemplateCollectionKey()
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_LPTCK"), args,
			layoutPageTemplateCollectionModelImpl, false);
	...
	public LayoutPageTemplateCollection updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, LayoutPageTemplateCollectionImpl.class,
			layoutPageTemplateCollectionModelImpl.getPrimaryKey(),
			layoutPageTemplateCollectionModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_LPTCK");
