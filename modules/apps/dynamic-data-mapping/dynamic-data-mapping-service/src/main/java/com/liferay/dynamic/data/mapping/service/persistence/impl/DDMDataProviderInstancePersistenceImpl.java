...
public class DDMDataProviderInstancePersistenceImpl
	...
	public void clearCache(DDMDataProviderInstance ddmDataProviderInstance) {
		...
		entityCache.removeResult(
			entityCacheEnabled, DDMDataProviderInstanceImpl.class,
			ddmDataProviderInstance, _columnBitmaskEnabled);
	}
	...
	public DDMDataProviderInstance updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, DDMDataProviderInstanceImpl.class,
			ddmDataProviderInstance, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, DDMDataProviderInstanceImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", DDMDataProviderInstanceModelImpl.UUID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", DDMDataProviderInstanceModelImpl.GROUPID_COLUMN_BITMASK);
