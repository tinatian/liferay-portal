...
public interface ElasticsearchConfiguration {
	...
	@Meta.AD(
		...
		name = "bootstrap-mlock-all", required = false
	)
	...
	@Meta.AD(
		...
		name = "http-corsenabled", required = false
	)
	...
	@Meta.AD(
		...
		name = "http-corsallow-origin", required = false
	)
	public String httpCORSAllowOrigin();

	@Meta.AD(
		description = "http-cors-configurations-help",
		name = "http-corsconfigurations", required = false
	)
	...
	@Meta.AD(
		deflt = "true", description = "sync-search", name = "sync-search",
		required = false
	)
