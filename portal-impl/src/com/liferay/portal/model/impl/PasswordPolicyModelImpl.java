...
public class PasswordPolicyModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (passwordPolicyCacheModel == null) {
			passwordPolicyCacheModel = _dummyPasswordPolicyCacheModel;
		}

		return (T)function.apply(passwordPolicyCacheModel);
	}

	private PasswordPolicyCacheModel _toPasswordPolicyCacheModel() {
		PasswordPolicyCacheModel passwordPolicyCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			passwordPolicyCacheModel -> {
				Long createDate = passwordPolicyCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			passwordPolicyCacheModel -> {
				Long modifiedDate = passwordPolicyCacheModel.modifiedDate;
