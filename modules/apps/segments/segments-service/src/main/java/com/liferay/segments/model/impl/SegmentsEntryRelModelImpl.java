...
public class SegmentsEntryRelModelImpl
	...
	private SegmentsEntryRelCacheModel _toSegmentsEntryRelCacheModel() {
		SegmentsEntryRelCacheModel segmentsEntryRelCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			segmentsEntryRelCacheModel -> {
				Long createDate = segmentsEntryRelCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			segmentsEntryRelCacheModel -> {
				Long modifiedDate = segmentsEntryRelCacheModel.modifiedDate;
