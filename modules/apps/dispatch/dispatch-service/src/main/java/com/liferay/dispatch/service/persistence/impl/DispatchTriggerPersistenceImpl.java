...
public class DispatchTriggerPersistenceImpl
	...
	public DispatchTrigger updateImpl(DispatchTrigger dispatchTrigger) {
		...
		DispatchTrigger originalDispatchTrigger = dispatchTrigger;
		...
		entityCache.putResult(
			DispatchTriggerImpl.class, originalDispatchTrigger, false, true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = DispatchTriggerImpl.class;
