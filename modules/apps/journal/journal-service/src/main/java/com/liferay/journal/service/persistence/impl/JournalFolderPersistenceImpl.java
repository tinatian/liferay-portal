	...
	private static class JournalFolderModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					journalFolderModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					journalFolderModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						journalFolderModelImpl.getOriginalAttributeValue(
							attributeName);
				}
				else {
					arguments[i] = journalFolderModelImpl.getAttributeValue(
						attributeName);
				}
			}
