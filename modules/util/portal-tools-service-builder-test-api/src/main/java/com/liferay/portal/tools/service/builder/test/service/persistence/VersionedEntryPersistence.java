 ...
 */
@ProviderType
public interface VersionedEntryPersistence extends BasePersistence<VersionedEntry> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<VersionedEntry> findByGroupId(long groupId,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<VersionedEntry> orderByComparator);
