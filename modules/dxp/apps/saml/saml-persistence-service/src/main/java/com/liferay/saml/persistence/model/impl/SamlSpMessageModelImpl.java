...
public class SamlSpMessageModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		SamlSpMessageCacheModel samlSpMessageCacheModel =
			_samlSpMessageCacheModel;

		if (samlSpMessageCacheModel == null) {
			samlSpMessageCacheModel = _dummySamlSpMessageCacheModel;
		}

		return (T)function.apply(samlSpMessageCacheModel);
	}

	private SamlSpMessageCacheModel _toSamlSpMessageCacheModel() {
		SamlSpMessageCacheModel samlSpMessageCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			...
			samlSpMessageCacheModel -> {
				Long createDate = samlSpMessageCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			...
			samlSpMessageCacheModel -> {
				String samlIdpEntityId =
					samlSpMessageCacheModel.samlIdpEntityId;
		...
		cacheModelGetterFunctions.put(
			"expirationDate",
			samlSpMessageCacheModel -> {
				Long expirationDate = samlSpMessageCacheModel.expirationDate;
