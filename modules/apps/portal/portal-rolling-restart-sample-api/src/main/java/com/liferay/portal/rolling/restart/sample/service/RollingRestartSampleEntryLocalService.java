...
/**
 * Provides the local service interface for RollingRestartSampleEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RollingRestartSampleEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RollingRestartSampleEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.rolling.restart.sample.service.impl.RollingRestartSampleEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rolling restart sample entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RollingRestartSampleEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
