...
public class DDLRecordPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByRecordSetId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			DDLRecordImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByRecordSetId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByRecordSetId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			DDLRecordImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByRecordSetId", new String[] {Long.class.getName()},
			DDLRecordModelImpl.RECORDSETID_COLUMN_BITMASK);

		_finderPathCountByRecordSetId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByRecordSetId", new String[] {Long.class.getName()});

		_finderPathWithPaginationFindByR_U = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			DDLRecordImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByR_U",
			new String[] {
		...
		_finderPathWithoutPaginationFindByR_U = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			DDLRecordImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByR_U",
		...
		_finderPathCountByR_U = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByR_U",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathWithPaginationFindByR_R = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			DDLRecordImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByR_R",
			new String[] {
		...
		_finderPathWithoutPaginationFindByR_R = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
			DDLRecordImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByR_R",
		...
		_finderPathCountByR_R = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordImpl.class,
