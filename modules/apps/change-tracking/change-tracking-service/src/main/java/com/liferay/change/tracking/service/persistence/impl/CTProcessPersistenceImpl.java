...
public class CTProcessPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			CTProcessImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathWithPaginationFindByCollectionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, CTProcessImpl.class,
			CTProcessImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByCollectionId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByCollectionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, CTProcessImpl.class,
			CTProcessImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByCollectionId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled, CTProcessImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
