...
public class RecentLayoutRevisionPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((recentLayoutRevisionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				recentLayoutRevisionModelImpl.getCacheModelAttribute("userId"),
				recentLayoutRevisionModelImpl.getCacheModelAttribute(
					"layoutSetBranchId"),
				recentLayoutRevisionModelImpl.getCacheModelAttribute("plid")
			};
