...
public class ServiceComponentPersistenceImpl
	...
	public ServiceComponent updateImpl(ServiceComponent serviceComponent) {
		...
		EntityCacheUtil.putResult(
			ServiceComponentModelImpl.ENTITY_CACHE_ENABLED,
			ServiceComponentImpl.class, serviceComponent, false,
			ServiceComponentModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByBuildNamespace = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("BuildNamespace"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("BuildNamespace"));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByBuildNamespace,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByBNS_BNU = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("BNS_BNU"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("BNS_BNU"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByBNS_BNU,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByBNS_BNU,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
