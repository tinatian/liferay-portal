...
public class LayoutPrototypePersistenceImpl
	...
	public LayoutPrototype updateImpl(LayoutPrototype layoutPrototype) {
		...
		LayoutPrototype originalLayoutPrototype = layoutPrototype;
		...
		EntityCacheUtil.putResult(
			LayoutPrototypeImpl.class, originalLayoutPrototype, false, true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = LayoutPrototypeImpl.class;
