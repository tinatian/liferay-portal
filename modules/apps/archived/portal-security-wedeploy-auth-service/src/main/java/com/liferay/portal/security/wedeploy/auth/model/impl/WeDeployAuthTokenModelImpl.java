...
public class WeDeployAuthTokenModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (weDeployAuthTokenCacheModel == null) {
			weDeployAuthTokenCacheModel = _dummyWeDeployAuthTokenCacheModel;
		}

		return (T)function.apply(weDeployAuthTokenCacheModel);
	}

	private WeDeployAuthTokenCacheModel _toWeDeployAuthTokenCacheModel() {
		WeDeployAuthTokenCacheModel weDeployAuthTokenCacheModel =
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			weDeployAuthTokenCacheModel -> {
				Long createDate = weDeployAuthTokenCacheModel.createDate;
		...
		cacheModelGetterFunctions.put(
			"modifiedDate",
			weDeployAuthTokenCacheModel -> {
				Long modifiedDate = weDeployAuthTokenCacheModel.modifiedDate;
