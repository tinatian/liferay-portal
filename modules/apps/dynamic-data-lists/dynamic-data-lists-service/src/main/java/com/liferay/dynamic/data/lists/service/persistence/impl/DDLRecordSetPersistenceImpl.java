	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {ddlRecordSetModelImpl.getOriginalUuid()};
			});
		...
		_finderPathWithoutPaginationFindByDDMStructureId = FinderPath.create(
			...
			baseModel -> {
				...
				return new Object[] {ddlRecordSetModelImpl.getDDMStructureId()};
			},
			baseModel -> {
				DDLRecordSetModelImpl ddlRecordSetModelImpl =
					(DDLRecordSetModelImpl)baseModel;
		...
		_finderPathWithPaginationCountByDDMStructureId = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordSetImpl.class,
			Long.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByDDMStructureId", new String[] {Long.class.getName()});

		_finderPathFetchByG_R = FinderPath.create(
			entityCacheEnabled, finderCacheEnabled, DDLRecordSetImpl.class,
