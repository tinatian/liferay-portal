...
public class DDMFormInstanceRecordPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			DDMFormInstanceRecordImpl.class, DDMFormInstanceRecordImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, Long.class,
		...
		_finderPathWithPaginationFindByFormInstanceId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, DDMFormInstanceRecordImpl.class,
		...
		_finderPathCountByFormInstanceId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByFormInstanceId",
			new String[] {Long.class.getName()});

		_finderPathWithPaginationFindByU_F = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, DDMFormInstanceRecordImpl.class,
		...
		_finderPathWithoutPaginationFindByU_F = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, DDMFormInstanceRecordImpl.class,
		...
		_finderPathCountByU_F = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByU_F",
			new String[] {Long.class.getName(), Long.class.getName()});

		_finderPathWithPaginationFindByF_F = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, DDMFormInstanceRecordImpl.class,
		...
		_finderPathWithoutPaginationFindByF_F = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, DDMFormInstanceRecordImpl.class,
		...
		_finderPathCountByF_F = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			DDMFormInstanceRecordImpl.class, Long.class,
