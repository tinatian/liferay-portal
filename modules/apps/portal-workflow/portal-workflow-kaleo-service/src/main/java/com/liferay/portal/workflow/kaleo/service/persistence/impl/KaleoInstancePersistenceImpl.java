...
public class KaleoInstancePersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByKDI_C", _finderPathCountByKDI_C
			).put(
				...
				"finderPathCountByKDVI_C", _finderPathCountByKDVI_C
			).put(
				...
				"finderPathFetchByKII_C_U", _finderPathFetchByKII_C_U
			).put(
				"finderPathCountByKII_C_U", _finderPathCountByKII_C_U
			).put(
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(KaleoInstance.class);
	}
