...
public class TrashVersionPersistenceImpl
	...
	public void clearCache(TrashVersion trashVersion) {
		...
		entityCache.removeResult(
			entityCacheEnabled, TrashVersionImpl.class, trashVersion,
	...
	public TrashVersion updateImpl(TrashVersion trashVersion) {
		...
		entityCache.putResult(
			entityCacheEnabled, TrashVersionImpl.class, trashVersion, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, TrashVersionImpl.class,
		...
		_finderPathWithoutPaginationFindByEntryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("EntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("EntryId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByE_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("E_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("E_C"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByE_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByE_C,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"EntryId", TrashVersionModelImpl.ENTRYID_COLUMN_BITMASK);
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((trashVersionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("EntryId")) != 0)) {

					return new Object[] {trashVersionModelImpl.getEntryId()};
				}
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((trashVersionModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("E_C")) != 0)) {
