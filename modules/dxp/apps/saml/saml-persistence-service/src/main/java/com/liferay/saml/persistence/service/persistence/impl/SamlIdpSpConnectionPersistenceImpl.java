...
public class SamlIdpSpConnectionPersistenceImpl
	...
	public SamlIdpSpConnection updateImpl(
		...
		SamlIdpSpConnection originalSamlIdpSpConnection = samlIdpSpConnection;
		...
		entityCache.putResult(
			SamlIdpSpConnectionImpl.class, originalSamlIdpSpConnection, false,
			true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByC_SSEI = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_SSEI", "fetchByC_SSEI",
			new String[] {Long.class.getName(), String.class.getName()});

		_finderPathCountByC_SSEI = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_SSEI",
			"countByC_SSEI",
			new String[] {Long.class.getName(), String.class.getName()});
	}
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = SamlIdpSpConnectionImpl.class;
