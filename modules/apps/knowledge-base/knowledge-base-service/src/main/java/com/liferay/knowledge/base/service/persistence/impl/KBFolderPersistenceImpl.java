...
public class KBFolderPersistenceImpl
	...
	public void cacheResult(KBFolder kbFolder) {
		entityCache.putResult(
			...
			new Object[] {
				...
				((KBFolderModelImpl)kbFolder).getColumnBitmask()
			});
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_P_UT"),
			new Object[] {
				kbFolder.getGroupId(), kbFolder.getParentKBFolderId(),
	...
	public void clearCache(List<KBFolder> kbFolders) {
		for (KBFolder kbFolder : kbFolders) {
			entityCache.removeResult(
				entityCacheEnabled, KBFolderImpl.class,
				kbFolder.getPrimaryKey(), kbFolder,
				new Object[] {
					_columnBitmaskEnabled,
					((KBFolderModelImpl)kbFolder).getColumnBitmask()
				});
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_P_UT"), args,
			kbFolderModelImpl, false);
	}
	...
	public KBFolder updateImpl(KBFolder kbFolder) {
		...
		entityCache.putResult(
			entityCacheEnabled, KBFolderImpl.class,
			kbFolderModelImpl.getPrimaryKey(), kbFolderModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled, kbFolderModelImpl.getColumnBitmask()
			});
	...
	public void activate(BundleContext bundleContext) {
		...
		Bundle bundle = FrameworkUtil.getBundle(KBFolderPersistenceImpl.class);
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_P_UT");
