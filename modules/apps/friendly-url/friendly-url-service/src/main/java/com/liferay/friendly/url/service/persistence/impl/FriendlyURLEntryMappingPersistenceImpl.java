...
public class FriendlyURLEntryMappingPersistenceImpl
	...
	public FriendlyURLEntryMapping updateImpl(
		...
		FriendlyURLEntryMapping originalFriendlyURLEntryMapping =
			friendlyURLEntryMapping;
		...
		entityCache.putResult(
			FriendlyURLEntryMappingImpl.class, originalFriendlyURLEntryMapping,
			false, true);
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = FriendlyURLEntryMappingImpl.class;
