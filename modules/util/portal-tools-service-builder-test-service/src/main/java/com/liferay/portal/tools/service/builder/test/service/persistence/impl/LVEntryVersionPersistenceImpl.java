...
public class LVEntryVersionPersistenceImpl
	...
	public void cacheResult(LVEntryVersion lvEntryVersion) {
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_UGK_Version"),
			new Object[] {
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_getFinderPath(
				FINDER_CLASS_NAME_ENTITY, "fetchByLvEntryId_Version"),
			args, lvEntryVersionModelImpl, false);
	...
	public LVEntryVersion updateImpl(LVEntryVersion lvEntryVersion) {
		...
		entityCache.putResult(
			LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED,
			LVEntryVersionImpl.class, lvEntryVersionModelImpl.getPrimaryKey(),
	...
	public void afterPropertiesSet() {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByG_UGK_Version");
	...
	private FinderPath _getFinderPath(String cacheName, String methodName) {
		if (!LVEntryVersionModelImpl.FINDER_CACHE_ENABLED) {
			return null;
		}
	...
	private FinderPath _populateFinderPath(
		...
		if ((bitMaskArray == null) || (bitMaskArray.length != 3)) {
			finderPath = new FinderPath(
				LVEntryVersionModelImpl.ENTITY_CACHE_ENABLED, true, returnClass,
