...
public class PortletPreferencesPersistenceImpl
	...
	public PortletPreferences updateImpl(
		...
		EntityCacheUtil.putResult(
			PortletPreferencesModelImpl.ENTITY_CACHE_ENABLED,
			PortletPreferencesImpl.class, portletPreferences, false,
			PortletPreferencesModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByOwnerId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("OwnerId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("OwnerId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByOwnerId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByOwnerId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByPortletId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("PortletId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("PortletId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByPortletId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByPortletId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByO_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("O_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("O_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByO_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByO_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByP_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("P_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("P_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByP_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByP_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByO_O_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("O_O_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("O_O_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByO_O_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByO_O_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByO_O_PI = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("O_O_PI"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("O_O_PI"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByO_O_PI,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByO_O_PI,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByO_P_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("O_P_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("O_P_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByO_P_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByO_P_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByO_O_P_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("O_O_P_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("O_O_P_P"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByO_O_P_P,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByO_O_P_P,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"OwnerId", PortletPreferencesModelImpl.OWNERID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"Plid", PortletPreferencesModelImpl.PLID_COLUMN_BITMASK);

		_FINDER_PATH_BITMASK_MAP.put(
			"PortletId", PortletPreferencesModelImpl.PORTLETID_COLUMN_BITMASK);
	...
	static {
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("OwnerId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("PortletId")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("O_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("P_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("O_O_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("O_O_PI")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("O_P_P")) != 0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((portletPreferencesModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("O_O_P_P")) != 0)) {
