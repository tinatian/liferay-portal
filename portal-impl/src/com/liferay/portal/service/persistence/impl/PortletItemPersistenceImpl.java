...
public class PortletItemPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByG_P_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_P_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_P_C"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_P_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_P_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByG_N_P_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_N_P_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_N_P_C"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByG_N_P_C,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_N_P_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
