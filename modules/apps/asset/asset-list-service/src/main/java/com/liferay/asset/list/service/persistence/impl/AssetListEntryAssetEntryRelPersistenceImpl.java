...
public class AssetListEntryAssetEntryRelPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathCountByAssetListEntryId = _createFinderPath(
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByAssetListEntryId", new String[] {"assetListEntryId"});
	...
	private static class AssetListEntryAssetEntryRelModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					assetListEntryAssetEntryRelModelImpl, attributeNames,
					original);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						assetListEntryAssetEntryRelModelImpl.getAttributeValue(
							attributeName);
				}
			}
