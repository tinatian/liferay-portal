...
public class CalendarNotificationTemplatePersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, CalendarNotificationTemplateImpl.class,
		...
		_finderPathFetchByC_NT_NTT = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("C_NT_NTT"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_NT_NTT"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByC_NT_NTT,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_ENTITY)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByC_NT_NTT,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	}
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", CalendarNotificationTemplateModelImpl.UUID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((calendarNotificationTemplateModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("C_NT_NTT")) != 0)) {
