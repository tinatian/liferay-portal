...
public class PollsVoteModelImpl
	...
	public static final int VOTEID_COLUMN_INDEX = 2;
	...
	public static final int QUESTIONID_COLUMN_INDEX = 9;

	public static final int CHOICEID_COLUMN_INDEX = 10;

	public static final int LASTPUBLISHDATE_COLUMN_INDEX = 11;

	public static final int VOTEDATE_COLUMN_INDEX = 12;
	...
	public void setQuestionId(long questionId) {
		if (_originalValues[QUESTIONID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[QUESTIONID_COLUMN_INDEX] = _questionId;
		}
	...
	public long getOriginalQuestionId() {
		Object originalValue = _originalValues[QUESTIONID_COLUMN_INDEX];

		if (originalValue == INITIAL_MARKER) {
			originalValue = _questionId;
		}
	...
	public void setChoiceId(long choiceId) {
		if (_originalValues[CHOICEID_COLUMN_INDEX] == INITIAL_MARKER) {
			_originalValues[CHOICEID_COLUMN_INDEX] = _choiceId;
		}
	...
	public long getOriginalChoiceId() {
		Object originalValue = _originalValues[CHOICEID_COLUMN_INDEX];

		if (originalValue == INITIAL_MARKER) {
			originalValue = _choiceId;
		}
	...
	public void resetOriginalValues() {
		...
		pollsVoteModelImpl._columnBitmask = null;
	}
