...
public class WikiCacheHelper {
	...
	public static WikiCacheHelper getWikiCacheHelper() {
		return _wikiCacheHelper;
	}
	...
	protected void activate() {
		_wikiCacheHelper = this;
	}

	@Deactivate
	protected void deactivate() {
		_wikiCacheHelper = null;
	}
	...
	private static WikiCacheHelper _wikiCacheHelper;
