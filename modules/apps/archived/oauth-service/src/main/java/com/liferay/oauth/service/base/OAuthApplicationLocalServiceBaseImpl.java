...
public abstract class OAuthApplicationLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return oAuthApplicationPersistence.dslQuery(dslQuery);
	}
	...
	@Override
	public BasePersistence<OAuthApplication> getBasePersistence() {
	...
	public void loadFinderCache(FinderPath[] finderPaths) {
		oAuthApplicationPersistence.loadFinderCache(finderPaths);
	}
