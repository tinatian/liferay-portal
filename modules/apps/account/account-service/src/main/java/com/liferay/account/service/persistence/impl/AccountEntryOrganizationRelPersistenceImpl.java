...
public class AccountEntryOrganizationRelPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByOrganizationId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			AccountEntryOrganizationRelImpl.class,
			AccountEntryOrganizationRelImpl.class,
		...
		_finderPathCountByOrganizationId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			AccountEntryOrganizationRelImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByOrganizationId",
			new String[] {Long.class.getName()});

		_finderPathFetchByA_O = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			AccountEntryOrganizationRelImpl.class,
		...
		_finderPathCountByA_O = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			AccountEntryOrganizationRelImpl.class, Long.class,
