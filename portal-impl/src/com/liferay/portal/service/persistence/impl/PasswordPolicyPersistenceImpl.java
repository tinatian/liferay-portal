...
public class PasswordPolicyPersistenceImpl
	...
	public PasswordPolicy updateImpl(PasswordPolicy passwordPolicy) {
		...
		EntityCacheUtil.putResult(
			PasswordPolicyModelImpl.ENTITY_CACHE_ENABLED,
			PasswordPolicyImpl.class, passwordPolicyModelImpl, false,
			PasswordPolicyModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByC_DP = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "C_DP", "fetchByC_DP",
			new String[] {Long.class.getName(), Boolean.class.getName()});

		_finderPathCountByC_DP = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "C_DP", "countByC_DP",
			new String[] {Long.class.getName(), Boolean.class.getName()});
	...
	private FinderPath _createFinderPath(
		...
		Class<?> returnClass = PasswordPolicyImpl.class;
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				PasswordPolicyModelImpl.FINDER_CACHE_ENABLED, returnClass,
