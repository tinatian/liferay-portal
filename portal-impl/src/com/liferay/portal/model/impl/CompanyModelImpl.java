...
public class CompanyModelImpl
	...
	public void resetOriginalValues() {
		...
		_companyCacheModel = _toCompanyCacheModel();
	}

	@Override
	public CacheModel<Company> toCacheModel() {
		CompanyCacheModel companyCacheModel = _toCompanyCacheModel();
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		CompanyCacheModel companyCacheModel = _companyCacheModel;

		if (companyCacheModel == null) {
			companyCacheModel = _dummyCompanyCacheModel;
		}

		return (T)function.apply(companyCacheModel);
	}

	private CompanyCacheModel _toCompanyCacheModel() {
	...
	static {
		...
		columnBitmasks.put("system", 128L);
