...
public class OAuthConsumerPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByGadgetKey = _createFinderPath(
			OAuthConsumerImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGadgetKey", new String[] {"gadgetKey"});
		...
		_finderPathCountByGadgetKey = _createFinderPath(
			...
			"countByGadgetKey", new String[] {"gadgetKey"});
	...
	private static class OAuthConsumerModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					oAuthConsumerModelImpl, attributeNames, original);
			}
			...
			for (String attributeName : attributeNames) {
				finderPathColumnBitmask |=
					oAuthConsumerModelImpl.getColumnBitmask(attributeName);
			}
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = oAuthConsumerModelImpl.getAttributeValue(
						attributeName);
				}
			}
