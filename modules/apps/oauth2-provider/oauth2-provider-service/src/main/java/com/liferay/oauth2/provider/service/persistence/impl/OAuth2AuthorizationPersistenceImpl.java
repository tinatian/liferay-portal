...
public class OAuth2AuthorizationPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			OAuth2AuthorizationImpl.class, OAuth2AuthorizationImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			OAuth2AuthorizationImpl.class, Long.class,
		...
		_finderPathCountByOAuth2ApplicationId = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			OAuth2AuthorizationImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByAccessTokenContentHash = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			OAuth2AuthorizationImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
		...
		_finderPathCountByRefreshTokenContentHash = FinderPathUtil.create(
			entityCacheEnabled, finderCacheEnabled,
			OAuth2AuthorizationImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
