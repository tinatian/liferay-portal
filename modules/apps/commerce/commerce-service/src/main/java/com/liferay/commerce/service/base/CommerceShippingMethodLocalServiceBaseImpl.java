...
public abstract class CommerceShippingMethodLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceShippingMethodLocalServiceImpl#deleteCommerceShippingMethod(CommerceShippingMethod) to avoid orphaned data");
		}
	...
	public void loadFinderCache(FinderPath[] finderPaths) {
		commerceShippingMethodPersistence.loadFinderCache(finderPaths);
	}
