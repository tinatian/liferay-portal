...
public class SiteNavigationMenuItemPersistenceImpl
	...
	public void clearCache(SiteNavigationMenuItem siteNavigationMenuItem) {
		...
		entityCache.removeResult(
			entityCacheEnabled, SiteNavigationMenuItemImpl.class,
			siteNavigationMenuItem, _columnBitmaskEnabled);
	}
	...
	public SiteNavigationMenuItem updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, SiteNavigationMenuItemImpl.class,
			siteNavigationMenuItem, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, SiteNavigationMenuItemImpl.class,
		...
		_finderPathWithoutPaginationFindBySiteNavigationMenuId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("SiteNavigationMenuId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("SiteNavigationMenuId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountBySiteNavigationMenuId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathWithoutPaginationFindByParentSiteNavigationMenuItemId =
			new FinderPath(
				...
				_ARGUMENTS_BIFUNCTION_MAP.get("ParentSiteNavigationMenuItemId"),
		...
		_finderPathWithoutPaginationFindByS_P = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("S_P"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("S_P"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByS_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByS_P,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"Uuid", SiteNavigationMenuItemModelImpl.UUID_COLUMN_BITMASK);
	...
	static {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((siteNavigationMenuItemModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("SiteNavigationMenuId")) !=
						  0)) {
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((siteNavigationMenuItemModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("S_P")) != 0)) {
