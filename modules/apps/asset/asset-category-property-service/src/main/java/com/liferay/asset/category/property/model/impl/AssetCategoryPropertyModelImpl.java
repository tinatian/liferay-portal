...
public class AssetCategoryPropertyModelImpl
	...
	public <T> T getOriginalAttributeValue(String attributeName) {
		...
		if (assetCategoryPropertyCacheModel == null) {
			assetCategoryPropertyCacheModel =
				_dummyAssetCategoryPropertyCacheModel;
		}

		return (T)function.apply(assetCategoryPropertyCacheModel);
	}

	private AssetCategoryPropertyCacheModel
		_toAssetCategoryPropertyCacheModel() {
	...
	static {
		...
		cacheModelGetterFunctions.put(
			"createDate",
			assetCategoryPropertyCacheModel -> {
				Long createDate = assetCategoryPropertyCacheModel.createDate;
