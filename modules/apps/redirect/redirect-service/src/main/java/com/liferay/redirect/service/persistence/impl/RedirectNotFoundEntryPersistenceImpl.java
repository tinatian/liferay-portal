...
public class RedirectNotFoundEntryPersistenceImpl
	...
	public void clearCache(RedirectNotFoundEntry redirectNotFoundEntry) {
		...
		entityCache.removeResult(
			entityCacheEnabled, RedirectNotFoundEntryImpl.class,
			redirectNotFoundEntry, _columnBitmaskEnabled);
	}
	...
	public RedirectNotFoundEntry updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, RedirectNotFoundEntryImpl.class,
			redirectNotFoundEntry, false, _columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, RedirectNotFoundEntryImpl.class,
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"GroupId", RedirectNotFoundEntryModelImpl.GROUPID_COLUMN_BITMASK);
