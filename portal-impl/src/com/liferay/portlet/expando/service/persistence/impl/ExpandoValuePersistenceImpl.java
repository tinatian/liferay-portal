...
public class ExpandoValuePersistenceImpl
	...
	public void clearCache(ExpandoValue expandoValue) {
		...
		EntityCacheUtil.removeResult(
			ExpandoValueModelImpl.ENTITY_CACHE_ENABLED, ExpandoValueImpl.class,
			expandoValue, ExpandoValueModelImpl.COLUMN_BITMASK_ENABLED);
	}
	...
	public void clearCache(List<ExpandoValue> expandoValues) {
		...
		for (ExpandoValue expandoValue : expandoValues) {
			EntityCacheUtil.removeResult(
				ExpandoValueModelImpl.ENTITY_CACHE_ENABLED,
				ExpandoValueImpl.class, expandoValue,
				ExpandoValueModelImpl.COLUMN_BITMASK_ENABLED);
		}
	}
	...
	public ExpandoValue updateImpl(ExpandoValue expandoValue) {
		...
		EntityCacheUtil.putResult(
			ExpandoValueModelImpl.ENTITY_CACHE_ENABLED, ExpandoValueImpl.class,
			expandoValue, false, ExpandoValueModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByTableId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("TableId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("TableId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByTableId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByTableId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByColumnId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("ColumnId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ColumnId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByColumnId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByColumnId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByRowId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("RowId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("RowId"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByRowId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByRowId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByT_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("T_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("T_C"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByT_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByT_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByT_R = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("T_R"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("T_R"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByT_R,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByT_R,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByT_CPK = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("T_CPK"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("T_CPK"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByT_CPK,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByT_CPK,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByC_R = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("C_R"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("C_R"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByC_R,
				HashMapBuilder.<String, Object>put(
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByC_R,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByT_C_C = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("T_C_C"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("T_C_C"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByT_C_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByT_C_C,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByT_C_D = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("T_C_D"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("T_C_D"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByT_C_D,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByT_C_D,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
	}
