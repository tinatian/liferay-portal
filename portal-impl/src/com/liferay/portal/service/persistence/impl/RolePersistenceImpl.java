...
public class RolePersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((roleModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				roleModelImpl.getCacheModelAttribute("companyId"),
				roleModelImpl.getCacheModelAttribute("name")
			};
		...
		if ((roleModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				roleModelImpl.getCacheModelAttribute("companyId"),
				roleModelImpl.getCacheModelAttribute("classNameId"),
				roleModelImpl.getCacheModelAttribute("classPK")
			};
		...
		if ((roleModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				...
				roleModelImpl.getCacheModelAttribute("classNameId"),
				roleModelImpl.getCacheModelAttribute("classPK"),
				roleModelImpl.getCacheModelAttribute("type")
			};
	...
	public Role updateImpl(Role role) {
		...
		if (isNew) {
			...
			if ((roleModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					roleModelImpl.getCacheModelAttribute("uuid")
				};
			...
			if ((roleModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					roleModelImpl.getCacheModelAttribute("subtype")
				};
