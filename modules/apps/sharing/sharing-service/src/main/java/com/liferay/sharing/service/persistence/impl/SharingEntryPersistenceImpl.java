...
public class SharingEntryPersistenceImpl
	...
	public void activate() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByTU_C", _finderPathCountByTU_C
			).put(
				...
				"finderPathFetchByTU_C_C", _finderPathFetchByTU_C_C
			).put(
				"finderPathCountByTU_C_C", _finderPathCountByTU_C_C
			).build());
	...
	public void deactivate() {
		...
		FinderPath.unregisterFinderPaths(SharingEntry.class);
	}
