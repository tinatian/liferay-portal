...
public class AccountRolePersistenceImpl
	...
	public void clearCache(AccountRole accountRole) {
		...
		entityCache.removeResult(
			entityCacheEnabled, AccountRoleImpl.class, accountRole,
	...
	public AccountRole updateImpl(AccountRole accountRole) {
		...
		entityCache.putResult(
			entityCacheEnabled, AccountRoleImpl.class, accountRole, false,
			_columnBitmaskEnabled);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			finderCacheEnabled, AccountRoleImpl.class,
		...
		_finderPathWithoutPaginationFindByAccountEntryId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("AccountEntryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("AccountEntryId"));
		...
		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathCountByAccountEntryId,
				MapUtil.singletonDictionary(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION)));
		...
		_finderPathFetchByRoleId = new FinderPath(
			finderCacheEnabled, AccountRoleImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByRoleId", new String[] {Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("RoleId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("RoleId"));

		_serviceRegistrations.add(
			bundleContext.registerService(
				FinderPath.class, _finderPathFetchByRoleId,
				MapUtil.singletonDictionary(
	...
	static {
		_FINDER_PATH_BITMASK_MAP.put(
			"CompanyId", AccountRoleModelImpl.COMPANYID_COLUMN_BITMASK);
		...
		_FINDER_PATH_BITMASK_MAP.put(
			"RoleId", AccountRoleModelImpl.ROLEID_COLUMN_BITMASK);
	}
	...
	static {
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((accountRoleModelImpl.getColumnBitmask() &
		...
		_ARGUMENTS_BIFUNCTION_MAP.put(
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((accountRoleModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("AccountEntryId")) != 0)) {
