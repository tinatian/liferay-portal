...
public class OAuthConsumerPersistenceImpl
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = FinderPathUtil.create(
			...
			OAuthConsumerImpl.class, OAuthConsumerImpl.class,
		...
		_finderPathCountAll = FinderPathUtil.create(
			OAuthConsumerModelImpl.ENTITY_CACHE_ENABLED,
			OAuthConsumerModelImpl.FINDER_CACHE_ENABLED,
			OAuthConsumerImpl.class, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
			new String[0]);

		_finderPathWithPaginationFindByGadgetKey = FinderPathUtil.create(
			OAuthConsumerModelImpl.ENTITY_CACHE_ENABLED,
			OAuthConsumerModelImpl.FINDER_CACHE_ENABLED,
			OAuthConsumerImpl.class, OAuthConsumerImpl.class,
		...
		_finderPathWithoutPaginationFindByGadgetKey = FinderPathUtil.create(
			OAuthConsumerModelImpl.ENTITY_CACHE_ENABLED,
			OAuthConsumerModelImpl.FINDER_CACHE_ENABLED,
			OAuthConsumerImpl.class, OAuthConsumerImpl.class,
		...
		_finderPathCountByGadgetKey = FinderPathUtil.create(
			OAuthConsumerModelImpl.ENTITY_CACHE_ENABLED,
			OAuthConsumerModelImpl.FINDER_CACHE_ENABLED,
			OAuthConsumerImpl.class, Long.class,
