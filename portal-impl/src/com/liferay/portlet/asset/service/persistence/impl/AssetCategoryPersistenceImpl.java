...
public class AssetCategoryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByParentCategoryId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("ParentCategoryId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("ParentCategoryId"));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByParentCategoryId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByVocabularyId = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("VocabularyId"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("VocabularyId"));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByVocabularyId,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByG_V = new FinderPath(
			...
			"findByG_V",
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("G_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_V"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByP_V = new FinderPath(
			...
			"findByP_V",
			new String[] {Long.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("P_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("P_V"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByP_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByP_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByN_V = new FinderPath(
			...
			"findByN_V",
			new String[] {String.class.getName(), Long.class.getName()},
			_ARGUMENTS_BIFUNCTION_MAP.get("N_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("N_V"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByN_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByN_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathWithoutPaginationFindByG_P_V = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("G_P_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("G_P_V"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathWithoutPaginationFindByG_P_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByG_P_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
		...
		_finderPathFetchByP_N_V = new FinderPath(
			...
			_ARGUMENTS_BIFUNCTION_MAP.get("P_N_V"),
			_ORIGINAL_ARGUMENTS_BIFUNCTION_MAP.get("P_N_V"));

		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathFetchByP_N_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_ENTITY
				).build()));
		...
		_serviceRegistrations.add(
			registry.registerService(
				FinderPath.class, _finderPathCountByP_N_V,
				HashMapBuilder.<String, Object>put(
					"cache.name", FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION
				).build()));
