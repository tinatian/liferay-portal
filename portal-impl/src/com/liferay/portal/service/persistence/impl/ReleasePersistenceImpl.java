...
public class ReleasePersistenceImpl
	...
	public void clearCache(Release release) {
		...
		EntityCacheUtil.removeResult(
			ReleaseModelImpl.ENTITY_CACHE_ENABLED, ReleaseImpl.class, release,
	...
	public void clearCache(List<Release> releases) {
		...
		for (Release release : releases) {
			EntityCacheUtil.removeResult(
				ReleaseModelImpl.ENTITY_CACHE_ENABLED, ReleaseImpl.class,
				release, ReleaseModelImpl.COLUMN_BITMASK_ENABLED);
		}
	}
	...
	public Release updateImpl(Release release) {
		...
		EntityCacheUtil.putResult(
			ReleaseModelImpl.ENTITY_CACHE_ENABLED, ReleaseImpl.class,
			releaseModelImpl, false, ReleaseModelImpl.COLUMN_BITMASK_ENABLED);
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByServletContextName = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "ServletContextName",
			"fetchByServletContextName", new String[] {String.class.getName()});

		_finderPathCountByServletContextName = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "ServletContextName",
	...
	private FinderPath _createFinderPath(
		...
		if (cacheName.equals(FINDER_CLASS_NAME_LIST_WITH_PAGINATION)) {
			return new FinderPath(
				ReleaseModelImpl.FINDER_CACHE_ENABLED, returnClass, cacheName,
				methodName, params);
		}
			...
			(baseModel, checkColumns) -> {
				...
				if (!checkColumns ||
					((releaseModelImpl.getColumnBitmask() &
					  _FINDER_PATH_BITMASK_MAP.get("ServletContextName")) !=
						  0)) {
