...
public class WorkflowMetricsSLADefinitionPersistenceImpl
	...
	public void cacheResult(
		...
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByWMSLAD_A"),
			new Object[] {
				workflowMetricsSLADefinition.
					getWorkflowMetricsSLADefinitionId(),
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			...
			args, Long.valueOf(1), false);
		finderCache.putResult(
			_getFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByWMSLAD_A"), args,
			workflowMetricsSLADefinitionModelImpl, false);
	}
	...
	public WorkflowMetricsSLADefinition updateImpl(
		...
		entityCache.putResult(
			entityCacheEnabled, WorkflowMetricsSLADefinitionImpl.class,
			workflowMetricsSLADefinitionModelImpl.getPrimaryKey(),
			workflowMetricsSLADefinitionModelImpl, false,
			new Object[] {
				_columnBitmaskEnabled,
	...
	public void activate(BundleContext bundleContext) {
		...
		_populateFinderPath(FINDER_CLASS_NAME_ENTITY, "fetchByWMSLAD_A");
