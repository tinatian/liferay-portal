...
public class CPDefinitionOptionRelPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		FinderPath.registerFinderPaths(
			...
			HashMapBuilder.<String, FinderPath>put(
				...
				"finderPathCountByCPDI_R", _finderPathCountByCPDI_R
			).put(
				...
				"finderPathCountByC_SC", _finderPathCountByC_SC
			).put(
				"finderPathFetchByC_K", _finderPathFetchByC_K
			).put(
				"finderPathCountByC_K", _finderPathCountByC_K
			).build());
	...
	public void destroy() {
		...
		FinderPath.unregisterFinderPaths(CPDefinitionOptionRel.class);
	}
